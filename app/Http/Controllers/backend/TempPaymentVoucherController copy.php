...
class TempPaymentVoucherController extends Controller
{
   ...
   public function temp_payment_voucher_edit($id){
        ...
        return view('backend.payment-voucher.temp-payment-voucher-edit', compact('temp_payment_voucher' ,'parties', 'modes', 'new_expenses', 'due'));
    }
    public function temp_payment_voucher_update(Request $request){
        ...
        {
            return redirect()->route('temp-payment-voucher-authorize')->with($notification);
