...
class CostCenterController extends Controller
{
    ...
    // work by mominul
    public function cost_center_list_print(Request $request){
        $costCenterDetails = CostCenter::all();
        return view('backend.costCenter.cost-center-list-print', compact('costCenterDetails'));
    }
}
