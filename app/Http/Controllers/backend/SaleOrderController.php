...
class SaleOrderController extends Controller
{
    ...
    public function customerPost(Request $request)
    {
        ...
        $draftCost->short_code = $request->short_code;
        $sv=$draftCost->save();
        ...
        return Response()->json(['page' => view('backend.ajax.form.customerSelect', compact('newCustomer'), ['customers' => $customers])->render(),
                'newCustomer' => $newCustomer
        ]);

    }
    public function add_new_customerPost(Request $request){
        $request->validate([
            'pi_name' => 'required',
            'pi_type'        => 'required',
        ...
        $temp_record->customer_id = $draftCost->short_code;
        $temp_record->save();
        return Response()->json(['newCustomer' => $newCustomer]);
    }
