...
<head>
    ...
    <style>
        ...
        .graph-7{background: url({{asset('img/balraj.png')}});}
        ...
        .widgets-Statistics2{
            background-image: url(http://zinith-accounting-inventory-main.test/img/balraj.png);
            opacity: 0.5;
        }
        @media screen {
        div.divFooter {
        ...
        .company-info{
            background-color: rgba(227 107 99);
            padding-top: 5px;
            font-weight: 800;
            padding-bottom: 1px;
            color: white;
...
<body onload="window.print();">
    ...
    @yield('content')
    <div class="balraj-footer">
        {{-- <span style="color: #0005"><img src="{{ asset('img/knooz-footer.jpeg') }}" style="max-height: 100px" class="img-fluid" alt=""></span> --}}
    </div>
    <div class="divFooter">
        Business Software Solutions by
        <span style="color: #0005"><img src="{{ asset('img/zisprink.png') }}" style="max-height: 50px" class="img-fluid" alt=""></span>
    </div>

    <div class="img">
        <img src="{{ asset('storage/upload/settings/'.$company_logo->config_value)}}" class="img-fluid" style="position: fixed; top:400px; left:50px; opacity:0.09; height:600px;" alt="">
