...
<body onload="window.print();">
            ...
            <div class="content-body">
                <section id="widgets-Statistics">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-1">
                                <img src="{{ asset('storage/upload/settings/'.$company_logo->config_value)}}"  style="width: 200px" alt="">
                            ...
                            <div class="col-md-10 text-center">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 text-center">
                                        <h6>Email: {{ $company_email->config_value }}</h6>
                                    </div>
                                    <div class="col-12 text-center">
                                        <h6>TRN No: {{ $company_trn->config_value }}</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-1">
    ...
    <div class="img">
        <img src="{{ asset('storage/upload/settings/'.$company_logo->config_value)}}" class="img-fluid" style="position: fixed; top:500px; left:50px; opacity:0.1; height:700px;" alt="">
