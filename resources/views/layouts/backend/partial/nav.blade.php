            ...
            <div class="navbar-collapse" id="navbar-mobile">
                <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
                    <ul class="nav navbar-nav">
                        <div class="d-flex justify-content-end pt-1 pr-1 ">
                            <button id="sidebar-toggler" > <i class="bx bx-list-ul"></i> </button>
                        </div>
                    </ul>
                        ...
                        <a class="nav-link nav-link-label" href="javascript:void(0);" data-toggle="dropdown">
                            ...
                            <span class="badge badge-pill badge-danger badge-up">
                                ...
                                $tarek_notification = 0;
                                    ...
                                    $po_generation = App\Purchase::count();
                                    $po_generation_revise = App\Purchase::count();
                                    ...
                                    $rejected_pv_authorize = App\PaymentVoucher::where('status', 100)->count();
                                    $revise_pv_authorizer_approver = App\PaymentVoucher::where('status', 99)->count();
