...
<div class="d-flex align-items-center gap-2 print-hideen">
    ...
    <a href="{{route('projects.roi.report')}}" class="btn btn-outline-secondary print-hideen  nav-item nav-link tabPadding {{  $activeMenu == 'roi' ? 'bg-secondary text-white' : ' text-dark'}}" role="tab" aria-controls="nav-contact" aria-selected="false" style="margin-right:15px;">
        <div>&nbsp; ROI Report  &nbsp;</div>
    </a>
</div>
