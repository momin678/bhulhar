...
<div class="d-flex align-items-center gap-2">
    ...
    <a href="{{route('sale_authorize')}}" class="btn btn-outline-secondary nav-item nav-link tabPadding {{  $activeMenu == 'authorize' ? 'bg-secondary text-white' : ' text-dark'}}" role="tab" aria-controls="nav-contact" aria-selected="false" style="margin-right:15px;">
