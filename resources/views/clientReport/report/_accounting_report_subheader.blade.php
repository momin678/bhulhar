...
{{--
    <a href="{{route('daily-report')}}" class="btn btn-outline-secondary nav-item nav-link tabPadding {{  $activeMenu == 'daily_summary' ? 'bg-secondary text-white' : ' text-dark'}}" role="tab" aria-controls="nav-contact" aria-selected="false" style="margin-right:15px;">
