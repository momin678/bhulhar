...
<section class="print-hideen border-bottom" style="background: #364a60;">
    <div class="d-flex flex-row-reverse" style="padding-top: 5px;padding-right: 8px;">
        ...
        <div class="" style="margin-top: 5px;padding-right: 3px;">
            <a href="{{ route('temp-payment-voucher-delete', $payment->id) }}" class="btn btn-sm btn-icon btn-danger" onclick="return confirm('Delete! Confirm?')"><i class="bx bx-trash"></i></a>
        </div>
        ...
        @if ($payment->is_authorize == 0)
            <div class="" style="margin-top: 5px;padding-right: 3px;">
                <a href="{{ route('payment-voucher-authorize', $payment) }}" class="btn btn-sm btn-icon btn-warning" onclick="return confirm('Authorize! Confirm?')" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Authorize"><i class="bx bx-check"></i></a>
            </div>
        @else
            <div class="" style="margin-top: 5px;padding-right: 3px;">
                <a href="{{ route('payment-voucher-approve', $payment) }}" class="btn btn-sm btn-icon btn-warning" onclick="return confirm('Approve! Confirm?')" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Approve"><i class="bx bx-check"></i></a>
            </div>
        @endif
        <div class="" style="margin-top: 5px;padding-right: 3px;">
            <a href="{{ route('temp-payment-voucher-edit', $payment->id) }}" class="btn btn-sm btn-icon btn-primary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit"><i class="bx bx-edit"></i></a>
        </div>
        {{-- <div class="mr-1"><a href="#" onclick="window.print();" class="btn btn-icon btn-light"><i class='bx bxs-virus'></i></a></div> --}}
        <div class="mr-1 w-100 pl-2" style="margin-top: 5px;">
...
<section id="payment-invoice">
<section id="widgets-Statistics">
    <div class="payment-voucher px-2 pt-1" style=" border: 1px solid; margin: 10px 5px; border-radius: 10px;">
        <div class="row  mb-2">
            <div class="col-4">
