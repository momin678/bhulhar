...
<div class="d-flex align-items-center gap-2">
    ...
    <a href="{{route('payment-voucher2-list')}}" class="btn btn-outline-secondary nav-item nav-link tabPadding {{  $activeMenu == 'list' ? 'bg-secondary text-white' : ' text-dark'}}" role="tab" aria-controls="nav-contact" aria-selected="false" style="margin-right:15px;">
        <div> Approved Payment </div>
    </a>
    <a href="{{route('payable')}}" class="btn btn-outline-secondary nav-item nav-link tabPadding {{  $activeMenu == 'payable' ? 'bg-secondary text-white' : ' text-dark'}}" role="tab" aria-controls="nav-contact" aria-selected="false" style="margin-right:15px;">
        <div> Payable  </div>
    </a>
</div>
