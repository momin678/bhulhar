...
@push('css')
@endpush
@section('title', 'pv approval view')
@section('content')
    <!-- BEGIN: Content-->
                ...
                <div class="row" id="table-bordered">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 ">
                        <form action="{{route('payment-voucher.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <h5>Payment Voucher Approval</h5>
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            <a class="btn btn-warning" href="{{route('rejected-pv-approver', $pv_info->id)}}">Reject</a>
                            <a class="btn btn-success" href="{{route('pv-approve-approval', $pv_info->id)}}">Approve</a>
                        </div>
                        <div id="approveRejectedForm" style="display: none;">
                            <form action="{{route("revise-pv-submit-approval")}}" method="post">
                                @csrf
                                <div class="row">
