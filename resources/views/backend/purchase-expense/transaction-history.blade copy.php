                                            ...
                                            @endphp
                                                ...
                                                <table class="table table-bordered table-sm " style="width: 805px">
                                                    <tbody id="purch-body">
                                                            ...
                                                            @foreach ($project->purchase_expense as $p_expense)
                                                                <tr class="border-top">
                                                                    <td>{{$p_expense->party->pi_name}}</td>
                                                                    <td>{{date('d/m/Y', strtotime($p_expense->date))}}</td>
                                                                    <td>{{number_format($p_expense->project_expense,2)}}</td>
                                                                </tr>
                                                            @endforeach
                                                    </tbody>
                                                </table>
                                                <table class="table table-bordered table-sm " style="width: 805px">
                                                    <tbody id="purch-body">
                                                            <tr>
                                                                <td colspan="3"><h6>Outcoming Transaction</h6></td>
                                                            </tr>
                                                            <thead class="thead">
                                                                <tr>
                                                                    <th style="width: 50%">Customer Name</th>
                                                            ...
                                                            @foreach ($project->invoicess as $invoice)
                                                                <tr class="border-top">
                                                                    ...
                                                                    <td>{{number_format($invoice->total_budget,2)}}</td>
                                                                </tr>
                                                            @endforeach
                                                    </tbody>
                                                </table>
