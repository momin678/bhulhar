...
<section class="print-hideen border-bottom" style="background: #364a60;">
    <div class="d-flex flex-row-reverse">
        ...
        <div class="pr-1" style="padding: 8px;padding-right: 0.2rem !important;"><a href="#" onclick="handlePrintClick('widgets-Statistics1')" class="btn btn-icon btn-secondary"><i class="bx bx-printer"></i></a></div>
        <div class="pr-1" style="padding-top: 8px;padding-right: 0.2rem !important;"><a href="{{route('purchase-approval',$purchase_exp)}}" onclick="return confirm('about to approval purchase. Please, Confirm?')" class="btn btn-sm btn-icon btn-warning" style="padding: 6px 8px;margin-right: -8px;"><i class="bx bx-check"></i></a></div>
        ...
        <div class="pr-1" style="padding-top: 9px;padding-right: 0.2rem !important;"><a href="{{route('purchase-expense.delete',$purchase_exp)}}" onclick="return confirm(' Please, Confirm?')"class="btn btn-sm btn-icon btn-danger" style="padding: 6px 8px;"><i class="bx bx-trash"></i></a></div>
...
<section id="widgets-Statistics1">
    ...
    <div class="row">
        <div class="col-md-12 text-center invoice-view-wrapper student_profle-print mt-1">
            <h2>Purchase - Bill</h2>
        </div>
        <div class="col-md-12">
            <div class="">
                <div class="mx-2 mb-2 pt-2">
                    <div class="row">
                        ...
                        <div class=" col-3 ">
                            <strong>Bill No:</strong> {{ $purchase_exp->invoice_no}}
                        </div>
        ...
        <div class="col-md-12 print-hideen ml-2 print-none">
        ...
        <div class="row p-2 print-none" id="documents">
            @if($purchase_exp->documents->count() > 0)
                @foreach ($purchase_exp->documents as $document)
                <div class="col-6 col-md-2 text-center py-1 px-4 print-hideen document-file" id="document-{{$document->id}}">
        ...
        {{-- <div class="col-md-12 text-center my-2">
            <a href="{{route('purchase-approve',$purchase_exp)}}" class="btn btn-info btn-sm" onclick="return confirm('about to approval purchase. Please, Confirm?')"> Approve </a>
        </div> --}}
    </div>
