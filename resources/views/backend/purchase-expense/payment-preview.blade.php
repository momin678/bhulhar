    ...
    <div class="d-flex flex-row-reverse" style="padding-top: 5px;padding-right: 8px;">
        <div class="pr-1" style="margin-top: 5px;">
            ...
            <a href="#" class="close btn-icon btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Close"><span
                    aria-hidden="true" data-dismiss="modal" aria-label="Close"><i class='bx bx-x' style="padding-bottom: 3px;"></i></span></a>
        </div>
        <div class="pr-1" style="margin-top: 5px;margin-right: -12px;"><a href="#" onclick="handlePrintClick('payment-invoice')" class="btn btn-icon btn-success" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Print"><i class="bx bx-printer" style="padding-bottom: 2px;"></i></a></div>


        @if ($payment->status == 'Realised')
            <div class="" style="margin-top: 6px;padding-right: 3px;"><a href="#" disabled class="btn btn-icon btn-primary" data-bs-toggle="tooltip" style="height: 31px" data-bs-placement="bottom" title="Realised"><i class="fa fa-external-link" style="font-size:17px"></i></a></div>
        @else
        <div class="" style="padding: 5px 3px;"><a href="{{ route('payment-realised', $payment) }}"
            class="btn btn-sm btn-icon btn-primary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Realised"><i class="fa fa-external-link" style="font-size:17px"></i></a></div>
        <div class="" style="white-space: nowrap;padding: 5px 0px;"><a href="#"
                class="btn btn-sm btn-icon btn-warning " data-toggle="modal" data-target="#notSubmit" title="Not Submited"><i class="fa fa-ban" style="font-size:17px"></i></a></div>
        <div class="" style="padding: 5px 3px;"><a href="{{ route('payment-declined', $payment) }}"
                class="btn btn-sm btn-icon {{ $payment->status == 'Declined' ? 'btn-secondary' : 'btn-danger' }}"
                style="{{ $payment->status == 'Declined' ? 'pointer-events: none' : '' }}" title="Decline"><i class="fa fa-hourglass-start" style="font-size:17px"></i></a></div>
        @endif
...
<div id="payment-invoice">
    <section>
        <div class="receipt-voucher-hearder invoice-view-wrapper" style="  border: 1px solid; margin: 15px 5px; border-radius: 10px;">
    ...
    <section id="widgets-Statistics">
            ...
            <div class="d-flex justify-content-between aligin-items-center mb-1">
                ...
                <div class="w-100" style="border-bottom:1px dashed #111;">
                    <p style="margin:0 !important;padding:0!important;color:#313131;font-size:15px;font-weight:500 !important; padding-left:30px">
                        {{ $payment->party ? $payment->party->pi_name :'' }}
                    </p>
                </div>
        ...
        <div class="container mt-1 print-none">
            ...
            <div class="row justify-content-center">
                <div class="col-auto">
                   <a href="{{ asset('storage/upload/documents/' . $payment->voucher_file) }}" target="_blank"> <img src="{{ asset('storage/upload/documents/' . $payment->voucher_file) }}" alt="Image" class="img-fluid" ></a>
                </div>
            </div>
            @endif
            @endif
