            ...
            <div class="tab-content journaCreation active">
                <div id="journaCreation" class="tab-pane bg-white active">
                    <div class="py-1 px-1">
                        ...
                        'activeMenu' => $purchase->invoice_type=='Garage'?'garage': ($purchase->invoice_type=='Office'?'office':'bill'),
                        ])
                    </div>
                    <section id="widgets-Statistics">
                        <form action="{{ route('expense-edit-post',$purchase->id) }}" method="POST" id="formSubmit"
                                    ...
                                    <div class="row pt-1">
                                        <div class="col-12 col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="date" value="{{date('d/m/Y',strtotime($purchase->date))}}"
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-10 customer-select">
                                                    ...
                                                    <select name="client_info" id="client_info"
                                                        ...
                                                        <option value="{{$client->id}}" {{$client->id == $purchase->client_id ? 'selected':''}}> {{$client->pi_name}} </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                        ...
                                        <div class="col-12 col-md-2 col-right-padding">
                                            <div class="form-group">
                                                ...
                                                <select name="pay_mode" id="pay_mode"
                                                    ...
                                                    <option value="{{ $item->title }}" {{$purchase->pay_mode == $item->title ? 'selected' : '' }}>
                                                        {{ $item->title }} </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="table-responsive bg-white">
                                            <table class="table table-sm auto-index">
                                                ...
                                                <tbody id="TBody">
                                                    ...
                                                    <tr id="TRow" class=" p-0 h6">
                                                        <td class="text-center"></td>
                                                        <td>
                                                            <select name="inputs[{{$key}}][description]"
                                                                class="inputFieldHeight2 task_id form-control"
                                                                style="width: 100%;    HEIGHT: 36PX;"  required>
                                                                <option value="" style="text-align:center;"> -- Choice
                                                                    Option -- </option>
                                                                @foreach ($account_heads as $account_head)
                                                                <option value="{{$account_head->id}}"{{$account_head->id == $item->head_id ? 'selected':'' }}>
                                                        ...
                                                        <td>
                                                            <div
                                                                ...
                                                                <input type="number" step="any"
                                                                    name="inputs[{{$key}}][qty]"  value="{{$item->qty}}" step="any"  required
                                                                    placeholder="Qty"
                                                        ...
                                                        <td>
                                                            <div
                                                                class="d-flex justy-content-between align-items-center">
                                                                <input type="number" step="any"
                                                                    name="inputs[{{$key}}][amount]"  value="{{$item->amount}}" step="any"  required
                                                                    placeholder="Amount"
                                                        ...
                                                        <td>
                                                            <div
                                                                class="d-flex justy-content-between align-items-center">
                                                                <input type="number" step="any"
                                                                    name="inputs[{{$key}}][taxable]" step="any" value="{{$item->amount}}"  readonly
                                                                    placeholder="Amount"
                                                        ...
                                                        <td class="vat-exist">
                                                            <select name="inputs[{{$key}}][vat_rate]"  required
                                                                class="inputFieldHeight2 vat_rate form-control "
                                                                style="width: 100%;HEIGHT: 36PX;text-align:center;">
                                                                <option value=""> -- Choice Option --
                                                                </option>
                                                                @foreach ($vats as $vat)
                                                                <option value="{{ $vat->value }}" {{ $item->vat > 0 ? ($vat->value==5? 'selected':''):($vat->value==0 ? 'selected':'')}}>
                                                                    {{ $vat->name . ' (' . $vat->value . ')' }}
                                                                </option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <td class="vat-exist"><input type="number" step="any"
                                                                ...
                                                                name="inputs[{{$key}}][vat_amount]" value="{{$item->vat}}"  readonly>
                                                        </td>
                                                        <td>
                                                            <input type="number" step="any"
                                                                name="inputs[{{$key}}][sub_gross_amount]"  value="{{$item->total_amount}}"  required
                                                    ...
                                                    <tr>
                                                        <td class="d-none"></td>
                                                        <td class="vat-exist" colspan="{{$purchase->invoice_type=='bill'?7:6}}"></td>
                                                        ...
                                                        <td><input type="number" step="any" readonly id="taxable_amount"
                                                                ...
                                                                name="taxable_amount" value="{{$purchase->amount}}" placeholder="Amount"
                                                                readonly required>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="number" step="any" readonly id="total_amount"
                                                                ...
                                                                name="total_amount" value="{{$purchase->total_amount}}" placeholder="TOTAL "
                                                                readonly required>
                                                            @error('total_amount')
                                                            <span class="error">{{ $message }}</span>
                                                            @enderror
                                ...
                                <div class="row p-2">
                                    <div class="col-12 col-md-6 col-right-padding">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$purchase->narration}}" name="narration"
