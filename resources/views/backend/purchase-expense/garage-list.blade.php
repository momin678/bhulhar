                    ...
                    <div id="journaCreation" class="tab-pane bg-white active">
                        <div class="py-1 px-1">
                            @include('clientReport.purchase.purchase-bill', [
                                'activeMenu' => $type == 'Office'?'office':'garage',
                                ])
                        </div>
                                            ...
                                            <div class="mb-2" id="Group-wise-Bill-List">
                                                ...
                                                <table class="table table-bordered table-sm ">
                                                    ...
                                                    <tbody id="purch-body">
                                                        ...
                                                        @php
                                                            $expense_list = App\PurchaseExpense::where('invoice_type',$type)->where('party_id', $item->client_id)
                                                         ...
                                                         @endforeach
                                                            ...
                                                            @foreach ($expense_item->items as $key =>  $e_item )
                                                                ...
                                                                <tr class="text-center border-bottom">
                                                                    ...
                                                                    <td class="total_amount" id="{{$e_item->purchase_expense_id}}">{{$e_item->total_amount}}</td>
