...
@section('content')
                                ...
                                <div class="card mb-1">
                                    <div class="card-body content-padding">
                                        <div class="row">
                                                ...
                                                <input type="hidden" value="{{ $purch_temp->purchase_no }}" name="temp_purchase_no"
                                                    id="temp_purchase_no">
                                         
                                            <div class="col-sm-3 col-12">
                                                <label for="pr_id">Project </label>
                                                <select name="project_id" id="project_id" class="form-control" required
                                                    disabled>

                                                    @foreach ($pr_lists as $pr_list)
                                                        <option value="{{ $pr_list->id }}"
                                                            {{ old('pr_id') == $pr_list->id ? 'selected' : '' }}>
                                                            {{ $pr_list->proj_name }}</option>
                                                    @endforeach
                                                </select>
                                                @error('project_id')
    ...
    @enderror
                                            ...
                                            <div class="col-sm-3 col-12">
                                                ...
                                                <select name="supplier_id" id="supplier_id" required
                                                    class="form-control common-select2" disabled>
                                                    <option value=""></option>
                                                    @foreach ($suppliers as $supplier)
                                                        <option value="{{ $supplier->id }}"
                                                            {{ old('supplier_id') == $supplier->id ? 'selected' : '' }}>
                                                            {{ $supplier->pi_name }}</option>
                                                    @endforeach
                                                </select>
                                                @error('supplier_id')
                                                    <span class="error">{{ $message }}</span>
                                            ...
                                            <div class="col-sm-3 col-12">
                                                ...
                                                <input type="text" required class="form-control" name="contact_no"
                                                    id="contact_no" value="{{ old('contact_no') }}" readonly>
                                                @error('contact_no')
                                                    <span class="error">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-sm-3 col-12">
                                                ...
                                                <input type="text" name="trn" class="form-control" id="trn"
                                                    readonly value="{{ old('trn') }}">
                                                @error('trn')
                                                    <span class="error">{{ $message }}</span>
                                                @enderror
                                            </div>
    ...
    @enderror
                                                ...
                                                <select name="pay_mode" id="pay_mode" class="form-control" required
                                                    ...
                                                    @foreach ($payMode as $payMode)
                                                        <option value="{{ $payMode->title }}"
                                                            {{ old('pay_mode') == $payMode->title ? 'selected' : '' }}>
                                            ...
                                            <div class="col-sm-3 col-12">
                                                ...
                                                <select name="pay_term" id="pay_term" class="form-control" required
                                                    ...
                                                    @foreach ($payTerms as $payTerm)
                                                        <option value="{{ $payTerm->value }}"
                                                            {{ old('pay_term') == $payTerm->value ? 'selected' : '' }}>
                                                            {{ $payTerm->title }}</option>
                                                    @endforeach
                                                    @error('pay_term')
                                                        <span class="error">{{ $message }}</span>
                                                    @enderror
                                            ...
                                            <div class="col-sm-3 col-12">
                                                ...
                                                <input type="text" class="form-control" name="shipping_id"
                                                    id="shipping_id" value="{{ old('shipping_id') }}" required readonly>
                                                @error('shipping_id')
                                                    <span class="error">{{ $message }}</span>
                                                @enderror
                                            </div>
                                ...
                                <div class="card-body content-padding">
                                    <div class="row">
                                        <div class="col-sm-3 col-12">
                                            ...
                                            <select name="style_id" id="style_id_show"
                                                class="form-control common-select2" disabled>
                                                <option value=""> select option</option>
                                                @foreach ($itemLists as $data)
                                                    <option value="{{ $data->style_id }}">{{ $data->style_name }}
                                                    </option>
                                                @endforeach
                                        ...
                                        <div class="col-sm-3 col-12">
                                            ...
                                            <input type="text" class="form-control quantity_value" disabled name="quantity" id="quantity">
                                            <span class="text-danger" id="quantityErrorMsg"></span>
                                        </div>
                                        <div class="col-sm-3 col-12">
                                            <label for="purchase_rate">Purchase Rate</label>
                                            <input type="text" class="form-control" name="purchase_rate"
                                                id="purchase_rate" readonly>
                                        ...
                                        <div class="col-sm-3 col-12">
                                            ...
                                            <select name="vat_rate" id="vat_rate" class="form-control" disabled>
                                                @foreach ($vatRates as $vatRate)
                                                    <option  value="{{ $vatRate->id }}" {{$vatRate->id == 3 ?  'selected' : '' }}>{{ $vatRate->name }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-sm-3 col-12">
                                            ...
                                            <input type="number" class="form-control" name="vat_amount" id="vat_amount"
                                                value="{{ old('vat_amount') }}" readonly step=".01">
                                            <span class="text-danger" id="vatAmountRateErrorMsg"></span>
                                        </div>
                                        <div class="col-sm-3 col-12">
                                            <label for="total_amount">Total Amount</label>
                                            <input type="number" class="form-control" name="total_amount"
                                                id="total_amount" value="{{ old('total_amount') }}" readonly
                                                step=".01">
                                        </div>
                                        <div class="col-sm-3 d-flex pt-1">
                                            <button class="btn btn-success btn-sm p-1 m-0" id="add_product"><i
                                                    class="bx bx-plus"></i></button>
                                            <button class="btn btn-warning btn-sm ml-1 p-1 m-0" id="refresh"><i
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="10" id="create"
                                    name="create" onclick="po_filter()">
                                <label class="form-check-label" for="create">
                                    PO Create
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="1" id="approval"
                                    name="approval" onclick="po_filter()">
                                <label class="form-check-label" for="approval">
                                    PO Approval
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="101" id="completed"
                                    name="completed" onclick="po_filter()">
                        ...
                        <div class="col-md-6">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="0" id="process"
                                    name="process" onclick="po_filter()">
                                <label class="form-check-label" for="process">
                                    PO Process
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="99" id="revise"
                                    name="revise" onclick="po_filter()">
                    ...
                    <button type="submit" class="btn btn-secondary btn-sm float-right mt-1" data-dismiss="modal"
                        id="filter_check">Check</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
  $(document).on("keyup", "#quantity", function(e) {
            ...
            let pamount = document.getElementById("purchase_rate").value;
            ...
            let amount = quantity * pamount;
            let total_vat_amount = (vat_rate * amount) / 100;
            let total_amount = total_vat_amount amount;
            $("#vat_rate").val(total_vat_amount);
            $("#total_amount").val(total_amount);
        });

        $('#purchase_rate').oninput(function(e) {
            e.preventDefault();
            let quantity =  document.getElementById("quantity").value;
            let pamount = document.getElementById("purchase_rate").value;
            let vatrate = document.getElementById("vat_rate").value;
    ...
    <script>
        ...
        $("#style_id_show").change(function(e) {
            e.preventDefault();
            // alert(this.value);
            $.ajax({
                url: "{{ URL::to('get-item-info') }}",
                type: "POST",
                datatype: "json",
                data: {
                    "id": this.value
        ...
        let item_list_info = document.getElementById("item_name");
        let purchase_rate = document.getElementById("purchase_rate");

        let style_id_show = document.getElementById("style_id_show");
        ...
        new_product.addEventListener("click", function(e) {
            ...
            style_id_show.removeAttribute("disabled");
        ...
        $('#add_product').on('click', function(e) {
            ...
            e.preventDefault();
            $.ajax({
                url: "{{ URL::to('po-item-store') }}",
                type: "post",
                data: {
                    purchase_no: serial_info.value,
                    style_id_show: style_id_show.value,
                ...
                success: function(response) {
                    ...
                    optionCount();
                    purchase_rate_val.setAttribute("", "");
                    item_price = 0;
                },
                error: function(response) {
                    if (response.responseJSON.errors.item_list_id) {
                        document.getElementById('itemListErrorMsg').innerHTML = response.responseJSON
                            .errors.item_list_id;
                    } else {
                        document.getElementById('itemListErrorMsg').innerHTML = '';
                    }
                    if (response.responseJSON.errors.purchase_rate) {
                        document.getElementById('purchaseRateErrorMsg').innerHTML = response
                            .responseJSON.errors.purchase_rate;
                    } else {
                        document.getElementById('purchaseRateErrorMsg').innerHTML = '';
                    }
                    if (response.responseJSON.errors.quantity) {
                        document.getElementById('quantityErrorMsg').innerHTML = response.responseJSON
                            .errors.quantity;
                    } else {
                        document.getElementById('quantityErrorMsg').innerHTML = '';
                    }
                    if (response.responseJSON.errors.vat_rate) {
                        document.getElementById('vatRateErrorMsg').innerHTML = response.responseJSON
                            .errors.vat_rate;
                    } else {
                        document.getElementById('vatRateErrorMsg').innerHTML = '';
                    }
                    if (response.responseJSON.errors.vat_amount) {
                        document.getElementById('vatAmountRateErrorMsg').innerHTML = response
                            .responseJSON.errors.vat_amount;
                    } else {
                        document.getElementById('vatAmountRateErrorMsg').innerHTML = '';
                    }
                },
        ...
        $(document).on("click", ".row-edit", function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    let optionHtml = "<option selected id='" + element_2.style_no + "' value='" +
                        element_1.id + "'>" + element_1.item_name + "</option>";
                    document.getElementById("purchaseRateErrorMsg").innerHTML = "Sell Price is " +
                        element_1.total_amount;
