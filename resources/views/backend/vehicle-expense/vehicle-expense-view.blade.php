            ...
            <div class="col-12">
                <table class="table tableStyle table-sm smTableStyle">
                    <tr>
                        ...
                        <th class="th-border text-left">{{date('d-m-Y', strtotime($expenses->date))}}</th>
                        <th class="th-border">Truck Number:</th>
                        <th class="th-border text-left">{{ $expenses->truck->vehicle_number}}</th>
                        <th class="th-border">Token Number:</th>
                        <th class="th-border text-left">{{ $expenses->token_no}}</th>
                ...
                <table class="table table-sm mt-1 smTableStyle">
                    ...
                    {{-- <tr>
                        ...
                        <td class="text-right pr-1">{{$expenses->others_cost}}</td>
                    </tr> --}}
                    <tr class="border-bottom">
                        <td colspan="4">Total Amount</td>
                        <td class="text-right pr-1">{{$expence_list->sum('total_amount')+$expenses->others_cost}}</td>
                    </tr>
                </table>
            </div>
        </div>
