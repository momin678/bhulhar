    ...
    <div class="content-wrapper">
        <div class="content-body">
            <div class="nav nav-tabs master-tab-section" id="nav-tab" role="tablist">
                ...
                <a href="{{route('vehicle-expense.create')}}" class="nav-item nav-link active" role="tab" aria-controls="nav-contact" aria-selected="false">
                    <div class="master-icon text-cente">
            ...
            <div class="tab-content journaCreation">
                <div id="journaCreation" class="tab-pane active">
                    <section id="widgets-Statistics">
                        <form action="{{ route('vehicle-expense.store') }}" method="POST" enctype="multipart/form-data" >
                            @csrf
                                ...
                                <div class="card-body pb-1">
                                    <div class="row m-1">
                                        ...
                                        <div class="col-md-3 changeColStyle">
                                            ...
                                            <input type="text" class="form-control inputFieldHeight" name="invoice_no" value="" id="invoice_no" placeholder="Invoice No" required>
                                            @error('invoice_no')
                                                <div class="btn btn-sm btn-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-md-3 changeColStyle" id="printarea">
                                            ...
                                            <input type="date" value="{{ Carbon\Carbon::now()->format('Y-m-d') }}" class="form-control inputFieldHeight" name="date" id="date" placeholder="dd-mm-yyyy" >
                                            @error('date')
                                                <div class="btn btn-sm btn-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-md-3 changeColStyle">
                                            <label for="vehicle_id">Vehicle List</label>
                                            <select name="vehicle_id" class="form-control common-select2" id="vehicle_id" required>
                                            ...
                                            <div class="repeater-default" id="form-repeat-container">
                                                    ...
                                                    <div data-repeater-item>
                                                        <div class="row every-form-row">
                                                            ...
                                                            <div class="col-md-2 changeColStyle">
                                                                ...
                                                                <input type="number" name="multi_total_amount" class="form-control inputFieldHeight amount_withvat" placeholder="Total Amount" step=".01">
                                                            </div>
                                                            <div class="col-md-2 changeColStyle">
                                                                <label for="">Vat Rate</label>
                                                                <select name="multi_tax_rate"  class="common-select2 form-control multi-tax-rate" required>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 col-12">
                                                        <div>
                                                            <input type="text" id="total_amount" class="form-control @error('total_amount') error @enderror inputFieldHeight" name="total_amount" value="" placeholder="Total Amount" required>
                                                            @error('total_amount')
