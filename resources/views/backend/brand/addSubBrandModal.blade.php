    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-12 ml-2 mt-1">
                    <h4>Add Description Under Brand <strong>{{ $brand->name }}</strong></h4>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form action="{{ route('sub-brand.store') }}" method="POST">
                                ...
                                <input type="text" name="name" id="name" placeholder="Description" required class="form-control col-7">
                                <input type="float" name="price" id="price"  placeholder="Sale Price" class="form-control col-2">
