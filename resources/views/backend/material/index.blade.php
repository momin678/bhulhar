                        ...
                        <div class="col-12">
                            <div class="cardStyleChange p-1">
                                <section id="widgets-Statistics" class="mb-1">
                                    <div class="d-flex">
                                        <h4 class="flex-grow-1">Materials List</h4>
                                        <div>
                                                ...
                                                <tbody class="table-sm">
                                                    ...
                                                    <tr class="trFontSize">
                                                        ...
                                                        <td class="text-right pr-2">
                                                            <a href="#" class="btn materialsInfoEdit truck_edit_btn" title="Edit" truck-id="{{$item->id}}" style="padding-top: 1px; padding-bottom: 1px; height: 30px; width: 30px;">
...
{{-- modal --}}
    <div class="modal fade" id="newTruckAddModal" tabindex="-1" rrole="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="content-body">
                <form class="form form-vertical" action="{{ route('material.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-12 ">
                                                    ...
                                                    <input type="text" name="name" class="inputFieldHeight form-control" placeholder="Material Name" required>
                                                </div>
    ...
    <div class="modal fade" id="materialsInfoEditModal" tabindex="-1" rrole="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <section class="print-hideen border-bottom">
                <div class="d-flex flex-row-reverse">
            ...
            <div class="content-body" id="edit_material_model">
...
@push('js')
<script>
    $(document).on("click", ".materialsInfoEdit", function(e){
        e.preventDefault();
        var material_id= $(this).attr('truck-id');
        var _token = $('input[name="_token"]').val();
        $.ajax({
            url: "{{ route('material-edit-model') }}",
            method: "POST",
            data: {
            ...
            success: function(response) {
                $('#edit_material_model').html(response);
                $("#materialsInfoEditModal").modal('show');
            }
        });
