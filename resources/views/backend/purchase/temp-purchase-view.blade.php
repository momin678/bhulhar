...
<section class="print-hideen border-bottom">
    <div class="d-flex flex-row-reverse">
        <div class="py-1 pr-1"><a href="#" class="close btn-icon btn btn-danger" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><i class='bx bx-x'></i></span></a></div>
            ...
            <div class="py-1 pr-1"><a href="{{route('temp-purchase-delete', $purchase->id)}}" class="btn btn-icon btn-danger" onclick="return confirm('Delete! Confirm')"><i class='bx bxs-trash'></i></a></div>
            <div class="py-1 pr-1"><a href="{{ route('purchase-edit', $purchase->id) }}" class="btn btn-icon btn-info"><i class="bx bx-edit"></i></a></div>
            @if ($purchase->status == 0)
                <div class="py-1 pr-1">
                    <a href="{{ route('temp-pruchase-authorize-submit', $purchase->id) }}" class="btn btn-icon btn-success" onclick="return confirm('Authorize! Confirm')">Authorize</a>
                </div>
            @else
                <div class="py-1 pr-1">
                    <a href="{{ route('temp-pruchase-approve-submit', $purchase->id) }}" class="btn btn-icon btn-success" onclick="return confirm('Approve! Confirm')">Approve</a>
                </div>
            @endif
    </div>
</section>
