                                            ...
                                            <tr class="trFontSize">
                                                ...
                                                <td style="padding-bottom: 11px; padding-top: 0px">
                                                   <div class="d-flex justify-content-end">
                                                    <a href="#" class="btn partyCenterView" style="height: 25px; width: 25px;" title="Preview" id="{{$pInfo->id}}"><img src="{{ asset('storage/upload/icon/view-icon.png')}}" style=" height: 25px; width: 25px;"></a>
                                                    <a href="{{ route('partyInfoEdit', $pInfo) }}" class="btn" style="height: 25px; width: 25px;" title="Edit"><img src="{{ asset('storage/upload/icon/edit-icon.png')}}" style=" height: 25px; width: 25px;"></a>
                                                    <a href="{{ route('partyInfoDelete', $pInfo) }}" onclick="return confirm('about to delete party info. Please, Confirm?')"  class="btn" style="height: 25px; width: 25px;" title="Delete"><img src="{{ asset('storage/upload/icon/delete-icon.png')}}" style=" height: 25px; width: 25px; margin-left: -12px;"></a>
                                                   </div>
                                            ...
                                            <div class="col-md-3 changeColStyle">
                                                ...
                                                <div class="col-md-3 d-flex justify-content-end changeColStyle">
                                                    <div class="form-group" style="padding-top: 20px;">
                                                        @isset($partyInfo)
                                                        <button class="btn btn-info party-info-form-btn mr-1 formButton" data_target="{{ route('partyInfoForm') }}" id="profitCenterButton"><img src="{{ asset('storage/upload/icon/add-icon.png')}}" alt="" srcset="" class="image-fluid" width="25">New</button>
                                                        @endisset
