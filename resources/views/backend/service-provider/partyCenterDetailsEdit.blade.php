                                    ...
                                    <div class="cardStyleChange">
                                        <div class="row">
                                                            ...
                                                            <span class="btn btn-warning invoice-item-delete" id="" data_target="{{ route('othersDelete',$others) }}"><i class="bx bx-trash"></i></span>
                                                                ...
                                                                @if ($others->extension == 'pdf')
                                                                    <a href="{{ asset('storage/upload/service-provider/'.$others->filename)}}" target="_blank">
                                                                        ...
                                                                        <img src="{{ asset('storage/upload/icon/pdf-download-icon-2.png')}}" alt="jugyjugyt" style="height: 100%; width: 100%;">
                                                                    </a>
                                                                @else
                                                                    <a href="{{ asset('storage/upload/service-provider/'.$others->filename)}}" target="_blank">
                                            ...
                                            <div class="col-md-3 d-flex justify-content-end changeColStyle">
                                                @isset($partyInfo)
                                                <a href="{{ route('service-provider.index') }}" class="btn btn-info mr-1 formButton mt-2"><img src="{{ asset('storage/upload/icon/add-icon.png')}}" alt="" srcset="" class="image-fluid" width="25"> New</a>
                                                @endisset
                        ...
                        <div class="mt-2">
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    ...
                                    <a href="#" class="btn btn-xs mExcelButton formButton" onclick="exportTableToCSV('PartyInfos.csv')" title="Export to Excel"><img  src="{{asset('storage/upload/icon/excel-icon.png')}}" alt="" srcset="" class="img-fluid" width="30">Export To Excel</a href="#">
                                </div>
                            </div>
                            <div class="cardStyleChange">
                                        ...
                                        <tr class="trFontSize">
                                            ...
                                            <td style="padding-bottom: 11px; padding-top: 0px">
                                               <div class="d-flex justify-content-end">
                                                <a href="#" class="btn partyCenterView" style="height: 30px; width: 30px;" title="Preview" id="{{$pInfo->id}}"><img src="{{ asset('storage/upload/icon/view-icon.png')}}" style=" height: 30px; width: 30px;"></a>
                                                <a href="{{ route('service-provider.edit', $pInfo->id) }}" class="btn" style="height: 30px; width: 30px;" title="Edit"><img src="{{ asset('storage/upload/icon/edit-icon.png')}}" style=" height: 30px; width: 30px;"></a>
                                                <a href="{{ route('partyInfoDelete', $pInfo) }}" onclick="return confirm('about to delete service provider. Please, Confirm?')"  class="btn" style="height: 30px; width: 30px;" title="Delete"><img src="{{ asset('storage/upload/icon/delete-icon.png')}}" style=" height: 30px; width: 30px; margin-left: -12px;"></a>
                                               </div>
