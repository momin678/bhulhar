                                ...
                                <div class="col-12">
                                    <div class="">
                                        <div class="card-body cardStyleChange">
                                            <form action="{{  route('item-code.update', $item_code->id) }}" method="POST" enctype="multipart/form-data">
                                                @method('PATCH')
                                                @csrf
                                                <div class="row match-height">
                                                    <div class="col-md-3">
                                                        <label for="">Item Code</label>
                                                        <input type="text" name="name" class="form-control inputFieldHeight" value="{{$item_code->name}}" required placeholder="Item Code">
                                                    </div>
                                                    <div class="col-md-3">
                                                        ...
                                                        <select  name="category_id" id="category_id" class="common-select2" style="width: 100% !important" required>
                                                            ...
                                                            @foreach ($categories as $category)
                                                                <option value="{{$category->id}}" {{$item_code->category_id==$category->id?'selected':''}}>{{$category->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="col-md-3">
                                                        ...
                                                        <select  name="brand_id" id="brand_id" class="common-select2" style="width: 100% !important" required>
                                                            ...
                                                            @foreach ($brands as $brand)
                                                                <option value="{{$brand->id}}"  {{$item_code->brand_id==$brand->id?'selected':''}}>{{$brand->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="col-md-3">
                                                        ...
                                                        <select  name="vehicle_name_id" id="vehicle_name_id" class="common-select2" style="width: 100% !important" required>
                                                            ...
                                                            @foreach ($vehicle_names as $vehicle_name)
                                                                <option value="{{$vehicle_name->id}}" {{$item_code->vehicle_name_id==$vehicle_name->id?'selected':''}}>{{$vehicle_name->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label for="">Vehicle Model</label>
                                                        <select  name="sub_brand_id" id="sub_brand_id" class="common-select2" style="width: 100% !important" required>
                                                            <option value="">Select......</option>
                                                            @foreach ($vehicle_models as $vehicle_model)
                                                                <option value="{{$vehicle_model->id}}" {{$item_code->vehicle_model_id==$vehicle_model->id?'selected':''}}>{{$vehicle_model->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label for="">Sale Price</label>
                                                        <input type="text" name="sale_price" class="form-control inputFieldHeight" value="{{$item_code->sale_price}}" placeholder="Sale Price">
                                                    </div>
                                                    <div class="col-md-3">
                                                        ...
                                                        <select  name="unit_id" id="unit_id" class="common-select2" style="width: 100% !important" required>
                                                            ...
                                                            @foreach ($units as $unit)
                                                                <option value="{{$unit->id}}" {{$item_code->unit_id==$unit->id?'selected':''}}>{{$unit->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
