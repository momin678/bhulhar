                                        ...
                                        <table class="table mb-0 table-sm table-hover">
                                            ...
                                            <tbody class="table-sm" id="items_cart">
                                                <tr class="trFontSize">
                                                    ...
                                                    <td class="">
                                                        <a href="#" class="btn" onclick="delete_item(0)" title="Delete" style="padding-top: 1px; padding-bottom: 1px; height: 30px; width: 30px;">
                                    ...
                                    <div class="card-body">
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-12 commonSelect2Style">
                                                    <select name="party_id" id="party_id_edit" class="inputFieldHeight form-control common-select2">
                                                        <option value="">Select Name</option>
                                                        @foreach ($customers as $customer)
                                                        <option value="{{$customer->id}}" >{{ $customer->pi_name}}</option>
                                                        @endforeach
                                            ...
                                            <div class="row">
                                                <div class="col-md-3 col-12 ">
                                                    <label for="">Date</label>
                                                    <input type="date" name="date" id="date_edit" class="inputFieldHeight form-control" placeholder="Date">
                                                </div>
                                                <div class="col-md-3 col-12 commonSelect2Style">
                                                    <label for="">Truck</label>
                                                    <select name="truck_id" id="truck_id_edit" class="inputFieldHeight form-control common-select2">
                                                        <option value="">Select Name</option>
                                                        @foreach ($trucks as $truck)
                                                        <option value="{{$truck->id}}" vehicle-no="{{$truck->vehicle_number}}" >{{ $truck->vehicle_number}}</option>
                                                        @endforeach
                                                ...
                                                <div class="col-md-3 col-12 ">
                                                    <label for="">Material</label>
                                                    <input type="text" name="material" id="material_edit" class="inputFieldHeight form-control" placeholder="Material">
                                                </div>
                                                <div class="col-md-3 col-12 ">
                                                    <label for="">Crusher/Site </label>
                                                    <input type="text" name="crusher" id="crusher_edit" class="inputFieldHeight form-control" placeholder="Crusher/Site">
                                                </div>
                                                <div class="col-md-3 col-12 ">
                                                    <label for="">DSTN</label>
                                                    <input type="text" name="dstm" id="dstm_edit" class="inputFieldHeight form-control" placeholder="DSTN">
                                                </div>
                                                <div class="col-md-3 col-12 ">
                                                    <label for="">Serial</label>
                                                    <input type="text" name="serial" id="serial_edit" class="inputFieldHeight form-control" placeholder="Serial">
                                                </div>
                                                <div class="col-md-3 col-12 ">
                                                    <label for="">WGT</label>
                                                    <input type="text" name="wgt" id="wgt_edit" class="inputFieldHeight form-control" placeholder="WGT">
                                                </div>
                                                <div class="col-md-3 col-12 commonSelect2Style">
                                                    <label for="">Third Party</label>
                                                    <select name="third_party_id" id="third_party_id_edit" class="inputFieldHeight form-control common-select2">
                                                        <option value="">Select Name</option>
                                                        @foreach ($suppliers as $supplier)
                                                        <option value="{{$supplier->id}}" party-name="{{$supplier->pi_name}}">{{ $supplier->pi_name}}</option>
                                                        @endforeach
        ...
        var _token = $('input[name="_token"]').val();
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#party_id_edit').val(response.customer_id);
                    $('#date_edit').val(response.date);
                    $('#truck_id_edit').val(response.truck_id);
                    $('#material_edit').val(response.material);
                    $('#crusher_edit').val(response.crusher);
                    $('#dstm_edit').val(response.destination);
                    $('#serial_edit').val(response.serial_no);
                    $('#wgt_edit').val(response.weight);
                    $('#third_party_id_edit').val(response.truck_owner);
