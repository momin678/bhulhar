                                                ...
                                                <tbody class="table-sm">
                                                    ...
                                                    <tr class="trFontSize">
                                                        ...
                                                        <td class="">
                                                            ...
                                                            <a href="{{ route('temp-invoice-view', $invoice->id)}}" class="btn" target="_blank" title="Edit" style="padding-top: 1px; padding-bottom: 1px; height: 30px; width: 30px;">
