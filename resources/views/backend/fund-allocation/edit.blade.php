...
<section class="print-hideen border-bottom" style="background: #364a60;">
    <div class="d-flex flex-row-reverse" style="padding-top: 5px; padding-right: 8px;">
        <div class="pr-1" style="margin-top: 5px;">
            <a href="#" class="close btn-icon btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Close">
                ...
                <div class="row pr-2 pl-2">
                    <div class="col-md-2 changeColStyle search-item-pi">
                        <label for="from_account">
                            From Account / <span style="font-size: 14px;">من الحساب</span>
                        </label>
                    ...
                    <div class="col-md-2 changeColStyle">
                        ...
                        <input type="text" value="{{ date('d/m/Y', strtotime($fund->date)) }}" class="form-control inputFieldHeight datepicker" name="date" placeholder="dd/mm/yyyy / <span style='font-size: 14px;'>يوم/شهر/سنة</span>" required>
                        @error('date')
                            <div class="btn btn-sm btn-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-2">
                        ...
                        <input type="number" step="any" name="amount" id="amount" value="{{$fund->amount}}" class="form-control inputFieldHeight" placeholder="Amount / <span style='font-size: 14px;'>المبلغ</span>" required>
                    </div>
                    <div class="col-md-2">
                        <label for="transaction_cost">
                            Transaction Cost
                        </label>
                        <input type="number" step="any" name="transaction_cost" value="{{$fund->transaction_cost}}" id="transaction_cost" class="form-control inputFieldHeight" placeholder="Transaction Cost / <span style='font-size: 14px;'>تكلفة المعاملة</span>">
                    </div>
                    <div class="col-md-2">
                        <label for="transaction_number">
                            Transaction Number
                        </label>
                        <input type="text" name="transaction_number" value="{{$fund->transaction_number}}" id="transaction_number" class="form-control inputFieldHeight" placeholder="Transaction Number / <span style='font-size: 14px;'>رقم المعاملة</span>">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body bg-white">
                <div class="row px-1">
                    <div class="col-md-7">
                        ...
                        <input type="text" name="note" id="note" value="{{$fund->note}}" class="form-control inputFieldHeight" placeholder="note / <span style='font-size: 14px;'>ملاحظة</span>">
                    </div>
                    ...
                    <div class="col-sm-2 text-right d-flex justify-content-end mt-2 mb-1">
                        ...
                        <a href="{{ route('fund-collection.index') }}" class="btn btn-warning d-none" id="newButton">
                            New 
                        </a>
                    </div>
                </div>
