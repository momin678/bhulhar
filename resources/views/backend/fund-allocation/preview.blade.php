...
<section class="print-hideen border-bottom" style="background: #364a60;">
    <div class="d-flex flex-row-reverse" style="padding-top: 5px;padding-right: 8px;">
        ...
        <div class="" style="padding-right: 3px;margin-top: 6px;">
            <a  class="btn btn-icon btn-success univarsal-print"  onclick="handlePrintClick('print-contain') " title="Allocation Print  "><i class="bx bx-printer"></i></a>
        </div>
...
<section class="print-hidee" id="print-contain">


    <div class="cardStyleChange bg-white p-2">
        <div class="row">
            <div class="col-sm-12">
                <h3 class="text-center print-hidden"> Fund Allocation</h3>
                <div class="customer-info">
                    <div class="row ml-1 mr-1 "style="border: 2px solid #bdbdbd;">
                        <div class="col-md-6 row">
                            <div class="col-6 customer-static-content">
                                From Account  :<br>
                                Amount  <br>
                                Transaction Cost : <br>
                            </div>
...
<div class="img receipt-bg">
    <img src="{{ asset('img/finallogo.PNG') }}" class="img-fluid" style="position: fixed; top: 220px; left: 170px; opacity: 0.3; width: 600px !important; height: 400px;" alt="">
</div>
<div class="img receipt-bg">
    <img src="{{ asset('img/finallogo.PNG') }}" class="img-fluid" style="position: fixed; top: 920px; left: 170px; opacity: 0.3; width: 600px !important; height: 400px;" alt="">
</div>
