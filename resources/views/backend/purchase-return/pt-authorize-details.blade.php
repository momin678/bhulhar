...
@push('css')
@endpush
@section('title', 'purchase return authorize details')
@section('content')
    <!-- BEGIN: Content-->
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                        <form action="{{route('purchase-temp-trasfer')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body content-padding">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4 col-12">
                                                ...
                                                <input type="date" name="challan_number" class="form-control" required value="{{date('d/m/Y', strtotime($pt_info->date))}}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <a class="btn btn-warning" href="{{route('authorize-pt-rejected', $pt_info->id)}}">Rejected</a>
                                <a class="btn btn-success" href="{{route('authorize-pt-submit', $pt_info->id)}}">Authorize</a>
                            </div>
                        </form>
                        <div id="authorizeRejectedForm" style="display: none;">
                            <form action="{{route("authorize-pt-reviece")}}" method="post">
                                @csrf
                                <div class="row">
