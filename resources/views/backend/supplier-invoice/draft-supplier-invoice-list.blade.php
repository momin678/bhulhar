    ...
    <div class="content-wrapper">
        <div class="content-body">
            ...
            <div class="tab-content bg-white">
                @include('backend.supplier-invoice.sub-head',['activeMenu' => 'draft'])
                                                ...
                                                <tbody class="table-sm">
                                                    ...
                                                    <tr class="trFontSize">
                                                        ...
                                                        <td class="">
                                                            ...
                                                            <a href="{{ route('draft-pre-supplier-invoice-view', $invoice->id)}}" class="btn " title="View" style="padding-top: 1px; padding-bottom: 1px; height: 30px; width: 30px;">
