                            ...
                            <div class="col-12">
                                <div class="cardStyleChange">
                                    <section id="widgets-Statistics" class="pl-1">
                                        <form  method="GET" id="search_form" action="{{ route('supplier-invoice')}}">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <select name="supplier_id" class="inputFieldHeight form-control common-select2" required>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input type="text" name="from" class="inputFieldHeight form-control" id="from" placeholder="dd\mm\yyyy">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input type="text" name="to" class="inputFieldHeight form-control" id="to" placeholder="dd\mm\yyyy">
                                                    </div>
                                                </div>

                                                <div class="col-md-2 text-right pr-2">
                                                    <div class="form-group">
                                                        <button type="submit" class=" btn btn-info btn-search">Next</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                                    </section>
                                    <div class="table-responsive p-1" style="min-height: 300px">
                                        <form action="{{ route('supplier-invoice_process')}}" method="get">
                                            <input type="hidden" name="supplier_id" value="{{ isset($supplier_id)? $supplier_id: ''}}">
                                        @isset($records)
