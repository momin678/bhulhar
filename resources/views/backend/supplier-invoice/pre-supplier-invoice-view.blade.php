@extends('layouts.backend.app', ['invoice_status' => $invoice->status . '1'])
@section('content')
        ...
        <div class="content-wrapper">
            <div class="content-body">
                ...
                <div class="tab-content bg-white">
                    @include('backend.supplier-invoice.sub-head',['activeMenu' => 'approved'])
                    ...
                    <div class="row" id="table-bordered">
                        <div class="col-12">
                            ...
                            <p class="text-center">
                              ...
                              <a href="{{ route('pre-authorize-supplier-invoice',$invoice->id)}}" class="btn btn-info" onclick="return confirm('Please, Confirm?')">{{ $invoice->status=="Authorize"?"Authorize":"Approve" }}</a>
                                <a href="{{ route('pre-decline-supplier-invoice',$invoice->id)}}" class="btn btn-danger" onclick="return confirm('Please, Confirm?')">Decline</a>

                             @elseif (Auth::user()->hasPermission('app.invoice.invoice_authorize'))
                             @if ($invoice->status=="Authorize")
                                    <p class="text-center"> <a href="{{ route('pre-authorize-supplier-invoice',$invoice->id)}}" class="btn btn-info" onclick="return confirm('Please, Confirm?')">{{ $invoice->status=="Authorize"?"Authorize":"Approve" }}</a></p>
                                    <p class="text-center"> <a href="{{ route('pre-decline-supplier-invoice',$invoice->id)}}" class="btn btn-danger" onclick="return confirm('Please, Confirm?')">Decline</a></p>
