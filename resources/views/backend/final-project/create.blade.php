    ...
    <div class="content-wrapper">
        <div class="content-body">
            <div class="nav nav-tabs master-tab-section" id="nav-tab" role="tablist">
                <a href="{{route('projects.index')}}" class="nav-item nav-link " role="tab" aria-controls="nav-contact" aria-selected="false">
                    <div class="master-icon text-cente">
                        <img src="{{asset('assets/backend/app-assets/icon/list-icon.png')}}" alt="" srcset="" class="img-fluid" width="50">
                    </div>
                    <div>Project List</div>
                </a>
                <a href="{{route('projects.create')}}" class="nav-item nav-link active" role="tab" aria-controls="nav-contact" aria-selected="false">
                    <div class="master-icon text-cente">
                                                ...
                                                <div class="row d-flex align-items-center">
                                                    ...
                                                    <div class="col-sm-3 form-group ">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            value="{{ $proTemp->number }}" name="pro_no"
                                                            id="pro_no" readonly>
                                                    </div>
                                                    <input type="hidden" name="pro_id" id="pro_id"  value="{{ $proTemp->id }}">
