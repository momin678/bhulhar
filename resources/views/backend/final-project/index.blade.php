    ...
    <div class="content-wrapper">
        <div class="content-body">
            <div class="nav nav-tabs master-tab-section" id="nav-tab" role="tablist">
                <a href="{{route('projects.index')}}" class="nav-item nav-link active" role="tab" aria-controls="nav-contact" aria-selected="false">
                ...
                <a href="{{route('projects.create')}}" class="nav-item nav-link" role="tab" aria-controls="nav-contact" aria-selected="false">
                    <div class="master-icon text-cente">
                                ...
                                <table class="table table-sm table-bordered">
                                    ...
                                    @foreach ($projects as $Project)
                                        <tr>
                                            ...
                                            <td>{{ $Project->date }}</td>
                                            <td>{{ $Project->taxable_amount }}</td>
                                            <td>{{ $Project->vat }}</td>
                                            <td>{{ $Project->total_cost }}</td>
                                            <td>
                                                <a href="{{ route('projects.show',$Project) }}" class=""><img src="{{ asset('assets/backend/app-assets/icon/view-icon.png')}}" style=" height: 30px; width: 30px; margin-left: -12px;"></a>
                                            </td>
                                        </tr>
                                    @endforeach
