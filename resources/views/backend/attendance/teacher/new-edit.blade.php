                                            ...
                                            <div class="form-body">
                                                @if (isset($attendances))
                                                    <div class="cardStyleChange m-1">
                                                        <h4 class="">   Teacher Attendance Edit Of {{date('d/m/Y', strtotime($date1))}}</h4>
                                                        <form class="form form-vertical"
                                                                action="{{route('new-teacher-attendance-update')}}" method="POST" enctype="multipart/form-data">
                                                                    @csrf
                                                                    <input type="hidden" value="{{$date1}}" name="new_date">
                                                                   {{-- <h1>{{$date1}}</h1> --}}
                                                                    {{-- @method('PUT') --}}
                                                            <div class="form-body">
                                                                <div class="row">
