    ...
    <div class="content-wrapper">
        <div class="content-body">
            <div class="nav nav-tabs master-tab-section" id="nav-tab" role="tablist">
                ...
                <a href="{{route('new-teacher-attendance')}}" class="nav-item nav-link active" role="tab" aria-controls="nav-contact" aria-selected="false" id="parentProfileTab">
                    <div class="master-icon text-cente">
                        <img src="{{asset('assets/backend/app-assets/icon/employee-icon.png')}}" alt="" srcset="" class="img-fluid" width="50">
                    </div>
                    <div>Teacher Attendance</div>
                </a>
                <a href="{{route("new-teacher-leave")}}" class="nav-item nav-link" role="tab" aria-controls="nav-contact" aria-selected="false" id="mJournalAuthorizationSection">
                    <div class="master-icon text-cente">
                        <img src="{{asset('assets/backend/app-assets/icon/leave-icon.png')}}" alt="" srcset="" class="img-fluid" width="50">
                    </div>
                    <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Teacher Leave&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
                </a>
            </div>
                                            ...
                                            <div class="form-body">
                                                @if (isset($attendances))
                                                    <div class="cardStyleChange m-1">
                                                        <h4 class="">   Teacher Attendance Edit</h4>
                                                        <form class="form form-vertical"
                                                                action="{{route('new-teacher-attendance-update', ['new_date'=>$new_date])}}" method="POST" enctype="multipart/form-data">
                                                                    @csrf
                                                                    {{-- @method('PUT') --}}
                                                            <div class="form-body">
                                                                <div class="row">
                                                                                    ...
                                                                                    <td>
                                                                                        <ul class="list-unstyled mb-0">
                                                                                            <li class="d-inline-block mr-2">
                                                                                                <fieldset>
                                                                                                    <div class="radio">
                                                                                                        <input type="radio" class="present-status" name="status[{{$employee->employee_id}}]" id="present-{{$employee->id}}" {{$employee->status == 1?'checked':''}}  value="1" >
                                                                                            ...
                                                                                            <li class="d-inline-block mr-2">
                                                                                                <fieldset>
                                                                                                    <div class="radio">
                                                                                                        <input type="radio" class="absent-status" name="status[{{$employee->employee_id}}]" id="absent-{{$employee->id}}" {{$employee->status == 0?'checked':''}} value="0">
