                                ...
                                <div class="col-md-12 col-12">
                                    <div class="cardStyleChange">
                                        <div class="d-flex card-header">
                                            <h4 class="flex-grow-1">Search Teacher Attendance</h4>
                                                        ...
                                                        <form class="form form-vertical row" method="get" enctype="multipart/form-data">
                                                            <div class="col-md-8 col-12">
                                                                <label for="date">Date</label>
                                                                    <input type="text" id="new_date" class="inputFieldHeight form-control datepicker" name="new_date"  placeholder="dd/mm/yyyy"  value="" required>
                                                                    @error('date')
                                                        ...
                                                        <form class="form form-vertical row" method="get" enctype="multipart/form-data">
                                                            ...
                                                            <div class="col-12 col-md-3 d-flex ">
                                                                ...
                                                                <button type="submit" class="btn btn-primary formButton mPrint mt-2 mb-1" title="Searching" >
                                                                    <div class="d-flex">
                                                                        <div class="formSaveIcon">
                                                                            <img src="{{asset('assets/backend/app-assets/icon/Print-icon.png')}}" alt="" srcset="" width="20">
                                                                        </div>
                            ...
                            @if (isset($attendances))
                                <div class="cardStyleChange m-2">
                                        ...
                                        <table class="table mb-0 table-sm table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="text-center border-bottom trFontSize">
                                                    <td>{{ $attendance->employee->emp_id}} {{$attendance->employee->middle_name}} {{$attendance->employee->last_name }}</td>
                                    ...
                                    <div class=" d-flex justify-content-end mt-2">
                                        <a href="{{route('new-teacher-attendance-edit', ['new_date'=>$new_date])}}" class="btn btn-primary mr-1 mb-1">
                                            <div class="d-flex">
                                                <div class="formSaveIcon">
                        ...
                        @if ($date)
                            <div class="daily-attendance-report">
                                <div class=" d-flex justify-content-end">
                                    <a href="{{route('teacher-attendance-print', ['date'=>$date])}}" class="btn btn-primary mr-1 mb-1" target="blank">Print</a>
                                </div>
                                @php
                                    ...
                                    <tr>
                                        ...
                                        @foreach ($dates as $item)
                                            <td class=" text-center" style="background-color: #C5E0B4">
                                                {{count(App\EmployeeAttendance::where('date', date('Y-m-d', strtotime($item)))->whereIn('employee_id', function ($query) {
                                                    $query->select('id')
                                                        ->from('employees')
                                                        ->where('role', 5);
                                                })->where('status',1)->get())}}
                                    ...
                                    <tr>
                                        ...
                                        @foreach ($dates as $item)
                                            <td class="bg-light text-center">
                                                @php
                                                $f = 0;
                                                    $a =count(App\EmployeeAttendance::where('date', date('Y-m-d', strtotime($item)))->whereIn('employee_id', function ($query) {
                                                    $query->select('id')
                                                        ->from('employees')
                                                        ->where('role', 5);
                                                })->where('status',1)->get());
