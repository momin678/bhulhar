...
<body onload="window.print();">
                                    ...
                                    <div class="tex-center">
                                        <div class="row">
                                            ...
                                            <div class="col-8 text-center">
                                                ...
                                                <p class="m-0 invoice-p">{{$company_address->config_value}}, {{$company_tele->config_value}} {{$company_tele->config_value}},
                                                    {{$company_email->config_value}}  <br> {{$company_trn->config_value}} </p>
                                            </div>
    ...
    <div class="img">
        <img src="{{asset('icon/invoice-logo.png')}}" class="img-fluid"
            style="position: fixed; top:350px; left:210px; opacity:0.2; height:500px;" alt="">
    </div>
