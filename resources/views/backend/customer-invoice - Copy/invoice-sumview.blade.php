                                    ...
                                    <table   class="table table-sm ">
                                        <tr class="bg-color">
                                            ...
                                            <tr>
                                                ...
                                                @if ($item->toll_fee>0)
                                                    <tr class="trFontSize t-row">
                                                        <td>{{$sl + 1}}</td>
                                                        <td>Toll</td>
                                                        <td class="text-right pr-1">{{$item->total_trip}}</td>
                                                        <td class="text-right pr-1">{{$item->toll_fee}}</td>
                                                        <td class="text-right pr-1">{{$item->total_trip * $item->toll_fee}}</td>
                                                        <td class="text-right pr-1">0%</td>
                                                    </tr>
                                                @endif
                                                @php
                                                    $toll_fees += $item->total_trip * $item->toll_fee;
                                                    if ($item->toll_fee>0){
                                                        $sl +=2;
                                                    }else {
                                                        $sl +=1;
                                            ...
                                            <tr class="trFontSize">
                                                ...
                                                <td  class="text-right pr-1">{{ number_format($invoice_items->sum('total_qty'), 2)}}</td>
                                                <td></td>
                                            </tr>
                                            <tr class="trFontSize">
                                            ...
                                            <tr>
                                                ...
                                                @if ($item->toll_fee>0)
                                                    <tr>
                                                        ...
                                                        <td>{{$item->total_trip * $item->toll_fee}}</td>
                                                        <td>0%</td>
                                                        <td>{{$item->total_trip * $item->toll_fee}}</td>
                                                        <td>{{$item->total_trip * $item->toll_fee}}</td>
                                                    </tr>
