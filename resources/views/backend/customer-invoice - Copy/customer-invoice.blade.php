                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text"  class="inputFieldHeight lpo_number form-control" name="lpo_number" required>
                                    </div>
                                </div>
                                <div class="col-md-3 d-none">
                                    <div class="form-group">
                                        <label for="">DO. NO <span> <input type="checkbox" checked name="do_check" value="1"></span></label>
                                        <input type="text"  class="inputFieldHeight lpo_number form-control" name="do_number">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                ...
                                <table class="table mb-0 table-sm table-hover table-bordered">
                                    <thead class="thead-light">
                                        <tr style="height: 25px;">
                                            ...
                                            <th>Crusher/Site <span> <input type="checkbox" checked name="cursher_check" value="1"></span></th>
                                            ...
                                            <th>Third Party <span> <input type="checkbox" checked name="third_party_check" value="1"></span></th>
                                            ...
                                            <th>Total Toll Fee <span> <input type="checkbox" checked name="total_toll_check" value="1"></span></th>
                                        </tr>
                                    </thead>
                                    ...
                                    <tbody class="table-sm">
                                        ...
                                        <tr class="trFontSize">
                                            <td colspan="16" align="right">Total Taxable Amount</td>
                                            <td><input type="text"  style="max-width: 100px;"name="total_taxable_amount" required id="total_taxable_amount" readonly></td>
                                        </tr>
                                        <tr class="trFontSize">
                                            <td colspan="16" align="right">Total Discount Amount</td>
                                            <td><input type="text"  style="max-width: 100px;"name="total_discount_amount" id="total_discount_amount" readonly></td>
                                        </tr>
                                        <tr class="trFontSize">
                                            <td colspan="16" align="right">Total Vat Amount</td>
                                            <td><input type="text"  style="max-width: 100px;"name="total_vat_amount" id="total_vat_amount" readonly></td>
                                        </tr>

                                        <tr class="trFontSize">
                                            <td colspan="16" align="right">Total Toll Fee Amount</td>
                                            <td><input type="text"  style="max-width: 100px;"name="total_toll_fee_amount" id="total_toll_fee_amount" readonly></td>
                                        </tr>
                                        <tr class="trFontSize">
                                            <td colspan="16" align="right">Total Amount</td>
                                            <td><input type="text"  style="max-width: 100px;"name="total_amount_sum" id="total_amount" required readonly></td>
                                        </tr>
                                        <tr class="trFontSize">
                                            <td colspan="16" align="right">Payment Applied</td>
                                            <td><input type="decimal" style="max-width: 100px;" name="payment_amount" id="payment_amount" required></td>
                                        </tr>
                                        <tr class="trFontSize">
                                            <td colspan="16" align="right">Balance Due</td>
