                        ...
                        <div class="col-12">
                            ...
                            <p class="text-center">
                                ...
                                @else
                                    ...
                                    <a href="{{ route('authorize-invoice',$invoice->id)}}" class="btn btn-info" onclick="return confirm('Please, Confirm?')">{{ $invoice->status=="Authorize"?"Authorize":"Approve" }}</a>
                                    ...
                                    @elseif (Auth::user()->hasPermission('app.invoice.invoice_authorize'))
                                        ...
                                        <p class="text-center"> <a href="{{ route('authorize-invoice',$invoice->id)}}" class="btn btn-info" onclick="return confirm('Please, Confirm?')">{{ $invoice->status=="Authorize"?"Authorize":"Approve" }}</a></p>
