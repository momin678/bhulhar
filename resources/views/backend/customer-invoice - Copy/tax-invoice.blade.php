                                                    ...
                                                    <tbody class="table-sm">
                                                        ...
                                                        <tr class="trFontSize">
                                                            ...
                                                            <td class="text-right pr-1">
                                                                <a href="{{ route('authorize-invoice', $invoice->id)}}" onclick="return confirm('Are you sure to Submit this?')" class="btn" title="Submit" style="padding-top: 1px; padding-bottom: 1px; height: 30px; width: 30px; padding-left:5px;">
                                                                ...
                                                                <a href="{{ route('decline-invoice-edit', $invoice->id)}}"  class="btn" title="Edit" style="padding-top: 1px; padding-bottom: 1px; height: 30px; width: 30px; padding-left:5px;">
                                                                    <img src="{{asset('assets/backend/app-assets/icon/edit-icon.png')}}" style=" height: 30px; width: 30px;">
                                                                </a>
                                                                @endif --}}
                                                                @if ($invoice->status=='Decline' && $invoice->created_by==Auth::id())
