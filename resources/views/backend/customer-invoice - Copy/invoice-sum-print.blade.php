...
<body onload="window.print();">
                        ...
                        <div class="page-container">
                            <div class="page">
                                ...
                                <table class="table table-bordered table-header">
                                    <tr >
                                        <th>CUSTOMER NAME</th>
                                        <th class="text-left">: {{ $invoice->customer->pi_name }}</th>
                                        <th>INVOICE NO</th>
                                        <th>: {{ $invoice->status=='Draft' ? "Draft Invoice": $invoice->invoice_no }} </th>
                                    ...
                                    <tr >
                                        <th>ADDRESS</th>
                                        <th class="text-left">: {{ $invoice->customer->address }} {{ $invoice->customer->con_no != null ? ', Contact No- '.$invoice->customer->con_no : '' }}</th>
                                        <th>DATE</th>
                                    ...
                                    <tr >
                                        <th>TRN</th>
                                        <th class="text-left">: {{ $invoice->customer->trn_no }}</th>
                                        <th>PAYMODE</th>
                                        <th>: {{ $invoice->pay_mode }}</th>
                                    </tr>
                                    <tr >
    ...
    <div class="footer">
        <img src="{{ asset('img/knooz-footer.png') }}" alt="Footer image" width="100%" height="30px"
            style="float:left; background-size: cover; padding-left:60px;padding-right:30px;"><br>
    ...
    <div class="img">
        <img src="{{ asset('img/knooz-bg.png')}}" class="img-fluid" style="position: fixed; top:300px; left:30px; opacity:0.2; height:500px;" alt="">
    </div>
