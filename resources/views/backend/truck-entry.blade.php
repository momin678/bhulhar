                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 col-12 ">
                                                    ...
                                                    <input type="text" name="vehicle_number" class="inputFieldHeight form-control" placeholder="Vehicle Number" required>
                                                </div>
                                                <div class="col-md-4 col-12 ">
                                                    <label for="">Brand</label>
                                                    <input type="text" name="brand" class="inputFieldHeight form-control" placeholder="Brand" required>
                                                </div>
                                                <div class="col-md-4 col-12 ">
                                                    <label for="">Model </label>
                                                    <input type="text" name="model" class="inputFieldHeight form-control" placeholder="Model" required>
                                                </div>
                                                <div class="col-md-4 col-12 commonSelect2Style">
                                                    <label for="">Origin</label>
                                                    <select name="origin" id="" class="inputFieldHeight form-control common-select2" required>
                                                ...
                                                <div class="col-md-4 col-12 ">
                                                    ...
                                                    <input type="text" name="engine_capacity" class="inputFieldHeight form-control" placeholder="Engine Capacity" required>
                                                </div>
                                                <div class="col-md-4 col-12 ">
                                                    <label for="">Number of Tyres</label>
                                                    <input type="text" name="number_of_tyres" class="inputFieldHeight form-control" placeholder="Number of Tyres" required>
                                                </div>
                                                <div class="col-md-4 col-12 commonSelect2Style">
                                                    <label for="">Owner</label>
                                                    <select name="owner" id="" class="inputFieldHeight form-control common-select2" required>
                                    ...
                                    <div class="card-body">
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 col-12 ">
                                                    <label for="">Brand</label>
                                                    <input type="text" name="brand" id="brand_edit" class="inputFieldHeight form-control" placeholder="Brand" required>
                                                </div>
                                                <div class="col-md-4 col-12 ">
                                                    <label for="">Model </label>
                                                    <input type="text" name="model" id="model_edit" class="inputFieldHeight form-control" placeholder="Model" required>
                                                </div>
                                                <div class="col-md-4 col-12 commonSelect2Style">
                                                    <label for="">Origin</label>
                                                    <select name="origin" id="origin_edit" class="inputFieldHeight form-control common-select2" required>
                                                        <option value="">Select Country</option>
                                                        @foreach ($countries as $country)
                                                        <option value="{{$country->name}}">{{$country->name}}</option>
                                                        @endforeach
                                                ...
                                                <div class="col-md-4 col-12 ">
                                                    <label for="">Engine Capacity</label>
                                                    <input type="text" name="engine_capacity" id="engine_capacity_edit" class="inputFieldHeight form-control" placeholder="Engine Capacity" required>
                                                </div>
                                                <div class="col-md-4 col-12 ">
                                                    <label for="">Number of Tyres</label>
                                                    <input type="text" name="number_of_tyres" id="number_of_tyres_edit" class="inputFieldHeight form-control" placeholder="Number of Tyres" required>
                                                </div>
                                                <div class="col-md-4 col-12 commonSelect2Style">
                                                    <label for="">Owner</label>
