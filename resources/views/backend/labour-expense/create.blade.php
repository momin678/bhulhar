            ...
            <div class="tab-content journaCreation">
                <div id="journaCreation" class="tab-pane active">
                    <section id="widgets-Statistics">
                        <form action="{{ route('labour-expense.store') }}" method="POST" enctype="multipart/form-data" >
                            @csrf
                                ...
                                <div class="card-body pb-1">
                                    <div class="row m-1">
                                        <div class="col-md-3 changeColStyle">
                                            ...
                                            <input type="text" class="form-control inputFieldHeight" name="date" id="date" placeholder="dd/mm/yyyy" required>
                                            @error('date')
                                            ...
                                            <table class="table table-bordered table-sm ">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="width: 20%;text-align:center;">Labour Name </th>
                                                ...
                                                <tbody id="TBody">
                                                    <tr id="TRow" class="d-none">
                                                        ...
                                                        <td>
                                                            <input type="number" class="form-control text-end rate" name="inputs[0][rate]" onkeyup="Calc(this);" step="any">
                                                        </td>
                                                        <td>
...
<script>
    ...
    function option(v) {
        ...
        $.ajax({
        url: "{{ route('labour-salary-per-hour') }}",
        method: 'GET',
        data: {
                id: id
            },
        ...
        success: function(res) {
            var subJobGroupElement = document.getElementsByClassName("rate")[index];
            subJobGroupElement.value = res;
        },
        error: function(err) {
