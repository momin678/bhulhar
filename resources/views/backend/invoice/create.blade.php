    ...
    <div class="content-wrapper">
        <div class="content-body">
            <div class="nav nav-tabs master-tab-section" id="nav-tab" role="tablist">
                <a href="{{route('invoice.index')}}" class="nav-item nav-link " role="tab" aria-controls="nav-contact" aria-selected="false">
                    <div class="master-icon text-cente">
                        <img src="{{asset('assets/backend/app-assets/icon/list-icon.png')}}" alt="" srcset="" class="img-fluid" width="50">
                    </div>
                    <div>Invoice List</div>
                </a>
                <a href="{{route('invoice.create')}}" class="nav-item nav-link active" role="tab" aria-controls="nav-contact" aria-selected="false">
                    <div class="master-icon text-cente">
                                                ...
                                                <div class="row d-flex align-items-center">
                                                    ...
                                                    <div class="col-sm-3 form-group ">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            value="{{ $invoice_temp->number }}" name="invoice_no"
                                                            id="invoice_no" readonly>
                                                    </div>
                                                    <input type="hidden" name="invoice_id" id="invoice_id"  value="{{ $invoice_temp->id }}">
                                                ...
                                                <div class="row d-flex align-items-center">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" step="any" name="total" id="total" class="form-control total" >
                                                        </div>
                                                    </div>
