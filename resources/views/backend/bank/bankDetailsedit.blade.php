                            ...
                            <form action="{{ route('bankDetailsUpdate', $bank) }}" method="POST">
                                ...
                                <div class="row match-height">
                                    <div class="col-md-4 changeColStyle">
                                        ...
                                        <input type="text" id="" class="form-control inputFieldHeight" placeholder="Bank Name" disabled readonly value="{{ $bank->bank_code }}">
                                    </div>
                                    <div class="col-md-4 changeColStyle">
                                        <label>Bank Name</label>
                                        <input type="text" id="bank_name" class="form-control inputFieldHeight" name="bank_name" value="{{ $bank->bank_name }}" placeholder="Bank Name" required>
                                        @error('bank_name')
                                    ...
                                    <div class="col-md-4 changeColStyle">
                                        ...
                                        <input type="text" id="branch" class="form-control inputFieldHeight" value="{{ $bank->branch }}" name="branch" placeholder="Branch Name" required>
                                        @error('branch')
                                            <div class="btn btn-sm btn-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-4 changeColStyle">
                                        ...
                                        <input type="text" id="signatory" class="form-control inputFieldHeight" name="signatory" value="{{ $bank->signatory }}" placeholder="Account Title" required>
                                        @error('signatory')
                                            <div class="btn btn-sm btn-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-4 changeColStyle">
                                        ...
                                        <input type="number" id="ac_no" class="form-control inputFieldHeight" name="ac_no" value="{{ isset($bank) ? $bank->ac_no : '' }}"placeholder="Account Number" required>
                                        @error('ac_no')
                                            <div class="btn btn-sm btn-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-4 changeColStyle">
                                        <label>IBAN</label>
                                        <input type="text" id="" class="form-control inputFieldHeight" name="bank_ibam" value="{{$bank->bank_ibam}}" placeholder="IBAN" >
                                    </div>
                    ...
                    <div class="mb-1">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <a href="#" class="btn btn-xs mPrint formButton bank_list_print" title="Print" target="_blank"><img  src="{{asset('assets/backend/app-assets/icon/print-icon.png')}}" alt="" srcset="" class="img-fluid" width="30"> Print</a>
