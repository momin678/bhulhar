                                            ...
                                            <section id="widgets-Statistics" class="mt-2 mb-1">
                                                <div class="row">
                                                        ...
                                                        <form action="">
                                                            <div class="changeColStyle">
                                                                ...
                                                                <input type="text" class="form-control inputFieldHeight"
                                                                    name="search"
                                                                    placeholder="Search by material, serial no, truck no">
                                                            </div>
                                                        </form>
                                                    </div>
                                                    <div class="col-md-7 mt-2">
                                                        ...
                                                        <button type="button" data-target="#truck_excel_download" data-toggle="modal" class="mExcelButton btn btn_create formButton mr-1 float-right" title="Export To Excel">
                                                            <div class="d-flex">
                                                                <div class="formSaveIcon">
                                ...
                                <tr id="TRow" class="d-none p-0 h6">
                                    ...
                                    <td class="p-0">
                                        <select name="inputs[0][driver_name]" required
                                            class="form-control inputFieldHeight smallFontSize driver_name" disabled>
                                    ...
                                    <td class="p-0">
                                        <select name="inputs[0][crusher]" required
                                            class="form-control inputFieldHeight crusher smallFontSize rate_tollfee" disabled>
                                    ...
                                    <td class="p-0">
                                        <select name="inputs[0][dstm]" required
                                            class="form-control inputFieldHeight dstm smallFontSize rate_tollfee" disabled>
                                    ...
                                    <td class="p-0">
                                        <input type="number" name="inputs[0][rate]" required
                                            class="form-control inputFieldHeight rate smallFontSize" placeholder="Rate" step="any"
                                            disabled>
                                    </td>
                                    <td class="p-0">
                                    ...
                                    <td class="p-0">
                                        <input type="number" name="inputs[0][toll_fee]" required
                                            class="form-control inputFieldHeight toll_fee smallFontSize" placeholder="Toll Fee"
                                            {{$toll_setup->value=='Automatic'?'readonly':''}}  step="any" disabled>
                                    </td>
                                    <td class="p-0 d-none">
                                        <select name="inputs[0][toll_name]" class="form-control last-select inputFieldHeight smallFontSize" disabled>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <a href="{{asset('truck service add excel sample.xlsx')}}">Sample Download</a>
...
<div class="modal fade bd-example-modal-lg" id="truck_excel_download" tabindex="-1" rrole="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <section class="print-hideen border-bottom">
            <div class="d-flex ">
                <h4 class="mr-auto pl-2 pt-1">Excel Export</h4>
                <div class="mIconStyleChange"><a href="#" class="close btn-icon btn btn-danger" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><i class='bx bx-x'></i></span></a></div>
            </div>
        </section>
        <form action="{{route('truck-service-export')}}" method="post" class="form form-vertical"  style="padding: 25px;">
            @csrf
            <section id="basic-vertical-layouts">
                <div class="cardStyleChange">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="party_infos.pi_name as party" checked  name="truck_service_excel_field_name[PARTY]">
                                <label class="form-check-label">
                                    PARTY
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="employees.full_name as driver_name" checked name="truck_service_excel_field_name[DRIVER NAME]">
                                <label class="form-check-label">
                                    DRIVER NAME
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="truck_records.date as date" checked name="truck_service_excel_field_name[DATE]">
                                <label class="form-check-label">
                                    DATE
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="trucks.vehicle_number as truck_id" checked name="truck_service_excel_field_name[TRUCK]">
                                <label class="form-check-label">
                                    TRUCK
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="truck_records.material as material" checked name="truck_service_excel_field_name[MATERIAL]">
                                <label class="form-check-label">
                                    MATERIAL
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="truck_records.crusher as crusher" checked name="truck_service_excel_field_name[CRUSHER]">
                                <label class="form-check-label">
                                    CRUSHER
                                </label>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="truck_records.destination as destination" checked name="truck_service_excel_field_name[DESTINATION]">
                                <label class="form-check-label">
                                    DESTINATION
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="truck_records.weight as weight" checked name="truck_service_excel_field_name[WGT]">
                                <label class="form-check-label">
                                    WGT
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="truck_records.rate as rate" checked name="truck_service_excel_field_name[RATE]">
                                <label class="form-check-label">
                                    RATE
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="truck_records.commision as commision" checked name="truck_service_excel_field_name[COMMISSION]">
                                <label class="form-check-label">
                                    COMMISSION
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="truck_records.tkt_number as tkt_number" checked  name="truck_service_excel_field_name[TKT NUMBER]">
                                <label class="form-check-label">
                                    TKT NUMBER
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="truck_records.toll_fee as toll_fee" checked name="truck_service_excel_field_name[TOLL FEE]">
                                <label class="form-check-label">
                                    TOLL FEE
                                </label>
                            </div>
                    ...
                    <div class="col-md-12 d-flex justify-content-end" style="padding-top:10px;">
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary btn_create formButton" title="Export">
                                <div class="d-flex">
                                    <div class="formSaveIcon">
...
<script>
    function BtnAdd(trow, tbody) {
        ...
        check_vehicle(newRow);
    }
    
     function check_vehicle(tr){
        var truck_id= tr.find('.truck_id').val();
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if(response.id==5)
                {
                    tr.find('.commision').removeAttr('readonly');
                    check_truck_woner_status = 1;
                }
                else
                {
                    tr.find('.commision').prop('readonly', true);
                    tr.find('.commision').val('');
                    check_truck_woner_status = 0;
                }
                // $("#fld_material").focus();
...
<script>
    ...
    let check_truck_woner_status = 1;
    $(document).on('change', '.truck_id', function(e){
    ...
    $(document).on('change', '.rate_tollfee', function(e){
        var tr =  $(this).closest('tr');
        rateChack(tr);
        toll_rate_check(tr);
    });
    ...
    function rateChack(tr){
        var fld_driver = tr.find(".driver_name").val();
        var fld_crusher = tr.find(".crusher").val();
        var fld_dstn = tr.find('.dstm').val();
        var _token = $('input[name="_token"]').val();
        if(fld_crusher && fld_dstn){
            $.ajax({
                ...
                data: {
                    ...
                    driver_id:fld_driver,
                    _token: _token,
                },
                success: function(response) {
                    if(response){
                        tr.find(".rate").val(response[0].customer_rate);
                        if(check_truck_woner_status){
                            if(response[1]>100){
                                tr.find(".commision").val(25);
                            }else if(response[1]>70){
                                tr.find(".commision").val(response[0].commission_rate+10);
                            }else{
                                tr.find(".commision").val(response[0].commission_rate);
                            }
                        }
                        // tr.find(".toll_fee").val(response[0].rak_toll+response[0].sharjah_toll+response[0].fnrc_toll);
                    }else{
                        if(fld_crusher && fld_dstn){
