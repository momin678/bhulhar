                                                        ...
                                                        <table class="table table-hover mb-0 table-sm">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr style="font-size: 12px;">
                                                                    ...
                                                                    <td>
                                                                        <a href="#" class="btn settingEdit" title="Edit" id="{{$setting->id}}" style="padding-top: 1px; padding-bottom: 1px; height: 30px; width: 30px;">
...
<div class="modal fade bd-example-modal-lg" id="newSettingAdd" tabindex="-1" rrole="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        @include('backend.settings.setting-create-modal')
      </div>
    </div>
</div>
