                                                        ...
                                                        <tr id="TRow" class="text-center invoice_row">
                                                            <td>
                                                                <div
                                                                    ...
                                                                    <textarea name="group-a[0][multi_acc_head]"  placeholder="Item Description" id="" cols="30" rows="1"  class="form-control" style="height: 36px" required></textarea>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <input name="group-a[0][unit]" type="text" required class="text-center inputFieldHeight2 unit form-control "style="width: 100%;height:36px;">
                                                            </td>
