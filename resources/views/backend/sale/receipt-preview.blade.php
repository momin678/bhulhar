...
<section class="print-hideen border-bottom" style="padding: 5px 15px;background:#364a60;">
    <div class="d-flex flex-row-reverse">
        <div class="pr-1" style="margin-top: 5px;">
            ...
            <a href="#" class="close btn-icon btn btn-danger" data-dismiss="modal" aria-label="Close" title="Close"><span
                    aria-hidden="true"><i class='bx bx-x' style="padding-bottom: 3px;"></i></span></a>
        </div>
        <div class="" style="margin-top: 5px;padding-right: 3px;"><a href="#" onclick="window.print();" class="btn btn-icon btn-success"><i
                    class="bx bx-printer"  data-bs-toggle="tooltip" data-bs-placement="bottom" title="Print"></i></a></div>
        ...
        @else
            <div class="" style="padding: 5px 3px;"><a href="{{ route('receipt-realised', $recept) }}"
            ...
            <div class="" style="white-space: nowrap;padding: 5px 0px;"><a href="#" class="btn btn-sm btn-icon btn-info " data-toggle="modal" data-target="#notSubmit" title="Not Submited"><i class="fa fa-ban" style="font-size:17px"></i></a></div>
            <div class="" style="padding: 5px 3px;"><a href="{{ route('receipt-declined', $recept) }}"
                    class="btn btn-sm btn-icon {{ $recept->status == 'Declined' ? 'btn-warning' : 'btn-danger' }}" title="Declined"
                    style="{{ $recept->status == 'Declined' ? 'pointer-events: none' : '' }}"><i class="fa fa-hourglass-start" style="font-size:17px"></i></a></div>
        @endif
...
<section id="widgets-Statistics">
    <div class="payment-voucher px-2 pt-1 pb-4" style=" border: 1px solid; margin: 20px; border-radius: 20px;">
                ...
                <div class="w-100" style="border-bottom:1px dashed #111;margin-left: 15px;">
                    <p style="margin:0 !important; padding:0!important;color:#313131;font-size:15px;font-weight:500 !important; padding-left:30px">
                      @foreach ($recept->items as $r)
                        {{$r->invoice?$r->invoice->invoice_no:$r->invoice?$r->sale_revenue->invoice_no}}
                      @endforeach
        ...
        <div class="d-flex justify-content-between aligin-items-center mb-1">
            ...
            <div class="w-100" style="border-bottom:1px dashed #111;">
                <p style="margin:0 !important;padding:0!important;color:#313131;font-size:15px;font-weight:500 !important; padding-left:30px">
                    <td>   {{ $recept->name==null?  $recept->party?$recept->party->pi_name:'' : $recept->name}}</td>
    ...
    <div class="container mt-1 print-hide">
...
<div class="img receipt-bg">
    <img src="{{ asset('img/knooz-bg.PNG') }}" class="img-fluid" style="position: fixed; top: 680px; left: 30px; opacity: 0.5; width: 1000px !important; height: 450px;" alt="">
</div>
