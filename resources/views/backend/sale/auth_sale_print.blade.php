                                    ...
                                    <tbody class="user-table-body">
                                        @foreach (\App\SaleItem::where('sale_id',$sale->id)->get() as  $item)
                                            <tr class="text-center">
                                                ...
                                                <td><pre class="text-left border-0">{{$item->item_description}}</pre>
                                             </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center" style="background: #706f6f33">{{$sale->amount}}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-center" colspan="3" > </td>

                                                <td class="text-left pr-1" colspan="2" style="background: #706f6f33">VAT{{'@'.$standard_vat_rate}}%</td>
                                                <td class="text-center" style="background: #706f6f33">{{$sale->vat}}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-center" colspan="3" > </td>
