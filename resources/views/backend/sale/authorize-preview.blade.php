...
<section class="print-hideen border-bottom" style="padding: 5px 15px;background:#364a60;">
    <div class="d-flex flex-row-reverse">
        ...
        <div class="" style="padding-right: 3px;margin-top: 6px;"><a href="{{route('auth-sale-print',$sale->id)}}" target="_blank" class="btn btn-icon btn-success" title="Print"><i class="bx bx-printer"></i></a></div>

        <div class=" show-edit-form" style="padding-right: 3px;margin-top: 6px;"><a class="btn btn-icon btn-primary" href="{{ route('proforma-invoice-edit', ['id' => $sale->id]) }}" title="Edit"> <i class='bx bx-edit-alt'></i></a></div>
        <div class="" style="padding-right: 3px;margin-top: 6px;"><a href="{{route('sale.delete',$sale)}}" class="btn btn-sm btn-icon btn-danger" title="Delete"><i class="bx bx-trash"></i></a></div>

        <div class="w-100">
            <h4 style="font-family:Cambria;font-size: 2rem;color:white;"> {{$sale->invoice_type=="Tax Invoice"? 'Tax Invoice':($sale->invoice_type=="Proforma Invoice"?'Proforma Invoice':'Invoice')}}</h4>
        </div>
    </div>
</section>
@php
    ...
    <div class="row pt-2">
        <div class="col-md-12">
            ...
            <div class="text-center">
                <h5 class="ml-1 mr-1" style="background: #E6BC99; margin-top: 5px;margin-bottom:0px;"> {{$sale->invoice_type=="Tax Invoice"? 'Tax Invoice':($sale->invoice_type=="Proforma Invoice"?'Proforma Invoice':'Invoice')}}</h5>
...
{{$item->item_description}}
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="background: #ada8a81c">{{$sale->amount}}</td>
                        </tr>
                        <tr>
                            <td class="text-center" colspan="4" > </td>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="background: yellow">{{$sale->total_amount}}</td>
                        </tr>
                        <tr>
    ...
    @if (isset($new))
    @else
    <div class="col-md-12 text-center print-hideen pb-2">
        @if($sale->authorized == 0)
        <a href="{{route('sale-authorize',$sale)}}" class="btn btn-info btn-sm" onclick="return confirm('about to authorize Sale. Please, Confirm?')"> Authorize </a>
        @else
        <a href="{{route('sale-approve',$sale)}}" class="btn btn-info btn-sm" onclick="return confirm('about to approve Sale. Please, Confirm?')"> Approve </a>
        @endif
