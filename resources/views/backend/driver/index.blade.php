                        ...
                        <div class="col-12">
                            <div class="cardStyleChange p-1">
                                <section id="widgets-Statistics" class="mb-1">
                                    <div class="d-flex">
                                        <h4 class="flex-grow-1">Driver List</h4>
                                        <div>
                                            ...
                                            <table class="table mb-0 table-sm table-hover">
                                                <thead  class="thead-light">
                                                    <tr style="height: 50px;">
                                                        ...
                                                        <th class="text-right pr-2">Due Commission</th>
                                                ...
                                                <tbody class="table-sm">
                                                    ...
                                                    <tr class="trFontSize">
                                                        ...
                                                        <td class="text-center">{{$item->gradeNeed?$item->gradeNeed->name:''}}</td>
                                                        <td class="text-right pr-3">{{number_format($item->driver_commission->sum('amount'),2)}}</td>
                                                        <td class="text-right pr-2">
                                                            <a href="#" class="btn driverInfoEdit truck_edit_btn" title="Edit" truck-id="{{$item->id}}" style="padding-top: 1px; padding-bottom: 1px; height: 30px; width: 30px;">
...
{{-- modal --}}
    <div class="modal fade" id="newTruckAddModal" tabindex="-1" rrole="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="content-body">
                <form class="form form-vertical" action="{{ route('driver.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-12 ">
                                                    ...
                                                    <input type="text" name="name" class="inputFieldHeight form-control" placeholder="Driver Name" required>
                                                </div>
                                                <div class="col-12">
    ...
    <div class="modal fade" id="driverInfoEditModal" tabindex="-1" rrole="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <section class="print-hideen border-bottom">
                <div class="d-flex flex-row-reverse">
            ...
            <div class="content-body" id="edit_driver_model">
...
@push('js')
<script>
    $(document).on("click", ".driverInfoEdit", function(e){
        e.preventDefault();
        var driver_id= $(this).attr('truck-id');
        var _token = $('input[name="_token"]').val();
        $.ajax({
            url: "{{ route('driver-edit-model') }}",
            method: "POST",
            data: {
                driver_id:   driver_id,
                _token: _token,
            ...
            success: function(response) {
                $('#edit_driver_model').html(response);
                $("#driverInfoEditModal").modal('show');
            }
        });
