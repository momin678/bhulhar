                            ...
                            <div class="mt-2">
                                <div class="row mb-1">
                                    ...
                                    <div class="col-md-6 text-right">
                                        ...
                                        <a href="#" class="btn btn-xs mExcelButton formButton" onclick="exportTableToCSV('profitcenterdetails.csv')" title="Export to Excel"><img  src="{{asset('storage/upload/icon/excel-icon.png')}}" alt="" srcset="" class="img-fluid" width="30">Excel</a href="#">
                                    </div>
                                </div>
                                            ...
                                            <tr class="text-center trFontSize" style="height: 40px;">
                                                ...
                                                <td>
                                                    <div style="margin-top: -12px;">
                                                        <a href="{{ route('profitCenEdit', $pCenter) }}" class="btn" style="height: 30px; width: 30px;" title="Edit"><img src="{{ asset('storage/upload/icon/edit-icon.png')}}" style=" height: 25px; width: 25px;"></a>
                                                        <a href="{{ route('profitCenDelete', $pCenter) }}" onclick="return confirm('about to delete profit center. Please, Confirm?')"  class="btn" style="height: 25px; width: 25px;padding: 0.467rem 0.8rem;" title="Delete"><img src="{{ asset('storage/upload/icon/delete-icon.png')}}" style=" height: 25px; width: 25px; margin-left: -12px;"></a>
                                                    </div>
                                                </td>
                                            </tr>
                                            @endforeach
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-12 d-flex justify-content-end mt-2">
                                                <button class="btn btn-info profit-center-form-btn formButton" data_target="{{ route('profitCenterForm') }}" id="profitCenterButton" style="margin-right: 0.2rem !important;"><img src="{{ asset('storage/upload/icon/add-icon.png')}}" alt="" srcset="" class="image-fluid" width="25">New</button>
