                ...
                <div class="tab-pane active">
                    <div class="content-body pt-1">
                        <section id="widgets-Statistics">
                                            ...
                                            <form action="" method="GET" class="d-flex row">
                                                <div class="row form-group col-md-3 mr-0">
                                                    <select name="party_name" id="party_name" class="form-control common-select2" required>
                                                        ...
                                                        <option value="{{$item->id}}" {{$party!=null? ($item->id==$party->id?'selected':''):''}}>{{$item->pi_name}} <small>({{$item->pi_type}})</small></option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-3 mr-0">
                                                    ...
                                                    onclick="handlePrintClick('print-123')">
                                                    <div class="d-flex">
                                                        <div class="formSaveIcon">
                            ...
                            @if($records!=null)
                            <div class="card-body pt-0 pb-0" id="print-123">
                                <div id="print-table">
                                    ...
                                    <div class="divFooter mb-1 ml-1 print-header-footer print-none " >
