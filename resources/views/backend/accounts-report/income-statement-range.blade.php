                    ...
                    <div class="content-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex-align-items-center gap-2">
                                ...
                                onclick="handlePrintClick('income-statement')">
                                    <div class="d-flex">
                                        <div class="formSaveIcon">
                        ...
                        <section id="widgets-Statistics ">
                            ...
                            <div class="card-body pt-0 pb-0" id="income-statement">
                                <table  class="table table-sm table-hover">
                                    ...
                                    <tr class="head-ledger" id="{{$unique_master_ac->ac_head?$unique_master_ac->ac_head->id:''}}">
                                                <td>{{$unique_master_ac->ac_head?$unique_master_ac->ac_head->fld_ac_head:''}} </td>
                                                <td></td>
