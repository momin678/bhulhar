                        ...
                        <div class="content-body">
                            <section id="widgets-Statistics">
                                ...
                                <div class="cardStyleChange">
                                    <div class="card-body mt-1">
                                        <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <input type="text"
                                                                ...
                                                                name="from" placeholder="From" id="from"
                                                                autocomplete="off">
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="text"
                                                                class="inputFieldHeight form-control datepicker"
                                                                name="to" placeholder="To" id="to"
                                                                autocomplete="off">
                                                        </div>
                                                        <div class="col-md-4">
                                                            <select name="search" id="search"
                                                                class="common-select2 form-control">
                                                                <option value="">Select Head</option>
                                                                @foreach ($journal_heads as $item)
                                                                    <option value="{{ $item->account_head_id . '/head' }}">
                                                                        {{ $item->ac_head?$item->ac_head->fld_ac_code:'' }}-{{ $item->ac_head?$item->ac_head->fld_ac_head :''}}
                                                                    </option>
                                                                @endforeach
                                                                @foreach ($master_groups as $item)
                                                                    <option
                                                                        value="{{ $item->master_account_id . '/master' }}">
                                                                        {{ $item->master_ac->mst_ac_code }}-{{ $item->master_ac->mst_ac_head }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                            ...
                                            <div class="col-md-3 text-right">
                                                ...
                                                onclick="handlePrintClick('widgets-Statistics1')">
                                                    <div class="d-flex">
                                                        <div class="formSaveIcon">
                                    ...
                                    <div class="card-body p-0" id="widgets-Statistics1">
                                        <h4 class="text-center">General Ledger</h4>
                                        <table class="table table-sm">
                                            @foreach ($journal_heads as $unique_acc_head)
                                                <tr class="text-center" style="background-color:#34465b;">
                                                    <th>{{ $unique_acc_head->ac_head?$unique_acc_head->ac_head->fld_ac_code:'' }}</th>
                                                    <th><a
                                                            href="#">{{ $unique_acc_head->ac_head?$unique_acc_head->ac_head->fld_ac_head:'' }}</a>
                                                    </th>
                                                    <th></th>
                                                    <th></th>
                                                    <th></th>
                                                ...
                                                <tr class="text-center">
                                                    ...
                                                    <th>Narration</th>
                                                    <th>Ref. No.</th>
                                                    <th>Debit <small>(@if(!empty($currency->symbole)){{$currency->symbole}}@endif)</small></th>
                                                    <th>Credit <small>(@if(!empty($currency->symbole)){{$currency->symbole}}@endif)</small></th>
                                                </tr>
                                                @php
                                                    $each_ledger_dr = 0;
                                                    $each_ledger_cr = 0;
                                                @endphp
                                                @foreach (App\JournalRecord::where('account_head_id', $unique_acc_head->account_head_id)->where('journal_id', '!=', 0)->where('opening_balance_entry', false)->orderBy('journal_date', 'ASC')->get() as $record)
                                                    @php
                                                    ...
                                                    @foreach ($r_count = App\JournalRecord::where('journal_id', $record->journal_id)->where('opening_balance_entry', false)->where('transaction_type', $reverse)->get() as $ledger_record)
                                                        @if ($r_count->count() > 1)
                                                            <tr class="text-center trFontSize journalDetails" v-type="main"
                                                                ...
                                                                <td>
                                                                    ...
                                                                    {{ $dr_amount = $record->transaction_type == 'DR' ? $ledger_record->amount : 0 }}
                                                                </td>
                                                                <td>

                                                                    {{ $cr_amount = $record->transaction_type == 'CR' ? $ledger_record->amount : 0 }}
                                                                </td>
                                                            </tr>
                                                        @else
                                                            <tr class="text-center trFontSize journalDetails" v-type="main"
                                                                ...
                                                                <td>
                                                                    ...
                                                                    {{ $dr_amount = $record->transaction_type == 'DR' ? $record->amount : 0 }}
                                                                </td>
                                                                <td>

                                                                    {{ $cr_amount = $record->transaction_type == 'CR' ? $record->amount : 0 }}
                                                                </td>
                                                            </tr>
                                                        @endif
                                                ...
                                                <tr class="text-center">
                                                    ...
                                                    <th>
                                                        ...
                                                        {{ $each_ledger_dr > $each_ledger_cr ? '0' : number_format($each_ledger_cr - $each_ledger_dr, 2,'.','') }}
                                                    </th>

                                                    <th>

                                                        {{ $each_ledger_dr > $each_ledger_cr ? number_format($each_ledger_dr - $each_ledger_cr, 2,'.','') : '0' }}
                                                    </th>
                                                </tr>
                                                <tr class="text-center">
                                                    <th></th>
                                                    ...
                                                    <th>
                                                        ...
                                                        {{ $each_ledger_dr > $each_ledger_cr ? number_format($each_ledger_dr, 2,'.','') : number_format($each_ledger_cr, 2,'.','') }}
                                                    </th>
                                                    <th>
                                            ...
                                            @foreach ($master_groups as $unique_mst)
                                                <tr class="text-center" style="background-color:#34465b;">
                                                ...
                                                @php
                                                    ...
                                                    $each_ledger_cr = 0;
                                                @endphp
                                                @foreach (App\JournalRecord::where('journal_id', '!=', 0)->where('master_account_id', $unique_mst->master_account_id)->where('opening_balance_entry', false)->orderBy('journal_date', 'ASC')->get() as $record)
                                                    @php
                                                        $reverse = $record->transaction_type == 'DR' ? 'CR' : 'DR';
                                                    @endphp
                                                    @foreach ($r_count = App\JournalRecord::where('journal_id', $record->journal_id)->where('opening_balance_entry', false)->where('transaction_type', $reverse)->get() as $ledger_record)
                                            ...
                                            @foreach ($openings as $unique_acc_head)
                                                <tr class="text-center" style="background-color:#34465b;color:white;">
                                                ...
                                                @php
                                                    ...
                                                    $each_ledger_cr = 0;
                                                @endphp
                                                @foreach (App\JournalRecord::where('account_head_id', $unique_acc_head->account_head_id)->where('journal_id', '!=', 0)->where('opening_balance_entry', true)->orderBy('journal_date', 'ASC')->get() as $record)
                                                    <tr class="text-center trFontSize journalDetails" v-type="main"
                                                        style="cursor: pointer;" id="{{ $record->journal_id }}">
                                                        <td>{{ \Carbon\Carbon::parse($record->journal_date)->format('d/m/Y') }}
                                                        </td>
                                                        <td>
                                                            Opening Balance
                                                        </td>
    ...
    <div class="card-body pt-0 pb-0">
        <table class="table table-sm">
            ...
            @foreach (App\JournalRecord::distinct()->get('account_head_id') as $unique_acc_head)
                <tr>
                    <th>{{ $unique_acc_head->ac_head?$unique_acc_head->ac_head->fld_ac_code :''}}</th>
                    <th>{{ $unique_acc_head->ac_head?$unique_acc_head->ac_head->fld_ac_head :''}}</th>
                    <th></th>
                ...
                @foreach (App\JournalRecord::where('account_head_id', $unique_acc_head->account_head_id)->get() as $record)
                    ...
                    @foreach (App\JournalRecord::where('journal_id', $record->journal_id)->where('transaction_type', $reverse)->get() as $ledger_record)
                        <tr class="text-center trFontSize">
                            ...
                            <td></td>
                            <td class="text-right">
                                {{ $dr_amount = $record->transaction_type == 'DR' ? $record->amount : 0 }} </td>
                            <td class="text-right">
                                {{ $cr_amount = $record->transaction_type == 'CR' ? $record->amount : 0 }}</td>
                        </tr>
                        @php
                            $each_ledger_dr = $each_ledger_dr + $dr_amount;
                            $each_ledger_cr = $each_ledger_cr + $cr_amount;
