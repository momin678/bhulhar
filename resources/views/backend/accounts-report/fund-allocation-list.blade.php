...
<section class=" border-bottom" style="padding: 5px 15px;background:#364a60;">
    <div class="d-flex flex-row-reverse">
        ...
        <div class="pr-1 w-100 pl-2">
            <h4 style="font-family:Cambria;font-size: 2rem;color:white;">Fund Allocation</h4>
        </div>
    </div>
</section>
        ...
        <table class="table table-bordered table-responsive-sm table-sm text-center">
            <thead class="thead">
                <tr >
                    ...
                    <th style="width: 150px;">Transaction Cost</th>
                    <th style="width: 150px;">Transaction Number</th>
                    <th>Action</th>
                    ...
                    <tr class="tr-item">
                        ...
                        <td style="padding-bottom: 11px; padding-top: 0px">
                            <div class="d-flex justify-content-center">
                                <a href="#" data="{{ 'fund-allocation-approval2/'. $item->id }}" class="btn btn-icon btn-warning pandding-accounting-approve" onclick="return confirm('Approve! Confirm?')" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Approve"><i class="bx bx-check"></i></a>
                            </div>
                        </td>
                    </tr>
