            ...
            <div class="tab-content journaCreation">
                <div id="journaCreation" class="tab-pane bg-white active">
                    ...
                    <section id="widgets-Statistics ">
                        ...
                        <div class="cardStyleChange thermal-print2">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div>
                        ...
                        <div id="print-table">
                            ...
                            <div class="card-body pt-0 pb-0">
                                <h2 class="text-center col-6">Daily Summary</h2>
                                <h2 class="text-center col-6">
                                    <h4 class="text-center col-6">
                                        @if ($from && $to)
                                ...
                                @php
                                    ...
                                    $bank_other_cost = $fund_allocation->where('account_id_from', 5)->sum('transaction_cost');
                                    $petty_cash_other_cost = $fund_allocation->where('account_id_from', 6)->sum('transaction_cost');

                                    $transfer_to_cash_from_bank = $fund_allocation->where('account_id_to', 1)->where('account_id_from', 5)->sum('amount');
                                    $transfer_to_cash_from_petty_cash = $fund_allocation->where('account_id_to', 1)->where('account_id_from', 6)->sum('amount');
                                    $transfer_from_cash_to_bank = $fund_allocation->where('account_id_from', 1)->where('account_id_to', 5)->sum('amount');
                                    $transfer_from_cash_to_petty_cash = $fund_allocation->where('account_id_from', 1)->where('account_id_to', 6)->sum('amount');

                                    $transfer_to_bank_from_petty_cash = $fund_allocation->where('account_id_to', 4)->where('account_id_from', 6)->sum('amount');
                                    $transfer_from_bank_to_petty_cash = $fund_allocation->where('account_id_from', 5)->where('account_id_to', 6)->sum('amount');
                                    $transfer_to_bank_from_visa_card = $fund_allocation->where('account_id_from', 6)->where('account_id_to', 4)->sum('amount');
                                    $transfer_from_bank_to_visa_card = $fund_allocation->where('account_id_from', 4)->where('account_id_to', 6)->sum('amount');
                                    ...
                                    $opening_balance_receipt_visa_card = $previous_fund_allocation->where('account_id_to', 6)->sum('amount');
                                    $opening_balance_payment_visa_card = $previous_fund_allocation->where('account_id_from', 6)->sum('amount');
                                    ...
                                    $opening_balance_receipt_bank_fund = $previous_fund_allocation->where('account_id_to', 5)->sum('amount');
                                    $opening_balance_payment_bank_fund = $previous_fund_allocation->where('account_id_from', 5)->sum('amount');
                                @endphp
                                {{-- chash --}}
                                <div class="row">
                                    <div class="col-md-6">
                                        <table class="table table-sm table-hover ">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 15% !important;" class="text-right pr-1">{{number_format($opening_balance_cash = (App\JournalRecord::dailyHeadOpeningBalance(1, $date, $from, $to) > 0 ? App\JournalRecord::dailyHeadOpeningBalance(1, $date, $from, $to) :0),2,'.','')}}</td>
                                                {{-- <td style="width: 15% !important;" class="text-right pr-1">{{number_format($opening_balance_cash =x($opening_balance_receive_cash+$opening_balance_receipt_cash_fund)-($opening_balance_payment_cash+$opening_balance_payment_cash_fund),2)}}</td> --}}
                                            </tr>
                                            ...
                                            <tr class="daily-summery" data="fund-transfer/5/1">
                                            ...
                                            <tr class="daily-summery" data="fund-transfer/1/5">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 15% !important;" class="text-right pr-1">
                                                    {{number_format(($opening_balance_cash+$today_cash_sale_receipts+$previous_cash_sale_receipts+$today_advance_cash_received+$transfer_to_cash_from_bank+$transfer_to_cash_from_petty_cash)
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <table class="table table-sm table-hover ">
                                            ...
                                            <tr>
                                                <td class="text-left pl-1">Opening Balance</td>
                                                <td style="width: 15% !important;" class="text-right pr-1">{{number_format($opening_balance_bank = (App\JournalRecord::dailyHeadOpeningBalance(2, $date,$from, $to) > 0 ? App\JournalRecord::dailyHeadOpeningBalance(2, $date,$from, $to) :0),2,'.','')}}</td>
                                            </tr>
                                            <tr class="daily-summery" data="bank-today-sale-received">
                                                <td class="text-left pl-1">Today's Bank Sales Received</td>
                                                <td style="width: 15% !important;" class="text-right pr-1">{{number_format($today_bank_sale_receipts->sum('Total_amount'),2)}}</td>
                                            </tr>
                                            ...
                                            <tr class="daily-summery" data="fund-transfer/6/5">
                                            ...
                                            <tr class="daily-summery" data="fund-transfer/5/6">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 15% !important;" class="text-right pr-1">
                                                    {{number_format(
                                                        ($opening_balance_bank+$today_bank_sale_receipts->sum('Total_amount')+$previous_bank_sale_receipts+$today_advance_bank_received+$transfer_from_cash_to_bank+$transfer_to_bank_from_petty_cash+$transfer_to_bank_from_visa_card)
                                                        -
