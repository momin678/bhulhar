                            ...
                            <section id="widgets-Statistics">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="d-flex gap-4 align-items-center">
                                        ...
                                        onclick="handlePrintClick('genaral-leger')">
                                            <div class="d-flex">
                                                <div class="formSaveIcon">
                                ...
                                <div class="cardStyleChange">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3">
                                                                <select name="search" id="search" class="common-select2 form-control">
                                                                    ...
                                                                    <option value="{{$item->account_head_id.'/head'}}">{{$item->ac_head?$item->ac_head->fld_ac_code:''}}-{{$item->ac_head?$item->ac_head->fld_ac_head:''}}</option>

                                                                    @endforeach
                                                                    @foreach ($master_groups as $item)
                                                                    <option value="{{$item->master_account_id.'/master'}}">{{$item->master_ac->mst_ac_code}}-{{$item->master_ac->mst_ac_head}}</option>
                                    ...
                                    <div class="card-body pt-0 pb-0" id="genaral-leger">
                                        ...
                                        <table class="table table-sm">
                                            @foreach ($journal_heads as $unique_acc_head)
                                                <tr>
                                                    ...
                                                    <th class="text-right">@if(!empty($currency->symbole)){{$currency->symbole}}@endif {{$each_ledger_dr =$unique_acc_head->headOpeningBalance($unique_acc_head->ac_head?$unique_acc_head->ac_head->id:'',$from)>0?$unique_acc_head->headOpeningBalance($unique_acc_head->ac_head?$unique_acc_head->ac_head->id:'',$from):'0.00'}}</th>
                                                    <th class="text-right">@if(!empty($currency->symbole)){{$currency->symbole}}@endif {{ $each_ledger_cr  = $unique_acc_head->headOpeningBalance($unique_acc_head->ac_head?$unique_acc_head->ac_head->id:'',$from)<0?($unique_acc_head->headOpeningBalance($unique_acc_head->ac_head?$unique_acc_head->ac_head->id:'',$from)*(-1)):'0.00'}}</th>
                                                </tr>
                                                <tr>
                                                    <th>Date</th>
                                                    <th>Narration</th>
        ...
        <table class="table table-sm">
            @foreach ($journal_heads as $unique_acc_head)
                <tr>
                    <th>{{ $unique_acc_head->ac_head?$unique_acc_head->ac_head->fld_ac_code:'' }}</th>
                    <th><a
                            href="{{ route('head-details', $unique_acc_head->account_head_id) }}">{{ $unique_acc_head->ac_head?$unique_acc_head->ac_head->fld_ac_head:'' }}</a>
                    </th>
                    <th>Opening Balance</th>
                    <th class="text-right">@if(!empty($currency->symbole)){{$currency->symbole}}@endif {{$each_ledger_dr =$unique_acc_head->headOpeningBalance($unique_acc_head->ac_head?$unique_acc_head->ac_head->id:'',$from)>0?$unique_acc_head->headOpeningBalance($unique_acc_head->ac_head?$unique_acc_head->ac_head->id:'',$from):'0.00'}}</th>
                    <th class="text-right">@if(!empty($currency->symbole)){{$currency->symbole}}@endif {{ $each_ledger_cr  = $unique_acc_head->headOpeningBalance($unique_acc_head->ac_head?$unique_acc_head->ac_head->id:'',$from)<0?($unique_acc_head->headOpeningBalance($unique_acc_head->ac_head?$unique_acc_head->ac_head->id:'',$from)*(-1)):'0.00'}}</th>
            ...
            @foreach ($openings as $unique_acc_head)
                <tr>
                    <th>{{ $unique_acc_head->ac_head->fld_ac_code }}</th>
                    <th><a
                            href="{{ route('head-details', $unique_acc_head->account_head_id) }}">{{ $unique_acc_head->ac_head->fld_ac_head }}</a>
                    </th>
                    <th></th>
                    <th class="text-right"></th>
                    <th class="text-right"></th>
