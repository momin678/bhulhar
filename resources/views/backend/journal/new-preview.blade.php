...
<section class="print-hideen border-bottom" style="padding: 5px 15px;background: #34465b;">
    <div class="d-flex flex-row-reverse" style="padding: 0 8px;">
        ...
        <div class="" style="padding-right: 3px;margin-top: 6px;"><a href="#" id="{{$journal->id}}" onclick="handlePrintClick('widgets-Statistics12')" class="btn btn-icon btn-success" title="Print"><i class='bx bx-printer'></i></a></div>
...
<section id="widgets-Statistics12">
    ...
    <div class="row pt-4">
        <div class="col-12 text-center print-none">
    ...
    <div class="divFooter mb-1 ml-1 pl-2 print-none">
