                ...
                <div id="journalList" class="tab-pane active p-1">
                    ...
                    <section class="">
                        <div class="row mb-1">
                            ...
                            <div class="col-md-6 text-right" style="padding-right: 210px!important;">
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm table-bordered table-hover" style="width: 1351px;">
                                <thead  class="thead">
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-bottom: 11px; padding-top: 0px">
                                                <div class="d-flex justify-content-center">
                                                    ...
                                                    <a href="#" class="btn mVoucherPreview" v-type="main" style="height: 25px; width: 25px;" title="Preview" data-id="{{$journal->id}}">
                                                        <img src="{{ asset('assets/backend/app-assets/icon/view-icon.png')}}" style=" height: 25px; width: 25px; margin-left: -12px;">
                                                    </a>
                                                </div>
                                             </td>
                                        </tr>
