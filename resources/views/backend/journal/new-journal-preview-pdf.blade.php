        ...
        <section>
            <div class="divFlex" style="margin-bottom:30px;">
                ...
                <div style="text-align: center; margin-top: -100px;">
                    <h2 style="line-height: .1;">{{ $school_name->config_value }}</h2>
                    <h6 style="line-height: .1;">{{ $school_address->config_value }}</h6>
                    <h6 style="line-height: .1;">Mobile {{ $school_tele->config_value }} <span style="padding-left:20px !important;"></span></h6>
                </div>
            </div>
        </section>
        <section>
