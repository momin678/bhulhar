                                    ...
                                    <div class="row mt-1 d-flex justify-content-center" style="">
                                        <div class="col-md-3 changeColStyle  col-right-padding">
                                            ...
                                            <select name="transection_type" class="common-select2 w-100" id="transection_type" required>
                                               ...
                                               <option value="Sales Entry">Sale</option>
                                        ...
                                        <div class="col-md-3 changeColStyle search-item-pi col-right-padding ">
                                                   <div class="row d-flex align-items-end">
                                                    <div class="col-10 col-right-padding customer-select">
                                            ...
                                            <table class="table table-bordered table-sm mb-0">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th  class="NoPrint"> <button type="button" class="btn btn-sm btn-success "style="border: 1px solid #fff;
                                                            color: #fff; border-radius: 10px;padding: 5px; margin: 4px;" onclick="BtnAdd()"><i class="bx bx-plus" style="color: white;margin-top: -5px;"></i></button>
                                                        </th>
                                                    </tr>
                                                </thead>
                                                <tbody id="TBody">
                                                    <tr id="TRow" >
                                                        ...
                                                        <td><input type="text" name="invoice_no[]" step="any" required  class="text-center form-control inputFieldHeight2 "style="width: 100%;height:36px;"></td>

                                                        <td><input type="number" name="multi_total_amount[]" step="any" required  class="text-center form-control inputFieldHeight2 amount_withvat"style="width: 100%;height:36px;"></td>
                                                            <td><input type="number" step="any"    class="text-center form-control amount_without_vat inputFieldHeight2"    name="multi_amount[]"  >
                                                        <td>
                                                            <input type="number"  step="any"    name="multi_tax_rate[]" required onchange="option(this);"onkeyup="gstSubtotal();"  class="text-center form-control multi-tax-rate inputFieldHeight2" style="width: 100%;height:36px;">
                                                        </td>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><input type="text" readonly id="total_amount" value="0.00" class="text-center form-control inputFieldHeight2 @error('total_amount') error @enderror inputFieldHeight total"
                                                             name="total_amount"  placeholder="TOTAL" readonly required>
                                                            @error('total_amount')
