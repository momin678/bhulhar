...
<section id="widgets-Statistics1" class="px-2">
    ...
    <div class="cardStyleChange">
        <div class="card-body">
            ...
            <div class="row d-flex align-items-center justify-content-center print-none">
                ...
                @endif
                <div class="col-12 d-flex justify-content-end print-hideen pr-0 print-none">
                    <button type="submit" class="btn mr-1 btn-info formButton" title="Authorize">
                        <a href="{{ route('journalMakeAuthorize',$journal) }}" onclick="return confirm('about to authorize journal. Please, Confirm?')" class="btn btn-info formButton btn-block">
