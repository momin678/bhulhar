    ...
    <div class="content-wrapper">
        <div class="content-body">
            <div class="nav nav-tabs master-tab-section" id="nav-tab" role="tablist">
                ...
                <a href="{{route("grades.index")}}" class="nav-item nav-link active" role="tab" aria-controls="nav-contact" aria-selected="false" id="mJournalAuthorizationSection">
                    <div class="master-icon text-cente">
                        ...
                        <div class="row" id="table-bordered">
                            <div class="col-12">
                                <div class="cardStyleChange">
                                    <h4 class="ml-2 mt-2">Grades Edit</h4>
                                    <div class="card-body">
                                        <!-- table bordered -->
                                        <div class="row">
                                            <div class="col-md-6">
                                                <form action="{{route('grades.update', $componemts_info->id)}}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PUT')
                                                    ...
                                                    @foreach ($components as $item)
                                                        <tr  class="data-row">
                                                            ...
                                                            <td style="padding-bottom: 11px; padding-top: 0px" class="text-right pr-2">
                                                                <a href="{{route('grades.edit', $item->id)}}" class="btn" style="height: 30px; width: 30px;" title="Eidt">
