    ...
    <div class="content-wrapper">
        <div class="content-body">
            ...
            <div class="tab-content bg-white">
                <div id="studentProfileList" class="tab-pane active px-2" style="max-width: 925px;">
                    <div class="row" id="table-bordered">
                        <div class="col-12">
                            <div class="cardStyleChange">
                                <div class="">
                                    <div class="d-flex mt-1 justify-content-between align-items-center">
                                        @include('clientReport.hrPayroll._base_table_submenu',['activeMenu' => 'department'])
                                    ...
                                    <div class="table-responsive mt-2">
                                        <form id="myform" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="table-responsive " style="height:75vh;max-height:75vh; overflow:auto;max-width: 925px;">
                                                        ...
                                                        @foreach ($items as $key => $data)
                                                            <tr class="text-center" style="border-bottom: 1px solid #dfe3e7">
                                                                <td class="employee"
                                                                        ...
                                                                        data-id="{{ route('department.edit',$data) }}"style="width: 60%">{{ $data->name }}</td>
                                                                    ...
                                                                    <div class="btn-group">
                                                                        <div class="dropdown">
                                                                            ...
                                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                                <a class="dropdown-item studentdocument employee" data-modal="#employee-modal"  data-id="{{ route('department.edit',$data) }}" id=""> Edit </a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </td>
...
@include('backend.payroll.department.modal')
@endsection
...
<script>
    ...
    @include('backend.payroll.department.ajax')
