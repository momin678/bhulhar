                        ...
                        <div class="row" id="table-bordered">
                            <div class="col-12">
                                <div class="cardStyleChange">
                                    <br>
                                    <div class="card-body">
                                        <form action="{{route('country-code.store')}}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="cardStyleChange">
                                                <div class="row px-1">
                                                    <div class="col-sm-2 col-12 changeColStyle">
                                                        <label for="mode">Country Code<sup class="text-danger">*</sup></label>
                                                        <input type="text" class="form-control inputFieldHeight" name="name" id="name" required>
                                                    </div>
