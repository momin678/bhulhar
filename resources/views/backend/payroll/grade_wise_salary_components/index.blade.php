        ...
        <div class="content-body">
            ...
            <div class="tab-content bg-white">
                <div id="studentProfileList" class="tab-pane active px-2 pt-1" style="max-width: 876px;">
                    @include('clientReport.hrPayroll._salary_procedures_submenu',['activeMenu' => 'grade-wise-salary-components'])
                                                        ...
                                                        @foreach ($grades as $key => $data)
                                                            <tr class="text-center" style="border-bottom: 1px solid rgb(243, 243, 243)">
                                                                ...
                                                                <td class="employee"
                                                                    ...
                                                                    data-id="{{ route('grade-wise-salary-components.edit',$data) }}"style="width: 20%">{{ $data->name }}</td>

                                                                <td class="employee"
                                                                    data-modal="#employee-modal"
                                                                    data-id="{{ $data->id }}">@foreach ($data->gradeWiseSalaryComponent as $item2) {{$item2->gradeComponents->name}} ,@endforeach</td>
                                                                <td>
                                                                    <div class="btn-group">
                                                                        <div class="dropdown">
                                                                            ...
                                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                                <a class="dropdown-item studentdocument employee empoyee" data-modal="#employee-modal"  data-id="{{  route('grade-wise-salary-components.edit',$data)}}" id=""> Edit </a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </td>
