                ...
                <section id="widgets-Statistics" class="mr-1 ml-1">
                    <div class="row">
                        <div class="col-md-6 mt-2 mb-2">
                            <h4>Yearly Performance Review Edit</h4>
                        </div>
                    </div>
                    <div class="row" style="padding-left: 10px; padding-right: 10px">
                        <div class="col-12">
                            <form action="{{route('performance-management.update', $performance_info->id)}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                                    ...
                                                    <div class="col-sm-4 col-12 changeColStyle">
                                                        ...
                                                        <select name="employee_id" id="employee_id" class="form-control common-select2" style="width: 100% !important" required>
                                                            ...
                                                            @foreach ($employees as $employee)
                                                                <option value="{{$employee->id}}" {{$performance_info->employee_id == $employee->id?'selected':''}}>{{$employee->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="col-sm-4 col-12 changeColStyle">
                                                        <label for="mode">Discussion <sup class="text-danger">*</sup></label>
                                                        <input type="text" class="form-control inputFieldHeight" name="discussion" id="discussion" value="{{$performance_info->discussion}}" required>
                                                    </div>
                                                    <div class="col-sm-4 col-12 changeColStyle ">
                                                        <label for="mode">Performance result <sup class="text-danger">*</sup></label>
                                                        <input type="number" class="form-control inputFieldHeight" name="performance_result" id="performance_result" value="{{$performance_info->performance_result}}" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card">
                                                <div class="row px-1">
                                                    <div class="col-sm-4 col-12 changeColStyle">
                                                        ...
                                                        <input type="number" class="form-control inputFieldHeight each-item" name="employee_contribution" value="{{$performance_info->performance_result}}" id="employee_contribution" readonly required>
                                                    </div>
                                                    <div class="col-sm-4 col-12 changeColStyle">
                                                        <label for="mode">Company Contribution <sup class="text-danger">*</sup> </label>
                                                        <input type="number" class="form-control inputFieldHeight each-item" name="company_contribution" id="company_contribution" value="{{$performance_info->company_contribution}}" required>
                                                    </div>
                                                    <div class="col-sm-4 col-12 changeColStyle">
                                                        <label for="mode">Country inflation rate <sup class="text-danger">*</sup> </label>
                                                        <input type="number" class="form-control inputFieldHeight each-item" name="country_inflation_rate" id="country_inflation_rate" value="{{$performance_info->country_inflation_rate}}" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card">
                                                <div class="row px-1">
                                                    <div class="col-sm-4 col-12 changeColStyle">
                                                        ...
                                                        <input type="text" class="form-control inputFieldHeight" name="proposed_compensation" id="proposed_compensation" value="{{$performance_info->proposed_compensation}}" readonly required>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-1 col-12 changeColStyle">
                                                        @if($employee_info->quali_image != null)
                                                            <br>
                                                            <div>
                                                                <a href="{{ asset('storage/upload/performance/'.$employee_info->quali_image)}}"  target="_blank">
                                                                    <img src="{{ asset('storage/upload/performance/'. $employee_info->quali_image) }}" style="width: 60px">
                                                                </a>
                                                            </div>
                                                        @endif
                                                    </div>
