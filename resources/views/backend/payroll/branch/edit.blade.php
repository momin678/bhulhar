    ...
    <div class="content-wrapper">
        <div class="content-body">
            <div class="nav nav-tabs master-tab-section" id="nav-tab" role="tablist">
                ...
                <a href="{{route('branch.index')}}" class="nav-item nav-link active" role="tab" aria-controls="nav-contact" aria-selected="false">
                    <div class="master-icon text-cente">
                        ...
                        <div class="row" id="table-bordered">
                            <div class="col-12">
                                <div class="cardStyleChange">
                                    <form action="{{route('branch.update', $info->id)}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="cardStyleChange">
                                            <div class="row px-1">
                                                <div class="col-sm-2 col-12 changeColStyle">
                                                    <label for="mode">Branch<sup class="text-danger">*</sup></label>
                                                    <input type="text" class="form-control inputFieldHeight" name="name" id="name" value="{{$info->name}}" required>
                                                </div>
                                                <div class="col-sm-2 col-12 changeColStyle">
                                                    <label for="mode">Routing Number<sup class="text-danger">*</sup></label>
                                                    <input type="text" class="form-control inputFieldHeight" name="routing_number" id="routing_number" value="{{$info->routing_number}}" required>
                                                </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="trFontSize">
                                                        ...
                                                        <td class="text-right pr-2">
                                                            <a href="{{route('department.edit', $item->id)}}" class="btn editExamModal" title="Edit" id="" style="padding-top: 1px; padding-bottom: 1px; height: 30px; width: 30px;"><img src="{{asset("assets/backend/app-assets/icon/edit-icon.png")}}" style=" height: 30px; width: 30px;"></a>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
