                            ...
                            <div class="cardStyleChange">
                                <div class="">
                                    <div class="d-flex mt-1 justify-content-between align-items-center">
                                        @include('clientReport.hrPayroll._base_table_submenu',['activeMenu' => 'branch'])
                                                        ...
                                                        @foreach ($items as $key => $data)
                                                            <tr class="text-center" style="border-bottom: 1px solid #dfe3e7">
                                                                <td class="employee"
                                                                    ...
                                                                    data-id="{{ route('branch.edit',$data) }}"style="width: 60%">{{ $data->name }}</td>
                                                                <td>
                                                                    <div class="btn-group">
                                                                        <div class="dropdown">
                                                                            ...
                                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                                <a class="dropdown-item studentdocument employee" data-modal="#employee-modal"  data-id="{{ route('branch.edit',$data)}}" id=""> Edit </a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </td>
...
@include('backend.payroll.branch.modal')
@include('backend.payroll.nationality.modal')
@endsection
...
<script>
    ...
    @include('backend.payroll.branch.ajax')
