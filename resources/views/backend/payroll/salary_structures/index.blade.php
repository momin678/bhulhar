            ...
            <div class="tab-content card cardStyleChange">
                <section id="widgets-Statistics" class="mr-1 ml-1">
                    ...
                    <div class="row" style="padding-left: 10px; padding-right: 10px">
                        <div class="col-12">
                            <form action="{{route('salary-structures.store')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="cardStyleChange">
                                    <div class="row">
                                        <div class="col-sm-2 col-12 changeColStyle">
                                            <label for="mode">Head</label>
                                            <input type="text" class="form-control inputFieldHeight each-item" name="head" id="head" required>
                                        </div>
                                        <div class="col-sm-2 col-12 changeColStyle">
                                        ...
                                        <div class="col-sm-2 col-12 changeColStyle">
                                            ...
                                            <input type="text" class="form-control inputFieldHeight each-item" name="value" id="value">
                                        </div>
