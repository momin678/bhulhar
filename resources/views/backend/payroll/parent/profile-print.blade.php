...
<section id="basic-vertical-layouts" class="m-2">
    <div class="row match-height">
        <div class="col-md-12 col-12">
            <div class="cardStyleChange">
                <div class="row mb-2">
                    <div class="col-md-6">
                        <h4 class="border-bottom">Father's Information: Personal Details</h4>
                        <div> <span><b>Father's Name:</b> {{ $parent->f_fname.' '.$parent->f_mname.' '.$parent->f_family_name}}</span></div>
                        <div> <span><b>Email Address: </b>{{ $parent->f_email_address}}</span> </div>
                        ...
                        <div>
                            ...
                            <div>
                                <img src="{{ asset('storage/upload/emirate_id/'.$parent->f_emirates_id_upload)}}" width="70" height="70">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <h4 class="border-bottom">Passport & Visa Information</h4>
                ...
                <div class="row mb-2">
                    <div class="col-md-6">
                        <h4 class="border-bottom">Education & Profession</h4>
                    ...
                    <div class="col-md-6">
                        <h4 class="border-bottom">Address Details</h4>
    ...
    <div class="row match-height">
        <div class="col-md-12 col-12">
            <div class="cardStyleChange">
                <div class="row mb-2">
                    <div class="col-md-6">
                        <h4 class="border-bottom">Mother's Information: Personal Details</h4>
                        ...
                        <div> <span><b>Email Address: </b>{{ $parent->m_email_address}}</span> </div>
                        ...
                        <div>
                            <div><label>Emirates ID</label></div>
                            <div>
                                <img src="{{ asset('storage/upload/emirate_id/'.$parent->m_emirates_id_upload)}}" width="70" height="70">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
