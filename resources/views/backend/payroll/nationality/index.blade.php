                            ...
                            <div class="cardStyleChange">
                                <div class="">
                                    <div class="d-flex mt-1 justify-content-between align-items-center">
                                        @include('clientReport.hrPayroll._base_table_submenu',['activeMenu' => 'nationality'])
                                                                    ...
                                                                    <div class="btn-group">
                                                                        <div class="dropdown">
                                                                            ...
                                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                                <a class="dropdown-item studentdocument employee"
                                                                                data-modal="#employee-modal"
                                                                                data-id="{{ route('nationality.edit',$data) }}"> Edit </a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </td>
...
<script>
    ...
    @include('backend.payroll.nationality.ajax')
@endpush
