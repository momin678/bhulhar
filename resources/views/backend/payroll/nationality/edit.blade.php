    ...
    <div class="content-wrapper">
        <div class="content-body">
            <div class="nav nav-tabs master-tab-section" id="nav-tab" role="tablist">
                <a href="{{route("nationality.index")}}" class="nav-item nav-link active" role="tab" aria-controls="nav-contact" aria-selected="false">
                                        ...
                                        <div class="cardStyleChange">
                                            <div class="row px-1">
                                                <div class="col-sm-2 col-12 changeColStyle">
                                                    ...
                                                    <input type="text" class="form-control inputFieldHeight" name="name" id="name" value="{{$nationality_info->name}}" required>
                                                </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="trFontSize">
                                                        ...
                                                        <td class="text-right pr-2">
                                                            <a href="{{route('nationality.edit', $item->id)}}" class="btn editExamModal" title="Edit" id="" style="padding-top: 1px; padding-bottom: 1px; height: 30px; width: 30px;"><img src="{{asset("assets/backend/app-assets/icon/edit-icon.png")}}" style=" height: 30px; width: 30px;"></a>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
