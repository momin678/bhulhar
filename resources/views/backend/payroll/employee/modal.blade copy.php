        ...
        <div class="modal fade bd-example-modal-lg" id="employee-modal" style="width: 100%;" tabindex="-1" rrole="dialog" aria-labelledby="employee-modal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document" style="padding-right: 0px !important">
                <div class="modal-content ">
                    ...
                    <form action="{{route('employees.store')}}" method="POST" class="p-2" enctype="multipart/form-data">
                        @csrf
                                    ...
                                    <div class="card">
                                        <div class="row mx-0" >
                                            <div class="col-md-12 col-12 changeColStyle " >
                                                ...
                                                <div class="col-md-1" style="margin-top: 10px; padding:0px" >
                                                ...
                                                <div class="col-md-11 pl-2">
                                                    <div class="row ">
                                                        ...
                                                        <div class="col-sm-3 col-12 changeColStyle habib">
                                    ...
                                    <div class="card">
                                        <div class="row mx-0" >
                                            ...
                                            <div class="col-sm-3 col-12">
                                                <div class="row" style="margin-left: 2px;margin-right: 2px">
                                                    <div class="col-sm-4  changeColStyle mx-0 px-0 " >
                                                        ...
                                                        <select name="countrytCode" id="countrytCode" class="form-control common-select2" required>
                                                            <option value="">Select ...</option>
                                                            @foreach ($countrytCode as $countrytCode1)
                                                                <option value="{{$countrytCode1->id}}" >+{{$countrytCode1->dial}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="col-sm-3 col-12 changeColStyle">
                                                ...
                                                <input type="email" style="font-size:12px" class="form-control inputFieldHeight" oninput="this.value = this.value.toLowerCase()" name="email" id="email" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
