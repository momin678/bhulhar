                                ...
                                <div class="cardStyleChange">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2 col-12 changeColStyle">
                                            <label for="mode">Salary type <sup class="text-danger">*</sup></label>
                                            <input type="text" class="form-control inputFieldHeight" name="salary_type" id="salary_type" value="{{$salary_info->salary_type}}" required>
                                        </div>
                                ...
                                @foreach ($salaryTypes as $item)
                                    <tr  class="data-row">
                                        ...
                                        <td style="padding-bottom: 11px; padding-top: 0px" class="text-right pr-2">
                                            <a href="{{route('salary-types.edit', $item->id)}}" class="btn" style="height: 30px; width: 30px;" title="Eidt">
                                            ...
                                            <a href="" class="btn" style="height: 30px; width: 30px;" title="Delete">
                                                <form action="{{ route('salary-types.destroy', $item->id) }}" method="POST" class="flot-right">
                                                    @csrf
                                                    @method('DELETE')
