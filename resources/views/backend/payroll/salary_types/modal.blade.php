        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="p-0" style="font-family:Cambria;font-size: 2rem;"><b>Salary Type Add</b></h5>
                ...
                <div class="">
                    <div class="card-body">
                        <form action="{{route('salary-types.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                                <label class="col-sm-4 col-form-label">Salary types</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="salary_type" value="" placeholder="Type new Head">
