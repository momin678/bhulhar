                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                   ...
                                   <input type="text" readonly value="{{$leave->emp->name}}" name="employee_name" class="inputFieldHeight form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <label style="margin-left: 10px !important">Documents</label>
