        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="p-0" style="font-family:Cambria;font-size: 2rem;"><b>Add Salary Component</b></h5>
                    ...
                    <div class="">
                        <form action="{{route('salary-structures.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="head" value="" placeholder="Type new Head">
