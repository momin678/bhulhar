            ...
            <div class="tab-content bg-white">
                <div id="studentProfileList" class="tab-pane active px-2" style="max-width: 876px;">
                    ...
                    <div class="d-flex justify-content-between align-items-center pt-1">
                        @include('clientReport.hrPayroll._salary_procedures_submenu',['activeMenu' => 'salary-component'])
                    ...
                    <div class="row" id="table-bordered">
                        <div class="col-12">
                            <div class="cardStyleChange">
                                <div class="">
                                    <div class="table-responsive mt-2" style="max-width: 876px;">
                                                    ...
                                                    <tbody class="t-body">
                                                        ...
                                                        <tr class="text-center" style="border-bottom: 1px solid #dfe3e7">                                                           
                                                            <td class="employee"
                                                                ...
                                                                data-id="{{ route('salary-structures.edit',$data) }}"style="width: 60%">{{ $data->name }}</td>
                                                                ...
                                                                <div class="btn-group">
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                            <a class="dropdown-item studentdocument employee" data-modal="#employee-modal"  data-id="{{  route('salary-structures.edit',$data)}}" id=""> Edit </a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                              </td>
...
@include('backend.payroll.salary_components.modal')
@endsection
...
<script>
    ...
    @include('backend.payroll.salary_components.ajax')
