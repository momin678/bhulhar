    ...
    <div class="app-content content print-hideen">
        ...
        <div class="content-wrapper">
            <div class="content-body">
                ...
                @include('clientReport.lpo-bill._header', ['activeMenu' => 'lpo_bill'])
                                        ...
                                        <div class="row mx-1">
                                                    ...
                                                    <div class="col-8 customer-select">
                                                        <select name="party_info" id="party_info"
                                                            ...
                                                            @foreach ($pInfos as $item)
                                                                <option value="{{ $item->id }}" {{ $lpo_bill->party_id == $item->id ? 'selected' : '' }}>{{ $item->pi_name }}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('party_info')
                                            ...
                                            <div class="col-md-2">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-10">
                                                        <input type="text" value="{{ date('d/m/Y', strtotime($lpo_bill->date)) }}" class="form-control inputFieldHeight datepicker" name="date" placeholder="dd-mm-yyyy">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row  align-items-center">
                                                    ...
                                                    value="{{ $lpo_bill->narration }}" required>
                                                    </div>
                                                </div>
                                                ...
                                                <table class="table  table-sm ">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>Total Amount</th>
                                                            <th class="NoPrint" style="width: 5%;padding: 2px;"> <button type="button"
                                                            ...
                                                            <tr class="text-center invoice_row">
                                                                <td>
                                                                    <div
                                                                        ...
                                                                        <input type="text"
                                                                            name="group-a[{{$key}}][multi_acc_head]" value="{{$item->item_description}}"
                                                                ...
                                                                <td>
                                                                    <div
                                                                        class="d-flex justy-content-between align-items-center">
                                                                        <input type="number" value="{{$item->qty}}" name="group-a[{{$key}}][quantity]"
                                                                ...
                                                                <td>
                                                                    <div
                                                                        class="d-flex justy-content-between align-items-center">
                                                                        <input type="number" value="{{$item->rate}}" name="group-a[{{$key}}][rate]"
                                                                ...
                                                                <td>
                                                                    <div
                                                                        class="d-flex justy-content-between align-items-center">
                                                                        <input type="number" value="{{$item->amount}}" name="group-a[{{$key}}][amount]"
                                                                ...
                                                                <td class="vat-exist">
                                                                    <select name="group-a[{{$key}}][vat_rate]" required
                                                                        ...
                                                                        @foreach ($vats as $vat)
                                                                            <option value="{{ $vat->value }}" {{($item->vat>0 && $vat->value==5)?'selected':'' }}>
                                                                                {{ $vat->name . ' (' . $vat->value . ')' }}
                                                                            </option>
                                                                        @endforeach
                                                                    </select>
                                                                ...
                                                                <td class="vat-exist"><input type="number" value="{{$item->vat}}" step="any"
                                                                        class="text-center form-control vat_amount inputFieldHeight2"
                                                                        required placeholder="Vat Amount"
                                                                        name="group-a[{{$key}}][vat_amount]" readonly>
                                                                </td>
                                                                <td>
                                                                    <input type="number" value="{{$item->total_amount}}" step="any"
                                                                        name="group-a[{{$key}}][sub_gross_amount]" required
                                                        ...
                                                        <tr id="TRow" class="text-center invoice_row">
                                                            <td>
                                                                <div
                                                                    class="d-flex justy-content-between align-items-center">
                                                                    <input type="text"
                                                                        name="group-a[{{count($items)}}][multi_acc_head]" step="any"
                                                                        required placeholder="Item Description"
                                                                        class="text-center form-control inputFieldHeight2"style="width: 100%;height:36px;">
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div
                                                                    class="d-flex justy-content-between align-items-center">
                                                                    <input type="number" step="any" name="group-a[{{count($items)}}][quantity]"
                                                                        step="any" required placeholder="Quantity"
                                                                        class="text-center form-control inputFieldHeight2 quantity"style="width: 100%;height:36px;">
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div
                                                                    class="d-flex justy-content-between align-items-center">
                                                                    <input type="number" step="any" name="group-a[{{count($items)}}][rate]"
                                                                        step="any" required placeholder="Rate"
                                                                        class="text-center form-control inputFieldHeight2 rate"style="width: 100%;height:36px;">
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div
                                                                    class="d-flex justy-content-between align-items-center">
                                                                    <input type="number" step="any" name="group-a[{{count($items)}}][amount]"
                                                                        step="any" required placeholder="Amount"
                                                                        class="text-center form-control inputFieldHeight2 amount"style="width: 100%;height:36px;">
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="vat-exist">
                                                                <select name="group-a[{{count($items)}}][vat_rate]" required
                                                                    class="inputFieldHeight2 vat_rate form-control "
                                                                    style="width: 100%;HEIGHT: 36PX;text-align:center;">
                                                            ...
                                                            <td class="vat-exist"><input type="number" step="any"
                                                                    class="text-center form-control vat_amount inputFieldHeight2"
                                                                    required placeholder="Vat Amount"
                                                                    name="group-a[{{count($items)}}][vat_amount]" readonly>
                                                            </td>
                                                            <td>
                                                                <input type="number" step="any"
                                                                    name="group-a[{{count($items)}}][sub_gross_amount]" required
                                                                    class="text-center form-control sub_gross_amount inputFieldHeight2"
                                                                    placeholder="Amount" style="width: 100%;height:36px;"
                                                                    readonly>
                                                            </td>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="number" step="any" readonly
                                                                    ...
                                                                    name="total_amount" value="{{$lpo_bill->total_amount}}"
                                    ...
                                    <div class="card-body bg-white">
                                        <div class="row px-1">
                                            ...
                                            <div class="col-sm-1 text-right d-flex justify-content-end mt-2 mb-1">
                                                ...
                                                <a href="{{route("lpo-bill-create")}}" class="btn btn-warning  d-none" id="newButton">New</a>
