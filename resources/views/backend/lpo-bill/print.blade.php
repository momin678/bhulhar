...
<div class="row">
    <div class="col-sm-12">
        <h4 class=" text-center" style="margin:0;padding:0;line-height:29px;"> LOCAL PURCHASE ORDER </h4>

        <div class="customer-info">
            <div class="row ml-1 mr-1 ">
                <div class="col-12 bg-white text-right" style="padding:0px !important">
                    <span >Bin Hindi TRN: {{$trn_no->config_value}}</span>
