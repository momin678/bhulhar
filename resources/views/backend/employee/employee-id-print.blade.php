                    ...
                    <div class="row d-flex justify-content-center">
                        ...
                        <div class="col-md-3" style="">
                           <div style="width:204px;
                                height:324px;background-color:rgba(43, 127, 43, 0.9);border:3px solid gray">
                                    <div class="id-card" style="">
                                        ...
                                        " class="">
                                                    ...
                                                    <p style="font-size: 11px;color:green">Terms and Conditions: <br>
                                                    </p>
                                                    <p class="height" style="padding-left: 10px;font-size:11px">
                                                        Nonumy dolores aliquyam <br> Tempor invidunt justo et justo. <br>
                                                        Duo lorem amet diam est.
                                        ...
                                        " class="">
                                                    ...
                                                    <p style="font-size: 11px;color:green">Contact Us: <br>
                                                    </p>
                                                    <p class="height" style="padding-left: 10px;font-size:11px">
