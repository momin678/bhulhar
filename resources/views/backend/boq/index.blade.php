    ...
    <div class="content-wrapper">
        <div class="content-body">
            <div class="nav nav-tabs master-tab-section" id="nav-tab" role="tablist">
                <a href="{{route('boq.index')}}" class="nav-item nav-link active" role="tab" aria-controls="nav-contact" aria-selected="false">
                    <div class="master-icon text-cente">
                        <img src="{{asset('assets/backend/app-assets/icon/list-icon.png')}}" alt="" srcset="" class="img-fluid" width="50">
                    </div>
                    <div>BOQ List</div>
                </a>
                <a href="{{route('boq.create')}}" class="nav-item nav-link" role="tab" aria-controls="nav-contact" aria-selected="false">
                    <div class="master-icon text-cente">
                                ...
                                <table class="table table-sm table-bordered">
                                    ...
                                    @foreach ($boqs as $boq)
                                        <tr>
                                            <td>{{ $boq->number }}</td>
                                            <td>{{ $boq->date }}</td>
                                            <td>{{ $boq->taxable_amount }}</td>
                                            <td>{{ $boq->vat }}</td>
                                            <td>{{ $boq->total_cost }}</td>
                                            <td>
                                                <a href="{{ route('boq.show',$boq) }}" class=""><img src="{{ asset('assets/backend/app-assets/icon/view-icon.png')}}" style=" height: 30px; width: 30px; margin-left: -12px;"></a>
                                            </td>
                                        </tr>
                                    @endforeach
