                                ...
                                <table class="table table-sm table-font table-bordered">
                                    <tr class="bg-color">
                                        ...
                                        @foreach ($invoice->items as $item)
                                            ...
                                            @endphp
                                        @endforeach
                                        @foreach ($invoice->items->where('toll_fee', '>',0) as $item)
                                            <tr>
                                                <td>{{$sl}}</td>
                                                <td>Toll {{$item->crusher}} To {{$item->destination}}</td>
                                                <td>1</td>
                                                <td>{{$item->toll_fee}}</td>
                                                <td>{{$item->toll_fee}}</td>
                                            </tr>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center bg-color" colspan="2"  >Total Quantity</th>
                                        <th class="text-center bg-color">{{number_format($invoice->items->sum('qty'), 2)}}</th>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center bg-color" > {{ number_format($invoice_items->sum('total_vat_amount'),2) }}</th>
                                    </tr>
                                    <tr>
                                        <th class="text-center" style="border-bottom: 1px solid white !important;  border-left: 1px solid white !important;" colspan="2" ></th>
                                        <th class="text-center bg-color" colspan="2"  >Toll Fee></th>
                                        <th class="text-center bg-color" > {{ number_format($invoice->items->sum('toll_fee'),2) }}</th>
                                    </tr>
                                    <tr>
                                        <th class="text-center" style="border-bottom: 1px solid white !important;  border-left: 1px solid white !important" colspan="2" ></th>
                                        <th class="text-center bg-color" colspan="2"  >Total Amount <small>(AED)</small></th>
                                        <th class="text-center bg-color"   > {{ number_format($invoice_items->sum('total_vat_amount')+$taxable_amount+$invoice->items->sum('toll_fee'),2) }}</th>
                                    </tr>
                                    <tr>
                                        <th class="text-center" style="border-bottom: 1px solid white !important;  border-left: 1px solid white !important;" colspan="2" ></th>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center bg-color" > {{number_format(($invoice_items->sum('total_vat_amount')+$taxable_amount+$invoice->items->sum('toll_fee'))-$invoice->paid_amount,2)}}</th>
                                    </tr>
                                </table>
                                @else
                                <table class="table table-sm table-font table-bordered">
                                    <tr class="bg-color">
                                        ...
                                        @endforeach
                                    <tr>
                                        <th class="text-center" style="border-bottom: 1px solid white !important;  border-left: 1px solid white !important;" colspan="3"></th>
                                        <th class="text-center bg-color" colspan="4"  >Total Quantity</th>
                                        <th class="text-center bg-color" colspan="2"  >{{number_format($invoice->items->sum('qty'), 2)}}</th>
                                    </tr>
                                    <tr>
                                        <th class="text-center" style="border-bottom: 1px solid white !important;  border-left: 1px solid white !important;" colspan="3"></th>
                                        <th class="text-center bg-color" colspan="4"  >Taxable Amount <small>(AED)</small></th>
                                        <th class="text-center bg-color" colspan="2"  >{{round($taxable_amount,2)}}</th>
                                    </tr>
                                    <tr>
                                        <th class="text-center" style="border-bottom: 1px solid white !important;  border-left: 1px solid white !important;" colspan="3"></th>
                                        <th class="text-center bg-color" colspan="4"  >VAT <small>(5%)</small></th>
                                        <th class="text-center bg-color" colspan="2"  > {{ number_format($invoice_items->sum('total_vat_amount'),2) }}</th>
                                    </tr>
                                    <tr>
                                        <th class="text-center" style="border-bottom: 1px solid white !important;  border-left: 1px solid white !important;" colspan="3"></th>
                                        <th class="text-center bg-color" colspan="4"  >Toll Fee</th>
                                        <th class="text-center bg-color" colspan="2"  > {{ number_format($invoice->items->sum('toll_fee'),2) }}</th>
                                    </tr>
                                    <tr>
                                        <th class="text-center" style="border-bottom: 1px solid white !important;  border-left: 1px solid white !important;" colspan="3"></th>
                                        <th class="text-center bg-color" colspan="4"  >Total Amount <small>(AED)</small></th>
                                        <th class="text-center bg-color" colspan="2"  > {{ number_format($invoice_items->sum('total_vat_amount')+$taxable_amount+$invoice->items->sum('toll_fee'),2) }}</th>
                                    </tr>
                                    <tr>
                                        <th class="text-center" style="border-bottom: 1px solid white !important;  border-left: 1px solid white !important;" colspan="3" ></th>
                                        <th class="text-center bg-color" colspan="4"  >Paid Amount <small>(AED)</small></th>
                                        <th class="text-center bg-color" colspan="2"  > {{$invoice->paid_amount}}</th>
                                    </tr>
                                    <tr>
                                        <th class="text-center" style="border-bottom: 1px solid white !important;  border-left: 1px solid white !important;" colspan="3" ></th>
                                        <th class="text-center bg-color" colspan="4"  >Due Amount <small>(AED)</small></th>
                                        <th class="text-center bg-color" colspan="2"  > {{number_format(($invoice_items->sum('total_vat_amount')+$taxable_amount+$invoice->items->sum('toll_fee'))-$invoice->paid_amount,2)}}</th>
                                    </tr>
                                </table>
                                @endif
                            </div>
