                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row col-md-9">
                                                <div class="col-md-2 changeColStyle">
                                                    ...
                                                    <input type="text" class="form-control inputFieldHeight" name="date"  placeholder="Search by Date" autocomplete="off" id="date">
                                                </div>
                                                <div class="col-md-2 changeColStyle">
                                                    <label for="">From Date</label>
                                                    <input type="text" class="form-control inputFieldHeight" name="from" placeholder="From" autocomplete="off"  id="from">
                                                </div>
                                                <div class="col-md-2 changeColStyle">
                                                    <label for="">To Date</label>
                                                    <input type="text" class="form-control inputFieldHeight" name="to" placeholder="To" autocomplete="off" id="to">
                                                </div>
