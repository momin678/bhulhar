    ...
    <div class="content-wrapper">
        <div class="content-body">
            ...
            <div class="tab-content bg-white">
                @include('backend.customer-invoice.sub-head',['activeMenu' => 'approved'])
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table mb-0 table-sm table-hover">
                                            ...
                                            <tbody class="table-sm">
                                                ...
                                                @endforeach
                                                <tr class="trFontSize">
                                                    <td colspan="14" class="text-right pr-1">Total Quantity: </td>
                                                    {{-- <td></td> --}}
                                                    <td class="text-right pr-1">{{ number_format($invoice->items->sum('qty'), 2)}}</td>
                                                </tr>
                                                <tr class="trFontSize">
                                                    <td colspan="14" class="text-right pr-1">Amount: </td>
                                                    <td class="text-right pr-1">{{ $invoice->items->sum('amount')}}</td>
                                                    {{-- <td></td> --}}
                                                </tr>
                                                <tr class="trFontSize">
                                                    <td colspan="14" class="text-right pr-1">Discount: </td>
                                                    <td class="text-right pr-1">{{ $invoice->items->sum('discount')}}</td>
                                                    {{-- <td></td> --}}
                                                </tr>
                                                <tr class="trFontSize">
                                                    <td colspan="14" class="text-right pr-1">Total VAT: </td>
                                                    <td class="text-right pr-1">{{ $invoice->items->sum('vat_amount')}}</td>
                                                    {{-- <td></td> --}}
                                                </tr>
                                                {{-- <tr class="trFontSize">
                                                    <td colspan="14" class="text-right pr-1">Total Toll Fee: </td>
                                                    <td class="text-right pr-1">{{  $invoice->items->sum('toll_fee')}}</td>
                                                </tr> --}}
                                                <tr class="trFontSize">
                                                    <td colspan="14" class="text-right pr-1">Total Amount: </td>
                                                    <td class="text-right pr-1">{{ $t_amount =  $invoice->items->sum('amount')+$invoice->items->sum('vat_amount')-$invoice->items->sum('discount')}}</td>
                                                    {{-- <td></td> --}}
                                                </tr>
                                                <tr class="trFontSize">
                                                    <td colspan="14" class="text-right pr-1">Payment Applied: </td>
                                                    <td class="text-right pr-1">{{ $invoice->paid_amount}}</td>
                                                    {{-- <td></td> --}}
                                                </tr>
                                                <tr class="trFontSize">
                                                    <td colspan="14" class="text-right pr-1">Balance Due: </td>
                                        ...
                                        <table class="table mb-0 table-sm table-hover">
                                            ...
                                            <tbody class="table-sm">
                                                ...
                                                @endforeach
                                                <tr class="trFontSize">
                                                    <td colspan="13" class="text-right pr-1">Total Quantity: </td>
                                                    {{-- <td></td> --}}
                                                    <td class="text-right pr-1">{{ number_format($invoice->items->sum('qty'), 2)}}</td>
                                                </tr>
                                                <tr class="trFontSize">
                                                    <td colspan="13" class="text-right pr-1">Amount: </td>
                                                    <td class="text-right pr-1">{{ $invoice->items->sum('amount')}}</td>
                                                    {{-- <td></td> --}}
                                                </tr>
                                                <tr class="trFontSize">
                                                    <td colspan="13" class="text-right pr-1">Discount: </td>
                                                    <td class="text-right pr-1">{{ $invoice->items->sum('discount')}}</td>
                                                    {{-- <td></td> --}}
                                                </tr>
                                                <tr class="trFontSize">
                                                    <td colspan="13" class="text-right pr-1">Total VAT: </td>
                                                    <td class="text-right pr-1">{{ $invoice->items->sum('vat_amount')}}</td>
                                                    {{-- <td></td> --}}
                                                </tr>
                                                {{-- <tr class="trFontSize">
                                                    <td colspan="13" class="text-right pr-1">Total Toll Fee: </td>
                                                    <td class="text-right pr-1">{{  $invoice->items->sum('toll_fee')}}</td>
                                                </tr> --}}
                                                <tr class="trFontSize">
                                                    <td colspan="13" class="text-right pr-1">Total Amount: </td>
                                                    <td class="text-right pr-1">{{ $t_amount =  $invoice->items->sum('amount')+$invoice->items->sum('vat_amount')-$invoice->items->sum('discount')}}</td>
                                                    {{-- <td></td> --}}
                                                </tr>
                                                <tr class="trFontSize">
                                                    <td colspan="13" class="text-right pr-1">Payment Applied: </td>
                                                    <td class="text-right pr-1">{{ $invoice->paid_amount}}</td>
                                                    {{-- <td></td> --}}
                                                </tr>
                                                <tr class="trFontSize">
                                                    <td colspan="13" class="text-right pr-1">Balance Due: </td>
                                                    <td class="text-right pr-1">{{ $t_amount - $invoice->paid_amount}}</td>
                                                    {{-- <td></td> --}}
                                                </tr>
                                            </tbody>
