...
<section class="print-hideen border-bottom" style="padding: 5px 15px;background:#364a60;">
    <div class="d-flex flex-row-reverse" style="padding-right: 10px;">
        ...
        <div class="" style="padding-right: 3px;margin-top: 6px;">
            <a href="{{ route('receipt-voucher-delete', $recept) }}" class="btn btn-icon btn-danger" onclick="return confirm('Delete! Confirm?')" title="Delete"><i class="bx bx-trash"></i></a>
        </div>
        @if ($recept->is_authorize == 0)
            <div class="" style="padding-right: 3px;margin-top: 6px;">
                <a href="{{ route('receipt-voucher-authorize', $recept) }}" class="btn btn-icon btn-warning" onclick="return confirm('Authorize! Confirm?')" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Authorize"><i class="bx bx-check"></i></a>
            </div>
        @else
            <div class="" style="padding-right: 3px;margin-top: 6px;">
                <a href="{{ route('receipt-voucher-approve', $recept) }}" class="btn btn-icon btn-warning" onclick="return confirm('Approve! Confirm?')" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Approve"><i class="bx bx-check"></i></a>
            </div>
        @endif
        @if ($recept->is_direct!=1)
            <div class="" style="padding-right: 3px;margin-top: 6px;">
                <a href="{{ route('receipt-voucher-edit', $recept) }}" class="btn btn-icon btn-primary" title="Edit"><i class="bx bx-edit"></i></a>
            </div>
        @endif
