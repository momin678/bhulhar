...
<section id="basic-vertical-layouts">
    <div class="cardStyleChange">
        <div class="content-wrapper">
                <form class="form form-vertical m-1" action="{{route('user.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf 
                    <section id="basic-vertical-layouts">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="first-name-vertical" class="inputFieldHeight form-control @error('name') error @enderror" name="name" value="{{ old('name')}}" placeholder="User Name" required>
                                                    @error('name')
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" id="contact-info-vertical" class="inputFieldHeight form-control @error('email') error @enderror" name="email" value="{{ old('email')}}" placeholder="Email ID" required>
                                                    @error('email')
                                                    <span class="error">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input id="password" type="password" class="inputFieldHeight form-control @error('password') is-invalid @enderror" name="password" required placeholder="Password">
                                                    @error('password')
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input id="password-confirm" type="password" class="inputFieldHeight form-control" name="password_confirmation" required placeholder="Confirm password">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
