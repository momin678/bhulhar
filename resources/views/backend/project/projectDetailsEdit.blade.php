                            ...
                            <form action="{{ route('projectDetailsUpdate', $proj) }}" method="POST">
                                ...
                                <div class="row match-height">
                                    <div class="col-md-3 changeColStyle">
                                        ...
                                        <input type="text" id="" class="form-control inputFieldHeight" name="" placeholder="Project No" disabled readonly value="{{$proj->proj_no}}">
                                        @error('proj_no')
                                    ...
                                    <div class="col-md-3 changeColStyle">
                                        ...
                                        <input type="text" id="proj_name" class="form-control inputFieldHeight" name="proj_name" placeholder="Project Name" required value="{{ $proj->proj_name }}">
                                        @error('proj_name')
                                            <div class="btn btn-sm btn-danger">{{ $message }} </div>
                                        @enderror
                                    </div>
                                    <div class="col-md-3 changeColStyle">
                                        ...
                                        <select name="proj_type" class="common-select2" style="width: 100% !important" required>
                                            ...
                                            @foreach ($projectTypes as $item)
                                                <option value="{{ $item->title }}" {{ $proj->proj_type == $item->title ? 'selected' : '' }}> {{ $item->title }}</option>
                                            @endforeach
                                        </select>
                                        @error('proj_type')
                                            <div class="btn btn-sm btn-danger">{{ $message }} </div>
                                    ...
                                    <div class="col-md-3 changeColStyle">
                                        <label>Manager</label>
                                        <input type="text" id="owner_name" class="form-control inputFieldHeight" name="owner_name" placeholder="Manager" required value="{{  $proj->owner_name }}">
                                        @error('owner_name')
                                            <div class="btn btn-sm btn-danger">{{ $message }}  </div>
                                        @enderror
                                    </div>
                                    <div class="col-md-3 changeColStyle">
                                        ...
                                        <input type="text" id="address" class="form-control inputFieldHeight" name="address" placeholder="Site Address" required value="{{ $proj->address }}">
                                        @error('address')
                                            <div class="btn btn-sm btn-danger">{{ $message }} </div>
                                        @enderror
                                    </div>
                                    <div class="col-md-3 changeColStyle">
                                        ...
                                        <input type="text" id="cons_agent" class="form-control inputFieldHeight" name="cons_agent" placeholder="Office Phone No" required value="{{ $proj->cons_agent }}">
                                        @error('cons_agent')
                                            <div class="btn btn-sm btn-danger">{{ $message }} </div>
                                        @enderror
                                    </div>
                                    <div class="col-md-3 changeColStyle">
                                        ...
                                        <input type="number" id="cont_no" class="form-control inputFieldHeight" name="cont_no" placeholder="Mobile" required value="{{ $proj->cont_no }}">
                                        @error('cont_no')
                                            <div class="btn btn-sm btn-danger">{{ $message }} </div>
                                        @enderror
                                    </div>
                                    <div class="col-md-3 changeColStyle">
                                        ...
                                        <input type="text" id="ord_date" class="form-control inputFieldHeight" name="ord_date" placeholder="Work Order Date" required value="{{ date('d/m/Y', strtotime($proj->ord_date)) }}">
                                        @error('ord_date')
                                            <div class="btn btn-sm btn-danger">{{ $message }}  </div>
                                        @enderror
                                    </div>
                                    <div class="col-md-3 changeColStyle">
                                        ...
                                        <input type="text" id="hnd_over_date" class="form-control inputFieldHeight" name="hnd_over_date" placeholder="Work Order Date" required value="{{ date('d/m/Y', strtotime($proj->hnd_over_date)) }}">
                                        @error('hnd_over_date')
                                            <div class="btn btn-sm btn-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6 d-flex justify-content-end changeColStyle mb-1 mt-2">
                                        <a href="{{ route('projectDetails') }}" class="btn btn-info mr-1 formButton "><img src="{{ asset('assets/backend/app-assets/icon/add-icon.png')}}" alt="" srcset="" class="image-fluid" width="25"> New</a>
                    ...
                    <div class="mb-1">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <a href="#" class="btn btn-xs mPrint formButton project_list_print" title="Print">
