                            ...
                            <form action="{{ route('projectDetailsPost') }}" method="POST">
                                ...
                                <div class="row match-height">
                                    ...
                                    <div class="col-md-3 changeColStyle">
                                        ...
                                        <input type="text" id="ord_date" class="form-control inputFieldHeight" name="ord_date" placeholder="dd/mm/yyyy" required>
                                        @error('ord_date')
                                            <div class="btn btn-sm btn-danger">{{ $message }}  </div>
                                        @enderror
                                    </div>
                                    <div class="col-md-3 changeColStyle">
                                        ...
                                        <input type="text" id="hnd_over_date" class="form-control inputFieldHeight" name="hnd_over_date" placeholder="dd/mm/yyyy" required>
                                        @error('hnd_over_date')
                                            <div class="btn btn-sm btn-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
