...
<section class="print-hideen border-bottom">
    <div class="d-flex flex-row-reverse">
        ...
        @if (!$tax_invoice->deleted_at)
            <div class="py-1 pr-1"><a href="{{route('soft-delete-tax-invoice', $tax_invoice->id)}}" class="btn btn-icon btn-danger" onclick="return confirm('Delete! Confrim ?')"><i class='bx bxs-trash'></i></a></div>
        @endif
    </div>
</section>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="">
                <div class="mx-2 mb-2">
                    <div class="row">
                        <div class="col-md-6 pb-2"><strong>To: </strong> {{$tax_invoice->partyInfo($tax_invoice->customer_name)->pi_name}}</div>
                        ...
                        <div class="col-md-3">
                            <strong>TRN:</strong> {{ $tax_invoice->partyInfo($tax_invoice->customer_name)->trn_no}}
                        </div>
                        <div class="col-md-3">
                            <strong>ADDRESS:</strong> {{ $tax_invoice->partyInfo($tax_invoice->customer_name)->address}}
                        </div>
                    </div>
                </div>
            </div>
