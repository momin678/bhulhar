                                ...
                                <div class="row">                                                
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="contact-info-vertical" class="inputFieldHeight form-control @error('role_name') error @enderror" name="role_name" value="{{old('role_name')}}" placeholder="Role Name">
                                            @error('role_name')
