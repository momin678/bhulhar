...
<section id="basic-vertical-layouts">
    <div class="cardStyleChange">
        <form class="form form-vertical" action="{{route('role.update', $role->id)}}" method="POST" enctype="multipart/form-data" style="padding: 25px;">
            @csrf 
            @method('PUT')
                                ...
                                <div class="row">                                                
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="contact-info-vertical" class="inputFieldHeight form-control @error('role_name') error @enderror" name="role_name" value="{{ $role->name ?? old('role_name')}}" placeholder="Family Name">
                                            @error('role_name')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <ul class="list-unstyled">
                                                <li class="d-inline-block mr-2">
                                                    <fieldset>
                                                        <div class="checkbox">
                                                            <input type="checkbox" class="checkbox-input" id="edit_all">
