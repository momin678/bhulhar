                ...
                <div class="tab-content journaCreation active">
                    <div id="journaCreation" class="tab-pane bg-white active">
                        ...
                        <section id="widgets-Statistics">
                            ...
                            <form action="{{ route('sale.revenues.store') }}" method="POST" id="formSubmit"
                                        ...
                                        <div class="row mx-1">
                                            <div class="col-md-4 changeColStyle search-item-pi">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-2 col-left-padding d-flex align-items-center" style="margin-top: 23px;">
                                                ...
                                                <div class="col-md-4 changeColStyle" id="printarea">
                                                    <div class="row align-items-center">
                                                        <div class="col-12">
                                                            ...
                                                            <input type="text" id="invoice_no" class="form-control inputFieldHeight" name="sale_no" placeholder="Invoice No">
                                                            @error('sale_no')
                                                                <div class="btn btn-sm btn-danger">{{ $message }}
                                                                </div>
                                                            @enderror
                                            ...
                                            <div class="col-md-12 cheque-content" style="display: none; margin-top:10px;">
                                                <div class="row">
                                        ...
                                        <table class="table  table-sm table-bordered">
                                            ...
                                            <tbody id="TBody">
                                                <tr id="TRow" class="text-center invoice_row">
                                                    <td>
                                                        <select name="group-a[0][account_head_id]" id="account_head_id" class="form-control">
                                                    ...
                                                    <td>
                                                        <select name="group-a[0][vehicle_id]" class="inputFieldHeight2 cost_center_id form-control d-inline" style="width: 87%;    HEIGHT: 36PX;">
                                                    ...
                                                    <td>
                                                        <div
                                                            ...
                                                            <input type="number" step="any" name="group-a[0][qty]"
                                                    ...
                                                    <td>
                                                        <div
                                                            class="d-flex justy-content-between align-items-center">
                                                            <input type="number" step="any" name="group-a[0][rate]"
                                                    ...
                                                    <td>
                                                        <div
                                                            ...
                                                            <input type="number" step="any" name="group-a[0][amount]"
                                                                step="any" required placeholder="Item amount" readonly
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td></td>
                                                    <td class="text-center" style="color: #757575;font-size: 12px !important;">TOTAL</td>
                                                ...
                                                <tr class="text-center">
                                                    ...
                                                    <td></td>
                                                    <td></td>
                                                    <td class="text-center" style="color: #757575;font-size: 12px !important;">VAT</td>
                                                    <td><input type="number" step="any" readonly
                                                            id="total_vat"
                                                ...
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td></td>
                                                    <td class="text-center" style="color: #757575;font-size: 12px !important;">TOTAL AMOUNT</td>
                                                    <td><input type="number" step="any" readonly
                                                            id="total_amount"
                                                ...
                                                <table class="table  table-sm ">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>Amount</th>
                                                            <th class="NoPrint" style="width: 10px;padding: 2px;"> <button type="button" class="btn btn-sm btn-success task_addBtn"style="border: 1px solid green; color: #fff; border-radius: 10px;padding: 5px;"
                                                                    onclick="task_BtnAdd()"><i class="bx bx-plus" style="color: white;margin-top: -5px;"></i></button>
                                                            </th>
                                                        </tr>
                                                    </thead>
                                                    <tbody id="task_TBody">
                                                        <tr id="task_TRow" class="text-center invoice_row">
                                                            ...
                                                            <td>
                                                                <select name="task[]" class="inputFieldHeight2 task_id form-control " style="width: 100%; HEIGHT: 36PX;">
                                                            ...
                                                            <td>
                                                                <div
                                                                    class="d-flex justy-content-between align-items-center">
                                                                    <input type="number" step="any" name="task_amount[]" step="any" placeholder="task amount" class="text-center form-control inputFieldHeight2 task_amount"style="width: 100%;height:36px;">
                                                                </div>
                                                            </td>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><input type="number" step="any" readonly id="task_total_amount" class="text-center inputFieldHeight2 form-control @error('task_total_amount') error @enderror inputFieldHeight task_total_amount" name="task_total_amount" value="" placeholder="TOTAL " >
                                                            </td>
                                                        </tr>
                                    ...
                                    <div class="card-body bg-white">
                                        <div class="row px-1">
                                            ...
                                            <div class="col-sm-2 text-right d-flex justify-content-end mt-2 mb-1">
                                                ...
                                                <a href="{{route('sale.revenues.create')}}" class="btn btn-warning  d-none" id="newButton">New</a>
    ...
    <script>
        ...
        // });
            ...
            $("#formSubmit").submit(function(e) {
                ...
                // if((pay_mode == 'Cash' || pay_mode == 'Card') && Number(total_amount)>=Number(pay_available_balance)){
                //     $('#balanceAdd').modal('show');
                // }else if(Number(task_total_amount)>Number(total_amount)){
                //     alert('Task amount not allow greater than total amount')
                // }else{
                // }
                $.ajax({
                    url: url,
