                ...
                <div class="tab-content bg-white">
                    <div id="journaCreation" class="tab-pane active">
                        ...
                        <section id="widgets-Statistics">
                            <form action="{{ route('update-payment-voucher', $payment->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="card-body" style="padding-bottom: 5px;">
                                        <div class="row m-1">
                                            ...
                                            <div class="col-sm-3 changeColStyle">
                                                ...
                                                <select name="project" class="common-select2" style="width: 100% !important" id="project"
                                                    ...
                                                    @foreach ($projects as $item)
                                                        <option value="{{ $item->id }}" {{$payment->project_id == $item->id ? 'selected' : ''}}> {{ $item->proj_name }} </option>
                                                    @endforeach
                                                </select>
                                                @error('project')
                                            ...
                                            <div class="col-sm-2 changeColStyle">
                                                ...
                                                <input type="text" name="cc_code" id="cc_code" value="{{ $payment->Cost_center->cc_code }}" class="form-control inputFieldHeight" placeholder="Cost Center Code" required>
                                                @error('cc_code')
                                                    <div class="btn btn-sm btn-danger">{{ $message }}
                                                    </div>
                                                @enderror
                                            ...
                                            <div class="col-sm-3 changeColStyle search-item">
                                                ...
                                                class="common-select2 party-info " style="width: 100% !important" data-target="" required>
                                                    ...
                                                    @foreach ($cCenters as $item)
                                                        <option value="{{ $item->id }}" {{$payment->cost_center_id == $item->id ? 'selected':''}}>{{ $item->cc_name }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-sm-2 changeColStyle">
                                                ...
                                                <input type="text" name="pi_code" id="pi_code" class="form-control inputFieldHeight" value="{{$payment->party->pi_code}}" required>
                                                @error('party_info')
                                                    <div class="btn btn-sm btn-danger">{{ $message }}
                                                    </div>
                                                @enderror
                                            ...
                                            <div class="col-sm-3 changeColStyle search-item-pi">
                                                ...
                                                class="common-select2 party-info" style="width: 100% !important" data-target="" required>
                                                    ...
                                                    @foreach ($pInfos as $item)
                                                        <option value="{{ $item->id }}" {{$payment->party_info_id == $item->id ? 'selected' : ''}}> {{ $item->pi_name }}</option>
                                                    @endforeach
                                                </select>
                                                @error('party_info')
                                                    <div class="btn btn-sm btn-danger">{{ $message }}
                                            ...
                                            <div class="col-sm-2 changeColStyle">
                                                <label for="">TRN</label>
                                                <input type="text" class="form-control inputFieldHeight" value="{{$payment->party->trn_no}}" name="trn_no" id="trn_no" class="form-control" readonly>
                                                @error('trn_no')
                                                    <div class="btn btn-sm btn-danger">{{ $message }}
                                                    </div>
                                                @enderror
                                            ...
                                            <div class="col-sm-3 changeColStyle">
                                                ...
                                                <select name="pay_mode" id="pay_mode"   class="common-select2 " style="width: 100% !important"
                                                    ...
                                                    @foreach ($modes as $item)
                                                        <option value="{{ $item->title }}" {{ $payment->pay_mode == $item->title ? 'selected' : '' }}> {{ $item->title }}</option>
                                                    @endforeach
                                                </select>
                                                @error('pay_mode')
                                                    <div class="btn btn-sm btn-danger">{{ $message }}
                                            ...
                                            <div class="col-sm-2 changeColStyle">
                                                ...
                                                <input type="text" class="form-control inputFieldHeight" name="invoice_no" value="{{ isset($journalF) ? $journalF->invoice_no : '' }}"
                                            ...
                                            <div class="col-sm-2 changeColStyle" id="printarea">
                                                ...
                                                <input type="text" value="{{ date('d/m/Y', strtotime($payment->date)) }}" class="form-control inputFieldHeight" name="date" id="date" placeholder="dd/mm/yyyy" required>
                                                @error('date')
                                                    <div class="btn btn-sm btn-danger">{{ $message }}
                                                    </div>
                                                @enderror
                                                                ...
                                                                <div class="row justify-content-between every-form-row">
                                                                    <div class="col-md-3 col-sm-12 changeColStyle">
                                                                        ...
                                                                        <select name="invoice_no" class="form-control common-select2 invoice_no input-due-payment inputFieldHeight">
                                                                            <option value="{{$payment->invoice_no}}">{{$payment->invoice_no}}</option>
                                                                        </select>
                                                                    </div>
                                                                    <div class="col-md-2 col-sm-12 changeColStyle">
                                                                        <label for="password">Invoice Amount</label>
                                                                        <input type="number" class="form-control invoice_amount inputFieldHeight" placeholder="Invoice Amount" readonly value="{{$payment->invoice_amount}}">
                                                                    </div>
                                                                    <div class="col-md-2 col-sm-12 changeColStyle">
                                                                        <label for="password">Due Amount</label>
                                                                        <input type="number" class="form-control due_amount inputFieldHeight" placeholder="Due Amount" readonly value="">
                                                                    </div>

                                                                    <div class="col-md-2 col-sm-12 changeColStyle">
                                                                        <label for="password">Payment Amount</label>
                                                                        <input type="number" name="payment_amount" class="form-control payment_amount inputFieldHeight"  step="any" placeholder="Payment Amount"  value="{{$payment->paid_amount}}">
                                                                    </div>
                                    ...
                                    <div class="card-body" style="padding-top: 0; padding-bottom: 0;">
                                        <div class="row m-1">
                                            <div class="col-sm-4 form-group">
                                                ...
                                                <input type="number" id="total_amount" class="form-control inputFieldHeight @error('total_amount') error @enderror" name="total_amount" value="{{$payment_item->sum('paid_amount')}}" placeholder="Total" required>
                                                @error('total_amount')
                                            ...
                                            <div class="col-sm-6 form-group">
                                                ...
                                                <input type="text" class="form-control inputFieldHeight" name="remark" placeholder="Narration" value="{{ $payment->narration }}" required>
                                            </div>
