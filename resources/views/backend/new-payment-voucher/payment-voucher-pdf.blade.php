                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless table-sm">
                            <tr>
                                ...
                                <td><strong>:</strong> {{$payment_voucher->party->pi_name}}</td>
                                <th><strong>Date</strong></th>
                                <td><strong>:</strong> {{$payment_voucher->payment_date}}</td>
                            </tr>
                            <tr>
                                <th><strong>Payment Type</strong></th>
                                <td><strong>:</strong> {{$payment_voucher->type}}</td>
                                <th><strong>Payment Mode</strong></th>
                                <td><strong>:</strong> {{$payment_voucher->pay_mode}}</td>
                            </tr>
                            <tr>
                                <th><strong>Amount</strong></th>
                                <td><strong>:</strong> {{$payment_voucher->amount}}</td>
                                <th><strong>Narration</strong></th>
                                <td><strong>:</strong> {{$payment_voucher->narration}}</td>
                            </tr>
                        </table>
                    </div>
                    <div class="row pt-4">
        ...
        <section>
            <div class="divFooter m-2" style="position: fixed; bottom: 0; width:100%; ">
                <div style="position: relative;">Business Software Solutions Powered by 
                    <img class="img-fluid" style="position: absolute;top: -30px;width: 70px;height: 70px;" src="{{ asset('img/zisprink.png')}}" alt="" width="70"></div>
            </div>
        </section>
  </body>
</html>