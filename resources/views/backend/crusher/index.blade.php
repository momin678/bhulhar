                        ...
                        <div class="col-12">
                            <div class="cardStyleChange p-1">
                                <section id="widgets-Statistics" class="mb-1">
                                    <div class="d-flex">
                                        <h4 class="flex-grow-1">Source List</h4>
                                        <div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table mb-0 table-sm table-hover">
                                                ...
                                                <tbody class="table-sm">
                                                    @foreach ($crushers as $item)
                                                    <tr class="trFontSize">
                                                        <td>{{$item->name}}</td>
                                                        <td class="text-right pr-2">
                                                            <a href="#" class="btn crusherInfoEdit crusherInfoEdit" title="Edit" truck-id="{{$item->id}}" style="padding-top: 1px; padding-bottom: 1px; height: 30px; width: 30px;">
...
{{-- modal --}}
    <div class="modal fade" id="newTruckAddModal" tabindex="-1" rrole="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="content-body">
                <form class="form form-vertical" action="{{ route('crusher.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row match-height">
                            <div class="col-md-12 col-12">
                                <div class="cardStyleChange">
                                    <div class="card-body">
                                        <div class="form-body">
                                            <h4>Crusher Information</h4>
                                            <div class="row">
                                                <div class="col-12 ">
                                                    <label for="">crusher Name</label>
                                                    <input type="text" name="name" class="inputFieldHeight form-control" placeholder="crusher Name" required>
                                                </div>
    ...
    <div class="modal fade" id="crusherInfoEditModal" tabindex="-1" rrole="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <section class="print-hideen border-bottom">
                <div class="d-flex flex-row-reverse">
            ...
            <div class="content-body" id="edit_crusher_model">
...
@push('js')
<script>
    $(document).on("click", ".crusherInfoEdit", function(e){
        e.preventDefault();
        var crusher_id= $(this).attr('truck-id');
        var _token = $('input[name="_token"]').val();
        $.ajax({
            url: "{{ route('crusher-edit-model') }}",
            method: "POST",
            data: {
            ...
            success: function(response) {
                $('#edit_crusher_model').html(response);
                $("#crusherInfoEditModal").modal('show');
            }
        });
