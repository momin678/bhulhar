                        ...
                        <form class="form print-hideen mt-1">
                            <div class="form-group d-flex">
                                ...
                                <select name="project_id" id="project_id" class="common-select2">
                                    ...
                                    <option value="{{$item->id}}" {{isset($project_id) ? $project_id == $item->id ? 'selected' : ' ' : ' '}}> {{$item->project_name}} </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="row">
                                <div class="col-6 pr-0">
                                     <p style="color:#000;font-weight:400; font-size:15px; margin:0;">
                                        <span style="color:#000;font-weight:500;"> Project Name: </span> {{ Illuminate\Support\Str::limit($project->project_name,35)}}
                                    </p>
                                </div>
                            ...
                            <table class="tabl-sm custom-tbl  border-botton  w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="1" class="text-center" style="font-weight:bold !important;color:#000;"> {{number_format($project->invoicess->sum('total_budget'),2,'.','')}}   </td>
                                        <td colspan="1" class="text-center" style="font-weight:bold !important;color:#000;"> {{number_format($project->invoicess->sum('paid_amount'),2,'.','')}}   </td>
                                        <td colspan="1" class="text-center" style="font-weight:bold !important;color:#000;"> {{number_format($due_amount=$project->invoicess->sum('due_amount'),2,'.','')}}   </td>
                                        <td></td>
                                    </tr>
                                </tbody>
                            </table>
