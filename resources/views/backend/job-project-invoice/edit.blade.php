            ...
            <div class="tab-content bg-white">
                <div id="journaCreation" class="tab-pane active">
                    <section class="p-1" id="widgets-Statistics">
                        <form class="repeater" action="{{ route('project.invoice.update',$tem_invoice->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="d-flex">
                                ...
                                <div class="form-group w-100 d-none">
                                    ...
                                    <select name="invoice_type" class="text-center invoice_type form-control" data-amount="{{ $job_project->due_amount}}" style="font-size:12px;">
                                ...
                                <div class="form-group w-100 d-none">
                                    <label for=""> Invoice type </label>
                                    <select name="invoice_type" class="text-center invoice_type form-control" data-amount="{{ $job_project->due_amount}}">
                                ...
                                <div class="form-group w-100">
                                    <label for=""> Invoice type</label>
                                    <select name="invoice_type" class="invoice_type form-control" data-amount="{{ $job_project->due_amount}}">
                                        <option value="task_base"> Tasks  Base Invoice </option>
                                        <option value="amount_base" selected> Amount Base Invoice </option>
                                    </select>
                                </div>
                                @endif
                                ...
                                <div class="form-group w-100 ml-1">
                                    ...
                                    <input type="text" name="invoice_no" readonly
                                    class="text-center form-control invoice_no  @error('invoice_no') is_invalid @enderror" placeholder="Invoice No" style="margin-top: 5px;font-size:12px;" autocomplete="off" value="{{$tem_invoice->invoice_no}}">
                                ...
                                <div class="form-group w-100 ml-1">
                                    ...
                                    <select name="job_project_id" class="text-center form-control  @error('job_project_id') is_invalid  @enderror" style="margin-top: 5px;font-size:12px;">
                                        <option value="{{ $job_project->id }}"> {{ $job_project->project_name }}</option>
                                    </select>
                                ...
                                <div class="form-group w-100 ml-1" style="padding-right:6px;">
                                    ...
                                    <select name="customer_id" class="text-center form-control select2Input @error('customer_id') is-invalid @enderror" style="font-size:12px;">
                                        <option  selected readonly> Select Customer </option>
                                        @foreach ($customers as $customer)
                                            <option value="{{ $customer->id }}" {{ old('customer_id',$job_project->customer_id) == $customer->id ? 'selected' : ' ' }}> {{ $customer->pi_name }} </option>
                                        @endforeach
                                    </select>
                                    @error('customer_id')
                                        <p class="text-danger"> {{ $message }}</p>
                                ...
                                <div class="form-group w-100 ml-1">
                                    ...
                                    <input type="text" name="attention" id="attention"
                                        ...
                                        placeholder="site delivery ..." value="{{$tem_invoice->attention}}" style="margin-top: 5px;" required>
                            ...
                            <div class="row d-flex align-items-center">
                                ...
                                <div class="col-md-1">
                                    ...
                                    <input type="text" name="date"
                                        ...
                                        value="{{ date('d/m/Y', strtotime($tem_invoice->date)) }}" autocomplete="off" style="font-size: 12px;padding:0 !important">
                                    @error('date')
                                        <p class="text-danger"> {{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="top_note" value="{{$tem_invoice->top_note}}" required id="top_note" placeholder="5% Progressive Payment Invoice">

                                </div>

                                <div class="col-md-2">
                                    <label><input type="checkbox" name="with_note" {{$tem_invoice->with_note?'checked':''}}> With Note</label>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <label for=""> Invoice Type </label>
                                        <select name="tax_invoice" class="form-control" style="font-size: 12px;">
                                            <option value="Tax Invoice" {{$tem_invoice->tax_invoice=='Tax Invoice'?'selected':''}}> Tax Invoice </option>

                                            <option value="Proforma Invoice" {{$tem_invoice->tax_invoice=='Proforma Invoice'?'selected':''}}> Proforma Invoice </option>
                                        </select>
                                </div>
                            </div>
                            ...
                            <table class="auto-index repeater1 table table-sm">
                                <thead style="background-color:#34465b !important;">
                                    <tr class="text-center">
                                        ...
                                        @if($tem_invoice->project->discount)
                                ...
                                <tbody id="input-container">
                                    @foreach ($tem_invoice->tasks as $key => $task)
                                    <tr class="text-center task_base">
                                        <td class="text-center" style="font-size:12px;">
                                            <input type="checkbox" class="task_checkbox" name="invoice_tasks[{{$task->task_id}}]" value="{{$task->task_id}}" checked style="font-size:12px;">
                                            <input type="hidden" value="{{$task->task_id}}" name="task_id[{{$task->task_id}}]" style="font-size:12px;">
                                         </td>
                                        <td style="width: 20%">
                                            <input type="text" name="task_name[{{$task->task_id}}]" class="text-center form-control @error('task_name') is-invalid @enderror" required autocomplete="off" value="{{$task->task_name}}" readonly style="font-size:12px;">
                                        </td>

                                        <td>
                                            <textarea name="description[{{$task->task_id}}]"  cols="30" rows="1" class="text-center form-control" readonly required>{{$task->description}}</textarea>
                                        </td>

                                        <td>
                                            <input type="text" name="unit[{{$task->task_id}}]" class="form-control text-center unit" required readonly value="{{$task->unit}}">
                                        </td>
                                        <td>
                                            <input type="number" name="qty[{{$task->task_id}}]" class="form-control text-center qty" required readonly  value='{{$task->qty}}' >
                                        </td>
                                        <td>
                                            <input type="number" name="rate[{{$task->task_id}}]" class="form-control text-center rate" required readonly value='{{$task->rate}}' >
                                        </td>
                                        @if($tem_invoice->project->discount)
                                        <td>
                                            <input type="number" step="any" name="discount[{{$task->task_id}}]" class="form-control amount text-center" required readonly value="{{$task->discount}}">
                                        </td>
                                        @endif

                                        <td>
                                            <input type="number" name="amount[{{$task->task_id}}]" class="form-control text-center discount" required readonly value='{{$task->amount}}' >
                                        </td>
                                    ...
                                    <tr>
                                        <td class="text-center" style="font-size:12px;">
                                            <input type="checkbox" class="task_checkbox" name="invoice_tasks[{{$task->id}}]" value="{{$task->id}}">
                                            <input type="hidden" value="{{$task->id}}" name="task_id[{{$task->id}}]">
                                         </td>
                                        <td style="width: 20%">
                                            <input type="text" name="task_name[{{$task->id}}]" class="form-control @error('task_name') is-invalid @enderror" required autocomplete="off" value="{{$task->task_name}}" readonly style="font-size:12px;">
                                        </td>

                                        <td>
                                            <textarea name="description[{{$task->id}}]"  cols="30" rows="1" class="form-control" readonly required style="font-size:12px;">{{$task->description}}</textarea>
                                        </td>

                                        <td>
                                            <input type="text" name="unit[{{$task->id}}]" class="form-control text-center unit" required readonly value="{{$task->unit}}" style="font-size:12px;">
                                        </td>
                                        <td>
                                            <input type="number" name="qty[{{$task->id}}]" class="form-control text-center qty" required readonly  value='{{$task->qty}}'  style="font-size:12px;">
                                        </td>
                                        <td>
                                            <input type="number" name="rate[{{$task->id}}]" class="form-control text-center rate" required readonly value='{{$task->rate}}'  style="font-size:12px;">
                                        </td>
                                        @if ($job_project->discount)
                                        <td>
                                            <input type="number" step="any" name="discount[{{$task->id}}]" class="form-control discount text-center" required readonly value="{{ $task->discount}}" style="font-size:12px;">
                                        </td>
                                        @endif

                                        <td>
                                            <input type="number" name="amount[{{$task->id}}]" class="form-control text-center  amount" required readonly value='{{$task->amount}}' style="font-size:12px;" >
                                        </td>
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td  colspan="{{$tem_invoice->project->discount ? 7 : 6}}" class="text-right"> <span class="mr-1">  Total  </span> </td>
                                            <td  colspan="1"> <input type="number" name="total" readonly step="any" class="form-control text-center total" value="{{$job_project->total_budget}}" style="font-size:12px;">  </td>
                                        </tr>

                                        <tr class="previous_amount">
                                            <td class="text-center d-none"> </td>
                                            <td  colspan="{{$tem_invoice->project->discount ? 7 : 6}}" class="text-right"> <span class="mr-1">  Previous invoice  </span> </td>
                                            <td  colspan="1"> <input type="number" name="previous_amount" readonly step="any" class="form-control text-center" value="{{$job_project->paid_amount }}" readonly style="font-size:12px;">  </td>
                                        </tr>

                                        <tr class="previous_amount">
                                            <td class="text-center d-none"> </td>
                                            <td  colspan="{{$tem_invoice->project->discount ? 7 : 6}}" class="text-right"> <span class="mr-1"> Amount  </span> </td>
                                            <td  colspan="1"> <input type="number" name="total_due_amount" step="any" class="form-control text-center total_due_amount" max="{{$job_project->due_amount}}" min="1" value="{{$tem_invoice->budget}}" placeholder="invoice Amount" style="font-size:12px;">  </td>
                                            <input type="hidden" class="sub_total"
                                            value="{{ $job_project->budget - $job_project->discount }}">
                                        </tr>
                                        <tr class="previous_amount">
                                            <td class="text-center d-none"> </td>
                                            <td colspan="{{$tem_invoice->project->discount ? 7 : 6}}" class="text-right"> <span class="mr-1"> Amount % </span>
                                            </td>
                                            <td colspan="1"> <input type="number" name="total_due_amount_percentage"
                                                    ...
                                                    max="{{  number_format((100-$job_project->paid_amount_percentage),2) }}" data-max="{{  number_format((100-$job_project->paid_amount_percentage),2) }}"
                                                    value="{{ number_format($tem_invoice->total_due_amount_percentage,2) }}"
                                                    placeholder="invoice Amount in percentage" style="font-size:12px;"> </td>
                                        </tr>
                                        <tr>
                                            <td class="text-center d-none"> </td>
                                            <td  colspan="{{$tem_invoice->project->discount ? 7 : 6}}" class="text-right"> VAT <span class="mr-1"> {{$standard_vat_rate}}% </span> </td>
                                            <td  colspan="1"> <input type="number" name="vat" step="any" data-vat="{{$standard_vat_rate}}" class="form-control text-center vat" value="0" placeholder="invoice Amount" readonly style="font-size:12px;">  </td>
                                        </tr>

                                        <tr>
                                            <td class="text-center d-none"> </td>
                                            <td  colspan="{{$tem_invoice->project->discount ? 7 : 6}}" class="text-right"> <span class="mr-1"> Total Amount  <small>(@if(!empty($currency->symbole)){{$currency->symbole}}@endif)</small>  </td>
                                            <td  colspan="1"> <input type="number" name="invoice_amount" step="any" class="form-control text-center invoice_amount" max="{{$job_project->due_amount}}" min="1" value="{{$tem_invoice->due_amount}}" readonly placeholder="invoice Amount" style="font-size:12px;">  </td>
                                        </tr>
                                </tbody>
                            </table>
                            <div class="row d-flex align-items-center">
