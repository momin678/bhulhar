...
{{$task->description}}
                    ...
                    @endif
                        <tr>
                            ...
                            <td style="background: #ada8a81c;text-align:center !important">{{$invoice->project->total_budget}}</td>
                        </tr>
                        <tr>

                            <td colspan="{{$invoice->project->discount>0 ? 6 : 5}}" class="text-right pr-1" style="background: #ada8a81c"> Invoiced Amount</td>
                            <td style="background: #ada8a81c;text-align:center !important">{{$invoice->budget }}</td>
                        </tr>
                        <tr>

                            <td colspan="{{$invoice->project->discount>0 ? 6 : 5}}" class="text-right pr-1" style="background: #ada8a81c"> VAT </td>
                            <td style="background: #ada8a81c;text-align:center !important">{{$invoice->vat}}</td>
                        </tr>
                        <tr>
