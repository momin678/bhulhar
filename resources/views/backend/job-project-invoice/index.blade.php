                    ...
                    <section class="p-1" id="widgets-Statistics">
                        <div class="row">
                            <div class="col-md-8 d-flex">
                                <a href="{{ route('project.invoice.index') }}" class="project-btn create-btn sub-btn active"> Authorization </a>

                                <a href="{{ route('project.authorize.invoice') }}" class="project-btn create-btn sub-btn ml-1"> Approve </a>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td  class="text-center">
                                                <div class="d-flex justify-content-center">
                                                    ...
                                                    <a href="{{ route('project.invoice.delete',$invoice->id) }}" class="project-btn bg-danger" style="margin-left: 0.2rem !important;" title="Delete"><i class="fa fa-trash text-white"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
