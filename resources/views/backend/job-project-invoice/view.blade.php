    ...
    <div class="receipt-voucher-hearder invoice-view-wrapper mb-1 " style=" border: 1px solid; margin: 70px 20px; border-radius: 20px;">
        ...
        <div class="d-flex justify-content-between px-2">
            <div>
                ...
                <span>P.O BOX: 8216 tttt</span><br>
        ...
        <div class="col-md-12">
            ...
            <div class="customer-info">
                <div class="row ml-1 mr-1"style="border: 2px solid #bdbdbd;">
                    <div class="col-md-2 customer-static-content" style="padding-left: 3px ">
                        M/S: <br>
                        Address: <br>
                        Attention: <br>
                        Contact No: <br>
                    ...
                    <div class="col-md-10 customer-dynamic-content">
                        ...
                        @else
                        {{$tem_invoice->party->con_no && $tem_invoice->party->con_no!='.'? $tem_invoice->party->con_no:($tem_invoice->party->phone_no && $tem_invoice->party->phone_no?$tem_invoice->party->phone_no:'')}}
        ...
        <div class="col-md-12">
            <table class="table table-sm table-bordered border-botton " style="color: black; ">
                <thead style="background: #E6BC99 !important;color: black;">
                    <tr >
                        <th class="text-center" style="color: black !important;">S.no</th>
                ...
                @foreach ($notes as $key => $data)
                    <tr>
                        ...
                        <td>  {{$data->top_note}} Invoice No :
                            {{ $data->invoice_no }} AED {{ number_format($data->total_budget,2,'.','') }} /- (@foreach ($data->receipts as $receipt)
                ...
                <tr>
                    ...
                    <td>  {{$tem_invoice->top_note}} Invoice No :
                        {{ $tem_invoice->invoice_no }} AED {{ number_format($tem_invoice->total_budget,2,'.','') }} /- ()</td>
