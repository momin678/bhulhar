                            ...
                            <form class="repeater" action="{{ route('project.invoice.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="form-group w-100 ml-1">
                                        ...
                                        <select name="job_project_id"
                                            class="form-control  @error('job_project_id') is_invalid  @enderror"
                                            style="margin-top: 5px;font-size: 12px;">
                                            <option value="{{ $job_project->id }}"> {{ $job_project->project_name }}
                                            </option>
                                        </select>
                                    ...
                                    <div class="form-group w-100 ml-1">
                                        ...
                                        <input type="text" name="attention" id="attention"
                                            ...
                                            placeholder="site delivery ..." value="{{$job_project->attention}}" style="margin-top: 5px;" required>
