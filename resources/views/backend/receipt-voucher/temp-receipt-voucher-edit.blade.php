...
<div class="app-content content print-hideen">
    ...
    <div class="content-wrapper">
        <div class="content-body">
            @include('clientReport.accounting._header', ['activeMenu' => 'receipt-voucher'])
                                ...
                                <div class="card-body pb-1">
                                    <div class="row mx-1 mt-1 d-flex justify-content-center">
                                        ...
                                        {{-- <div class="col-md-3 changeColStyle ">
                                            <div class="row align-items-center">
                                                 ...
                                                 <div class="col-10">
                                                    <select name="party_id" id="party_id" class="common-select2 w-100">
                                                        ...
                                                        <option value="{{$party->id}}">{{$party->pi_code}}-{{$party->pi_name}}</option>
                                         ...
                                         <div class="col-md-3 changeColStyle invoice_no">
                                            <div class="row align-items-center">
                                                 <div class="col-3">
                                                 ...
                                                 <div class="col-9">
                                                     ...
                                                     class="common-select2 party-info" style="width: 100% !important" data-target="" required>
                                                         @foreach ($invoices as $invoice)
                                                             <option value="{{ $invoice->id }}" {{$receipt->items->first()->sale_id==$invoice->id?'selected':''}}>{{ $invoice->invoice_no }}</option>
                                                         @endforeach
                                                     </select>
                                                     @error('invoice_no')
                                        ...
                                        <div class="col-md-2 changeColStyle d-none">
                                           <div class="row aling-items-center">
                                            <div class="col-3">
                                                <label for="">Party Code {{$receipt->party->trn_no}}</label>
                                            </div>
                                            <div class="col-9">
                                                <input type="text" name="pi_code" id="pi_code" class="form-control inputFieldHeight" value="{{$receipt->party->pi_code }}" required placeholder="Party Code">
                                                @error('party_info')
                                                    <div class="btn btn-sm btn-danger">{{ $message }}
                                                    </div>
                                                @enderror
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2 changeColStyle">
                                                    <div class="row align-items-center">
                                                        ...
                                                        name="deposit_date" placeholder="dd/mm/yyyy" value="{{$receipt->pay_mode=='Cheque'? date('d/m/Y',strtotime($receipt->deposit_date)):''}}" {{$receipt->pay_mode=='Cheque'?'required':''}}>
                                                            @error('deposit_date')
                                                                <div class="btn btn-sm btn-danger">{{ $message }}
                                                                </div>
                                                            @enderror
                                        ...
                                        <div class="col-md-2 changeColStyle" id="printarea">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-8">
                                                    <input type="number" step="any" class="form-control inputFieldHeight" name="due_amount" id="due_amount" placeholder="Due Amount" value="{{number_format($due,2,'.','')}}" readonly>
                                        ...
                                        <div class="col-md-2 changeColStyle" id="printarea">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-8">
                                                    <input type="number" step="any" class="form-control inputFieldHeight" name="pay_amount" id="pay_amount" placeholder="Pay Amount" value="{{number_format($receipt->total_amount,2,'.','')}}" max="{{$due}}" required>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-8">
                                                    ...
                                                    class="form-control  @error('voucher_file') is-invalid @enderror" type="file" name="voucher_file"
                                                     style="height: 45px !important" accept="application/pdf,image/png,image/jpeg,application/msword" >
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-1 text-right d-flex justify-content-end mb-1" style="padding-right: 5px;">
