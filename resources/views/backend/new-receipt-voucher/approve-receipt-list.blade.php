...
<div class="app-content content print-hideen">
    ...
    <div class="content-wrapper">
        <div class="content-body">
            {{-- @include('backend.new-receipt-voucher.top-header',['activeMenu' => 'new-receipt-voucher']) --}}
            @include('backend.taxInvoice.top-header', ['activeMenu' => 'new-receipt-voucher'])
            <div class="tab-content journaCreation">
                <div id="journaCreation" class="tab-pane bg-white active">
                    <div class="py-1 px-2">
                        @include('backend.new-receipt-voucher.bottom-header', [ 'activeMenu' => 'approve'])
                    </div>
                            ...
                            <div class="row">
                                <div class="cardStyleChange" style="width: 100%">
                                    <div class="card-body bg-white">
                                        <div class="row">
                                            <div class="col-3">
                                                <input type="text" name="search" id="search" class="form-control inputFieldHeight" placeholder="Search by Receipt No">
                                            </div>
                                            <div class="col-3">
                                            ...
                                            <div class="col-3">
                                                <input type="text" name="date_search" id="date_search" class="form-control inputFieldHeight date" placeholder="Search by Date">
                                            </div>


                                            <div class="col-3">
                                                <select name="mode_search" id="mode_search" class="common-select2 inputFieldHeight w-100">
