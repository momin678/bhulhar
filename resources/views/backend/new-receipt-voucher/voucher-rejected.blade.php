        ...
        <div class="content-body">
            <div class="nav nav-tabs master-tab-section" id="nav-tab" role="tablist">
                @if (Auth::user()->hasPermission('receipt_voucher_view'))
					...
					@endif
					<a href="{{route("receipt-voucher-reject-list")}}" class="nav-item nav-link active" role="tab" aria-controls="nav-contact" aria-selected="false">
                        <div class="master-icon text-cente">
            ...
            <div class="tab-content bg-white">
                <div id="journalAuthorization" class="tab-pane active">
                    <section id="widgets-Statistics">
                        <div class="col-md-12">
                            <div class="row">
                                <h4 class="mt-2 ml-2">Rejected Receipt Voucher</h4>
                            </div>
                        </div>
                    </section>
                    <section>
                                        ...
                                        <tr class="trFontSize">
                                            ...
                                            <td style="padding-bottom: 11px; padding-top: 0px">
                                                <div class="d-flex justify-content-end">
                                                    <a href="#" class="btn journalAuthorizeShowId" style="height: 30px; width: 30px;" title="Preview" id="{{$vouchers->id}}">
