...
<section class="print-hideen border-bottom">
    <div class="d-flex flex-row-reverse">
        ...
        <div class="py-1 mr-1">
            <a href="{{ route('receipt-voucher-delete', $recept) }}" class="btn btn-sm btn-icon btn-danger" onclick="return confirm('Delete! Confirm?')">Delete</a>
        </div>
        {{-- @if ($recept->status == 0)
            <div class="py-1 mr-1">
        ...
        @endif --}}
        <div class="py-1 mr-1">
            <a href="{{ route('receipt-voucher-approve', $recept) }}" class="btn btn-sm btn-icon btn-success" onclick="return confirm('Approve! Confirm?')">Approve</a>
        </div>
...
<div class="img receipt-bg">
    <img src="{{ asset('img/zisprink.png') }}" class="img-fluid" style="position: fixed; top: 420px; left: 200px; opacity: 0.3; width: 650px !important; height: 250px;" alt="">
