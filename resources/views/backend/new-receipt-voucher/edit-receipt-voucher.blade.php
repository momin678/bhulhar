                ...
                <div class="tab-content bg-white">
                    <div id="journaCreation" class="tab-pane active">
                        ...
                        <section id="widgets-Statistics">
                            <form action="{{ route('update-receipt-voucher', $voucher->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body" style="padding-bottom: 5px;">
                                        <div class="row m-1">
                                                ...
                                                <select name="project" class="common-select2" style="width: 100% !important" id="project"
                                                    ...
                                                    @foreach ($projects as $item)
                                                        <option value="{{ $item->id }}"
                                                            {{ $voucher->project_id == $item->id ? 'selected' : '' }}>
                                                            {{ $item->proj_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-sm-2 changeColStyle">
                                                ...
                                                <input type="text" name="cc_code" id="cc_code" value="{{$voucher->cost_center->cc_code}}" class="form-control inputFieldHeight" placeholder="Cost Center Code" required>
                                                @error('cc_code')
                                                    <div class="btn btn-sm btn-danger">{{ $message }}
                                                    </div>
                                                @enderror
                                            ...
                                            <div class="col-sm-3 changeColStyle search-item">
                                                ...
                                                class="common-select2 party-info " style="width: 100% !important" data-target="" required>
                                                    ...
                                                    @foreach ($cCenters as $item)
                                                        <option value="{{ $item->id }}" {{ $voucher->cost_center_id == $item->id ? 'selected' : '' }}>
                                                            {{ $item->cc_name }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-sm-2 changeColStyle">
                                                ...
                                                <input type="text" name="pi_code" id="pi_code" class="form-control inputFieldHeight" value="{{$voucher->party->pi_code}}" required>
                                                @error('party_info')
                                                    <div class="btn btn-sm btn-danger">{{ $message }}
                                                    </div>
                                                @enderror
                                            </div>
                                            <div class="col-sm-2" style="padding-right:5px;  padding-left:5px; padding-bottom:5px;"> 
                                            ...
                                            <div class="col-sm-3 changeColStyle search-item-pi">
                                                ...
                                                class="common-select2 party-info" style="width: 100% !important" data-target="" required>
                                                    ...
                                                    @foreach ($pInfos as $item)
                                                        <option value="{{ $item->id }}" {{ $voucher->party_info_id == $item->id ? 'selected' : '' }}>{{ $item->pi_name }}</option>
                                                    @endforeach
                                                </select>
                                                @error('party_info')
                                                    <div class="btn btn-sm btn-danger">{{ $message }}
                                            ...
                                            <div class="col-sm-2 changeColStyle">
                                                <label for="">TRN</label>
                                                <input type="text" class="form-control inputFieldHeight" value="{{$voucher->party->trn_no}}" name="trn_no" id="trn_no" class="form-control" readonly>
                                                @error('trn_no')
                                                    <div class="btn btn-sm btn-danger">{{ $message }}
                                                    </div>
                                                @enderror
                                            ...
                                            <div class="col-sm-3 changeColStyle">
                                                ...
                                                <select name="pay_mode" id="pay_mode"   class="common-select2 " style="width: 100% !important" required>
                                                    ...
                                                    @foreach ($modes as $item)
                                                        <option value="{{ $item->title }}" {{ $voucher->pay_mode == $item->title ? 'selected' : '' }}>{{ $item->title }}</option>
                                                    @endforeach
                                            ...
                                            <div class="col-sm-2 changeColStyle">
                                                ...
                                                <input type="text" class="form-control inputFieldHeight" name="invoice_no" value="{{ $voucher->invoice_no }}" id="invoice_no" placeholder="Invoice No">
                                                @error('invoice_no')
                                                    <div class="btn btn-sm btn-danger">{{ $message }}
                                                    </div>
                                                @enderror
                                            ...
                                            <div class="col-sm-2 changeColStyle" id="printarea">
                                                ...
                                                <input type="text" value="{{ date('d/m/Y', strtotime($voucher->payment_date)) }}" class="form-control inputFieldHeight" name="date" id="date" placeholder="dd/mm/yyyy" required>
                                                @error('date')
                                                    <div class="btn btn-sm btn-danger">{{ $message }}
                                                    </div>
                                                @enderror
                                                            ...
                                                            <div class="row justify-content-between every-form-row">
                                                                <div class="col-md-3 col-sm-12 changeColStyle">
                                                                    ...
                                                                    <select name="invoice_no" class="form-control common-select2 invoice_no input-due-payment inputFieldHeight">
                                                                        ...
                                                                        <option value="{{$invoice->invoice_no}}" {{$item->invoice_no == $invoice->invoice_no ? "selected":""}}>{{$invoice->invoice_no}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                                <div class="col-md-2 col-sm-12 changeColStyle">
                                                                    <label for="password">Invoice Amount</label>
                                                                    <input type="number" class="form-control invoice_amount inputFieldHeight" placeholder="Invoice Amount" readonly value="{{$item->invoice_amount}}">
                                                                </div>
                                                                <div class="col-md-2 col-sm-12 changeColStyle">
                                                                    <label for="password">Due Amount</label>
                                                                    <input type="number" class="form-control due_amount inputFieldHeight" placeholder="Due Amount" readonly value="{{$item->tax_invoice->due_amount}}">
                                                                </div>


                                                                <div class="col-md-2 col-sm-12 changeColStyle">
                                                                    <label for="password">Payment Amount</label>
                                                                    <input type="number" name="payment_amount" class="form-control payment_amount inputFieldHeight"  step="any" placeholder="Payment Amount" value="{{$item->paid_amount}}">
                                                                </div>
                                    ...
                                    <div class="card-body" style="padding-top: 0; padding-bottom: 0;">
                                        <div class="row m-1">
                                            <div class="col-sm-4 form-group">
                                                ...
                                                <input type="text" id="total_amount" class="form-control inputFieldHeight @error('total_amount') error @enderror" name="total_amount" value="{{$voucher->amount}}" placeholder="Total" required>
                                                @error('total_amount')
