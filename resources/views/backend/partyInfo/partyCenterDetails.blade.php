                            ...
                            <div class="mt-2">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-right">
                                        ...
                                        {{-- <a href="#" class="btn btn-xs mPrint formButton" id="partyCenterListPrint" title="Print"><img  src="{{asset('storage/upload/icon/print-icon.png')}}" alt="" srcset="" class="img-fluid" width="30"> Print</a> --}}
                                        <a href="#" class="btn btn-xs mExcelButton formButton" onclick="exportTableToCSV('PartyInfos.csv')" title="Export to Excel"><img  src="{{asset('storage/upload/icon/excel-icon.png')}}" alt="" srcset="" class="img-fluid" width="30">Excel</a href="#">
                                    </div>
                                </div>
                                    ...
                                    <table class="table mb-0 table-sm table-hover">
                                        <thead  class="thead-light">
                                            <tr class="text-center" style="height: 40px;">
                                                ...
                                                <th style="width: 10%;">@if(!empty($currency->licence_name)){{$currency->licence_name}} @endif </th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="text-center trFontSize">
                                                <td class=" part-ledger" style="cursor: pointer;" id="{{$pInfo->id}}" >{{ $pInfo->pi_code }}</td>
                                                ...
                                                <td>
                                                   <div class="d-flex justify-content-end" style="padding-right: 27px;">
                                                    <a href="#" class="btn partyCenterView" style="height: 25px; width: 25px;padding: 0 2rem !important;" title="Preview" id="{{$pInfo->id}}"><img src="{{ asset('storage/upload/icon/view-icon.png')}}" style=" height: 25px; width: 25px;"></a>
                                                    <a href="{{ route('partyInfoEdit', $pInfo) }}" class="btn" style="height: 25px; width: 25px;padding: 0rem !important;" title="Edit"><img src="{{ asset('storage/upload/icon/edit-icon.png')}}" style=" height: 25px; width: 25px;"></a>
                                                    @if (count($pInfo->effects())==0)
                                                    <a href="{{ route('partyInfoDelete', $pInfo) }}" onclick="return confirm('about to delete party info. Please, Confirm?')"  class="btn" style="height: 25px; width: 25px;padding: 0 0.8rem !important;" title="Delete"><img src="{{ asset('storage/upload/icon/delete-icon.png')}}" style=" height: 25px; width: 25px; margin-left: -12px;"></a>
                                ...
                                <div class="cardStyleChange">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 changeColStyle">
                                            ...
                                            <select name="pi_type" class="form-control" style="width: 100% !important" id="" required>
                                        ...
                                        <div class="col-md-2 changeColStyle">
                                            <label>@if(!empty($currency->licence_name)){{$currency->licence_name}} @endif No</label>
                                        ...
                                        <div class="col-md-3 changeColStyle">
                                            ...
                                            <div class="col-md-3 d-flex justify-content-end changeColStyle">
                                                <div class="form-group" style="padding-top: 20px;">
                                                    @isset($partyInfo)
                                                    {{-- <button class="btn btn-info party-info-form-btn formButton" data_target="{{ route('partyInfoForm') }}" id="profitCenterButton"><img src="{{ asset('storage/upload/icon/add-icon.png')}}" alt="" srcset="" class="image-fluid" width="25">New</button> --}}
                                                    @endisset
