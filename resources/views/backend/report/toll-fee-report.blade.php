                                ...
                                <div class="row" id="table-bordered">
                                    <div class="col-12">
                                        <div class="card cardStyleChange">
                                            ...
                                            <div class="card-body print-hidden">
                                                ...
                                                <div class="mt-2">
                                                    <form action="" method="GET" class="row">
                                                        ...
                                                        <div class="col-md-2 text-right mt-2">
                                                            <button type="button" class="btn mPrint formButton" title="Print"  onclick="handlePrintClick('toll-free')">
                                                                <div class="d-flex">
                                                                    <div class="formSaveIcon">
                                                                        <img src="{{asset('assets/backend/app-assets/icon/print-icon.png')}}" width="25">
                                                                    </div>
                                            ...
                                            <div class="card-body" id="toll-free">
                                                <h4 class="card-title flex-grow-1 print-show text-center" style="display: none">Toll Fee Report:
                                                        @if ($from && $to)
                                                        {{" From ". date('d/m/Y', strtotime($from)) ." To ". date('d/m/Y', strtotime($to)) }}
                                                        @endif
                                                        @if($date)
