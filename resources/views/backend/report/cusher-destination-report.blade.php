                                                ...
                                                <table class="table mb-0 table-sm table-bordered">
                                                    <thead  class="thead-light">
                                                        <tr style="height: 50px;">
                                                            ...
                                                            <th class="text-right pr-1">Commition</th>
                                                            <th class="text-right pr-1">WGT</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @php
                                                            $total_amount += $item->weight * $item->weight;
                                                            $total_qty += $item->weight;
                                                        @endphp
                                                        <tr>
                                                            <td>{{$item->customer?$item->customer->pi_name:''}}</td>
                                                            <td>{{$item->driver_name_info?$item->driver_name_info->full_name:''}}</td>
                                                            ...
                                                            <td class="text-right pr-1">{{$item->weight}}</td>
                                                            <td class="text-right pr-1">{{number_format($item->weight * $item->weight,2)}}</td>
                                                        </tr>
                                                        @endforeach
                                                        <tr>
                                                            <td colspan="11" class="text-right pr-2">Total: </td>
