                                ...
                                <div class="row" id="table-bordered">
                                    <div class="col-12">
                                        <div class="card cardStyleChange">
                                            ...
                                            <h4 class="card-title flex-grow-1 mt-2 ml-1">Third Party Report:
                                                @if ($customer)
                                                    {{$customer->pi_name}}
                                                @endif
                                                @if ($from && $to)
                                            ...
                                            <div class="card-body print-hidden">
                                                ...
                                                <div class="mt-2">
                                                    <form action="" method="GET" class="row">
                                                        ...
                                                        <div class="col-md-2 text-right mt-2">
                                                            <button type="button" class="btn mPrint formButton" title="Print" onclick="handlePrintClick('thrird-part')">
                                                                <div class="d-flex">
                                                                    <div class="formSaveIcon">
                                                                        <img src="{{asset('assets/backend/app-assets/icon/print-icon.png')}}" width="25">
                                                                    </div>
                                            ...
                                            <div class="card-body" id="thrird-part">
                                                <h4 class="card-title flex-grow-1 mt-2 ml-1 print-show text-center" style="display:none">Third Party Report:
                                                    @if ($customer)
                                                        {{$customer->pi_name}}
                                                    @endif
                                                    @if ($from && $to)
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @foreach ($tax_invoices as $invoice_key => $invoice)
                                                                <tr class="trFontSize">
                                                                    ...
                                                                    <td><a href="{{route('invoice-view', $invoice->id)}}">{{$invoice->invoice_no}}</a></td>
