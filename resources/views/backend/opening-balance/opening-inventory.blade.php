        ...
        <div class="content-body">
            ...
            <div class="tab-content bg-white">
                <div id="masterAccount" class="tab-pane active p-2">
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <form action="{{ route('opening-inventory.store') }}" method="POST" >
                                @csrf
                                            ...
                                            <div data-repeater-list="group-a">
                                                <div data-repeater-item>
                                                    <div class="row every-form-row d-flex align-items-center">
                                                        ...
                                                        <div class="col-md-3 changeColStyle text-center px-0 mx-0">
                                                        ...
                                                        <div class="col-md-2 changeColStyle text-center px-0 mx-0">
                                                            ...
                                                            <input type="number" step="any" name="quantity" class="form-control form-control-sm quantity"  placeholder="Quantity"  required>
                                                        </div>

                                                        <div class="col-md-2 changeColStyle text-center px-0 mx-0">
                                                            <label for="">Unit Price</label>
                                                            <input type="number" name="unit_price" class="form-control form-control-sm unit_price"  step="any" placeholder="Unit Price" required>
                                                        </div>

                                                        <div class="col-md-3 changeColStyle text-center px-0 mx-0">
                                                            <label for="">Total Price</label>
                                                            <input type="number" name="total_price" class="form-control form-control-sm total_price"  step="any" placeholder="Cost Price" required readonly>
 ...
 var i = 1;
    $(document).ready(function() {
        ...
        $(document).on("keyup", ".quantity", function(e) {
                var value = $(this).val();
                var h = $(this).closest('.every-form-row').find('.unit_price').val();
                var to = value*h;
                $(this).closest('.every-form-row').find('.total_price').val(to);
                sum_class()
            });

            $(document).on("keyup", ".unit_price", function(e) {
                var value = $(this).val();
                var h = $(this).closest('.every-form-row').find('.quantity').val();
                var to = value*h;
                $(this).closest('.every-form-row').find('.total_price').val(to);
                sum_class()
            });
