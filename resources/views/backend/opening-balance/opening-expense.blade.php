            ...
            <div class="tab-content bg-white">
                <div id="masterAccount" class="tab-pane active p-2">
                    ...
                    <div class="row d-flex justify-content-center mt-3">
                        <div class="col-12">
                            <form action="{{ route('opening-expense.store') }}" method="POST" >
                                @csrf
                                <div class="row mx-1 p-0 d-flex justify-content-center">
                                    <div class="col-md-4 form-group">
                                        <label for="">Date </label>
                                        <input type="date"
                                            value="{{ Carbon\Carbon::now()->format('Y-m-d') }}"
                                            class="form-control form-control-sm" name="date" id="date" required>
                                    </div>
                                </div>
                                <div class="row pb-1 mx-1 d-flex justify-content-center">
                                    <div class="col-md-5">
                                        <div class="repeater-default" id="form-repeat-container">
                                            <div data-repeater-list="group-a">
                                                <div data-repeater-item>
                                                    <div class="row every-form-row d-flex align-items-center">
                                                        <div class="col-md-8 changeColStyle text-center pr-0 mr-0">
