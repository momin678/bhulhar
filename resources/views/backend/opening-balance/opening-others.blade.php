        ...
        <div class="content-body">
            ...
            <div class="tab-content bg-white">
                <div id="masterAccount" class="tab-pane active p-2">
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <form action="{{ route('opening-others.store') }}" method="POST" >
                                @csrf
                                            ...
                                            <div data-repeater-list="group-a">
                                                <div data-repeater-item>
                                                    <div class="row every-form-row d-flex align-items-center">
                                                        ...
                                                        <div class="col-md-4 changeColStyle text-center px-0 mx-0">
                                                        ...
                                                        <div class="col-md-4 changeColStyle text-center px-0 mx-0">
                                                            ...
                                                            <input type="text" class="form-control form-control-sm" name="note" id="" required>
                                                        </div>


                                                        <div class="col-md-3 changeColStyle text-center px-0 mx-0">
                                                            <label for="">Total Price</label>
                                                            <input type="number" name="total_price" class="form-control form-control-sm total_price"  step="any" placeholder="Amount" required>
